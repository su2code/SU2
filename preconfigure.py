...
if __name__ == '__main__':
  ...
  parser.add_argument("--with-own-meson",
                      help="download own copies of Meson and Ninja",
                      action="store_true")
  parser.add_argument("--no-codi",
                      help="do not download own copy of CoDiPack",
                      action="store_false")
  parser.add_argument("--no-medi",
                      help="do not download own copy of MeDiPack",
                      action="store_false")
  parser.add_argument("--no-opdi",
                      help="do not download own copy of OpDiLib",
                      action="store_false")
  parser.add_argument("--no-mpp",
                      help="do not download own copy of Mutationpp",
                      action="store_false")
  parser.add_argument("--no-coolprop",
                      help="do not download own copy of CoolProp",
                      action="store_false")
  parser.add_argument("--no-mel",
                      help="do not download own copy of MEL",
                      action="store_false")
  args = parser.parse_args()

  run(own_meson = args.with_own_meson,
