...
## \file divide_unsteady.py
#  \brief Python script for dividing SU2 unsteady solution files.
...
for time in range(int(options.endtime)-int(options.begintime)):
    ...
    os.system ("divide_solution_su2.py -p %s -f %s -t %05d"    % (int(options.partitions), options.filename, iteration))
