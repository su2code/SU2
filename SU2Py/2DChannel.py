...
parser.add_option("-n", "--nNode", dest="nNode", default=500,
                  help="use this NNODE in x direction", metavar="NNODE")
parser.add_option("-m", "--mNode", dest="mNode", default=80,
                  help="use this MNODE in y direction", metavar="MNODE")
parser.add_option("-x", "--xLength", dest="xLength", default=100.0,
                  help="use this XLENGTH", metavar="XLENGTH")
parser.add_option("--offsetx", dest="offsetx", default=50.0,
...
for jNode in range(mNode):
    for iNode in range(nNode):
        ...
        y0 = 0.0; y1 = 0.3333; y2 = 0.6666; y3 = 1.0;
        fp3 = 10.0;  fp0 = fp3; fpp2 = 0.0; fpp1 = -fpp2;
