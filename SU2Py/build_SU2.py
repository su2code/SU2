...
group.add_option("--SU2_CFD",
                 ...
                 help="build SU2_CFD")
group.add_option("--SU2_SOL",
                 action="store_true", dest="SU2_SOL", default=False,
                 help="build SU2_SOL")
...
if options.SU2_CFD  or options.SU2_SOL or options.SU2_DDC or options.SU2_GPC or options.SU2_GDC or options.SU2_MAC or options.SU2_MDC or options.SU2_PBC or options.SU2_SMC:
  if options.SU2_CFD:
    build_cfd = True
  else:
    build_cfd = False
...
if options.operatingsys == "darwin":
  ...
  if options.clean:
    ...
    if build_sol:
      print '\n  Cleaning SU2_SOL...\n'
      os.chdir(su2_home + '/SU2_SOL/config')
      os.system('cp ./makefile.darwin.gcc4.2.1.in ./makefile.in')
      os.system('make clean')
      os.chdir(su2_home + '/SU2Py')
      os.system('rm -f SU2_SOL')
    ...
    if build_sol:
      ...
      if options.compiler != False:
        set_compiler(options.compiler, 'makefile.in')
      if options.cgns:
        print '\n!!! Warning: SU2_SOL does not yet support parallel CGNS. Option ignored. !!!\n'
      os.system('make all')
