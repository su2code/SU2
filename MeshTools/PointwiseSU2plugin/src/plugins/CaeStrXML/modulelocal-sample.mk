...
#             All rights reserved.
#
# modulelocal.mk for src\plugins\CaeStrXML plugin
########################################################################
...
# The file paths are relative to the project path macro CaeStrXML_LOC.
# For example,
#    myFile.cxx is located in $(CaeStrXML_LOC)/myFile.cxx
#    sub/myOtherFile.cxx is located in $(CaeStrXML_LOC)/sub/myOtherFile.cxx
#
#CaeStrXML_CXXFILES_PRIVATE := \
#    yourfile.c \
#    yourfile.cxx \
#	$(NULL)
...
#
#CaeStrXML_MAINT_TARGETS_PRIVATE = \
#	$(NULL)
...
#
#CaeStrXML_sample: CaeStrXML_clean CaeStrXML
#	@echo "done building CaeStrXML"
