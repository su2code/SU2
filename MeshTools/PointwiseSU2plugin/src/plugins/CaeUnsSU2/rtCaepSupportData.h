...
/*------------------------------------*/
/* CaeUnsSU2 format item setup data */
/*------------------------------------*/
// CAEP_BCINFO CaeUnsSU2BCInfo[] = {
// };
/*------------------------------------*/
// CAEP_VCINFO CaeUnsSU2VCInfo[] = {
// };
/*------------------------------------*/
const char *CaeUnsSU2FileExt[] = {
    "su2"
};
/*! \endcond */
...
\skip == CAEP_BCINFO*
\until ARRAYSIZE(CaeUnsSU2FileExt)
*/
