...
The resources for this tutorial can be found in the Tutorials/Inviscid_OneraM6 directory. You will need the configuration file (inv_ONERAM6.cfg) and the mesh file (mesh_ONERAM6_inv_ffd.su2).
