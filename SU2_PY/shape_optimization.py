...
def shape_optimization( filename                           ,
    ...
    xb_low        = [float(bound_lower)/float(accel_factor)]*n_dv      # lower dv bound it includes the line search acceleration factor
    xb_up         = [float(bound_upper)/float(accel_factor)]*n_dv      # upper dv bound it includes the line search acceleration fa
