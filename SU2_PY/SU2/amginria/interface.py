...
def merge_sol(mesh0, mesh1):
    ...
    mesh0['solution_tag'] = np.hstack((np.array(mesh0['solution_tag'],dtype='U'), \
                                       np.array(mesh1['solution_tag'],dtype='U'))).tolist()
...
def split_adj_sol(mesh):
    ...
    adj_sol['solution_tag'] = np.delete(np.array(mesh['solution_tag'],dtype='U'), np.s_[0:iAdj], axis=0).tolist()
    ...
    mesh['solution_tag'] = np.delete(np.array(mesh['solution_tag'],dtype='U'), np.s_[iAdj:nsol], axis=0).tolist()
