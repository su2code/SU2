...
void CMMSNSUnitQuadSolutionWallBC::GetSolution(const su2double *val_coords,
  ...
  su2double T = 0.25*TWall*(3.0 + fact*(a_T1*cos(Pi*(y-1.0))
              +                         a_T2*cos(Pi*(y-1.0)*2.0)));
...
void CMMSNSUnitQuadSolutionWallBC::GetMMSSourceTerm(const su2double *val_coords,
  ...
  const su2double t155 = 0.4e1 * t75 * v_0 * (t57 * t50 * t26 / 0.4e1 + (16.0 * (-t2 * t64 - t2 * t68 + t7 * t62 + t7 * t66) * rho_0) + t52)
                       + 0.4e1 * t2 * t92 - 0.4e1 * y * t92 - Conductivity * t111 * (-t102 * Pi * t41 - 0.4e1 * y * t43 * t97 + 0.4e1 * t104 * a_T2
                       - 0.2e1 * a_T2 + 0.2e1 * t32) * TWall - Conductivity * t111 * (-t102 * t31 * t115 - 0.4e1 * t118 * t115 * t104
                       + 0.4e1 * t118 * t116 * t115 - 0.12e2 * t43 * t97 - 0.3e1 * t42) * TWall * y + (32.0 * t75 * t61 * Viscosity)
                       - (4.0 * t2 * t61 * t138) + (4.0 * t62 * t138) + 0.128e3 / 0.3e1 * t75 * t20 * Viscosity + 0.64e2 / 0.3e1 * t2 * t20 * t149
                       - 0.64e2 / 0.3e1 * t66 * t149;
...
void CMMSNSTwoHalfCirclesSolution::GetBCState(const su2double *val_coords,
                                              const su2double val_t,
                                              su2double       *val_solution) {
...
void CMMSNSTwoHalfCirclesSolution::GetSolution(const su2double *val_coords,
                                               const su2double val_t,
                                               su2double       *val_solution) {
...
void CMMSNSTwoHalfCirclesSolution::GetMMSSourceTerm(const su2double *val_coords,
                                                    const su2double val_t,
                                                    su2double       *val_source) {
  ...
  const su2double t113 = (0.4e1 * y * t102 * t105 - 0.8e1 * y * t65 * t105 - 0.4e1 * t6 * t75 * u_0
                       +  0.4e1 * t102 * t99 - 0.8e1 * t65 * t99) * Viscosity;
  ...
  const su2double t137 = (0.4e1 * x * t102 * t121 - 0.8e1 * x * t65 * t121 - 0.4e1 * t6 * t75 * v_0
                       +  0.4e1 * t102 * t131 - 0.8e1 * t65 * t131) * Viscosity;
  ...
  const su2double t391 = -0.4e1 * t8 * t230 * t137 + 0.4e1 * t9 * t271 - 0.4e1 * t13 * t271
                        - 0.4e1 * t300 * (-t281 * y * t278 + t11 * a_T2 * y * t285 - Pi * t16 * t183
                        - 0.2e1 * a_T2 * t51 * y * t292 - t151 / 0.2e1) * t11 * TWall * t16
                        + 0.4e1 * t300 * t190 * t11 * TWall * t81 * t3 + 0.32e2 / 0.3e1 * t237 * t311 * t310
                        - 0.64e2 / 0.3e1 * t317 * t316 * y * t168 - 0.64e2 / 0.3e1 * t231 * t316 * t321
                        + 0.64e2 / 0.3e1 * y * t11 * t316 * t321 - 0.4e1 * t300 * x * (-t281 * x * t278
...
bool CMMSNSTwoHalfCirclesSolution::IsManufacturedSolution(void) {
  return true;
}
