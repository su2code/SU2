...
void CFEMStandardQuadAdjacentPrismSol::SolIntPoints(ColMajorMatrix<su2double> &matSolDOF,
...
void CFEMStandardQuadAdjacentPrismSol::ResidualBasisFunctions(ColMajorMatrix<su2double> &scalarDataInt,
...
void CFEMStandardQuadAdjacentPrismSol::ResidualGradientBasisFunctions(vector<ColMajorMatrix<su2double> > &vectorDataInt,
                                                                      ColMajorMatrix<su2double>          &resDOFs) {
