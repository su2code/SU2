...
CFEMStandardTriAdjacentPyraSol::CFEMStandardTriAdjacentPyraSol(const unsigned short val_nPoly,
  ...
  CFEMStandardPyraBase::LocalGridConnFaces();
...
void CFEMStandardTriAdjacentPyraSol::ResidualBasisFunctions(ColMajorMatrix<su2double> &scalarDataInt,
...
void CFEMStandardTriAdjacentPyraSol::ResidualGradientBasisFunctions(vector<ColMajorMatrix<su2double> > &vectorDataInt,
                                                                    ColMajorMatrix<su2double>          &resDOFs) {
