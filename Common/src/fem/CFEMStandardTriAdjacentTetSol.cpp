...
CFEMStandardTriAdjacentTetSol::CFEMStandardTriAdjacentTetSol(const unsigned short val_nPoly,
  ...
  CFEMStandardTetBase::LocalGridConnFaces();
...
void CFEMStandardTriAdjacentTetSol::GradSolIntPoints(ColMajorMatrix<su2double>          &matSolDOF,
...
void CFEMStandardTriAdjacentTetSol::SolIntPoints(ColMajorMatrix<su2double> &matSolDOF,
...
void CFEMStandardTriAdjacentTetSol::ResidualGradientBasisFunctions(vector<ColMajorMatrix<su2double> > &vectorDataInt,
                                                                   ColMajorMatrix<su2double>          &resDOFs) {
