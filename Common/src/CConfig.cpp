...
void CConfig::SetGlobalParam(MAIN_SOLVER val_solver,
  ...
  switch (val_solver) {
    ...
    case MAIN_SOLVER::RANS: case MAIN_SOLVER::INC_RANS:
      ...
      break;
    case MAIN_SOLVER::FEM_EULER: case MAIN_SOLVER::FEM_INC_EULER:
      if (val_system == RUNTIME_FLOW_SYS) {
      ...
      break;
    case MAIN_SOLVER::FEM_NAVIER_STOKES: case MAIN_SOLVER::FEM_INC_NAVIER_STOKES:
      if (val_system == RUNTIME_FLOW_SYS) {
        SetKind_ConvNumScheme(Kind_ConvNumScheme_Flow, Kind_Centered_Flow,
                              Kind_Upwind_Flow, Kind_SlopeLimit_Flow,
                              MUSCL_Flow, Kind_FEM_Flow);
      ...
      break;
    case MAIN_SOLVER::FEM_LES: case MAIN_SOLVER::FEM_INC_LES:
      if (val_system == RUNTIME_FLOW_SYS) {
        SetKind_ConvNumScheme(Kind_ConvNumScheme_Flow, Kind_Centered_Flow,
                              Kind_Upwind_Flow, Kind_SlopeLimit_Flow,
                              MUSCL_Flow, Kind_FEM_Flow);
