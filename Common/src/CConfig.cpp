...
# endif
 ...
 /* DESCRIPTION: default value for AIR */
  ...
  /*!\brief MG_DAMP_RESTRICTION\n DESCRIPTION: Initial damping factor for the residual restriction. DEFAULT: 0.5 \ingroup Config*/
  addDoubleOption("MG_DAMP_RESTRICTION", Damp_Res_Restric, 0.5);
  /*!\brief MG_DAMP_PROLONGATION\n DESCRIPTION: Initial damping factor for the correction prolongation. DEFAULT 0.5 \ingroup Config*/
