...
void CConfig::SetConfig_Options() {
 ...
 /* DESCRIPTION: default value for AIR */
  ...
  addStringOption("OBJECTIVE_FUNCTION_NEW", ObjectiveFunction, "");
...
bool CConfig::GetInlet(unsigned short iMarker) const {
  return ((Marker_All_KindBC[iMarker] == INLET_FLOW) ||
          (Marker_All_KindBC[iMarker] == OUTLET_FLOW) ||
          (Marker_All_KindBC[iMarker] == ACTDISK_INLET) ||
          (Marker_All_KindBC[iMarker] == ACTDISK_OUTLET)||
          (Marker_All_KindBC[iMarker] == ENGINE_INFLOW) ||
          (Marker_All_KindBC[iMarker] == ENGINE_EXHAUST));
}
