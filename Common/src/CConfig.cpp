...
void CConfig::SetConfig_Options() {
  ...
  addEnumOption("SOLVER", Kind_Solver, Solver_Map, ENUM_MAIN_SOLVER::NONE);
...
void CConfig::SetnZone(){
  ...
  if (Multizone_Problem == NO && Kind_Solver != ENUM_MAIN_SOLVER::MULTIPHYSICS){
    nZone = 1;
  }

  if (Kind_Solver == ENUM_MAIN_SOLVER::MULTIPHYSICS){
...
void CConfig::SetPostprocessing(SU2_COMPONENT val_software, unsigned short val_izone, unsigned short val_nDim) {
  ...
  if (Kind_Solver == ENUM_MAIN_SOLVER::NAVIER_STOKES && Kind_Turb_Model != TURB_MODEL::NONE){
    SU2_MPI::Error("KIND_TURB_MODEL must be NONE if SOLVER= NAVIER_STOKES", CURRENT_FUNCTION);
  }
  if (Kind_Solver == ENUM_MAIN_SOLVER::INC_NAVIER_STOKES && Kind_Turb_Model != TURB_MODEL::NONE){
    SU2_MPI::Error("KIND_TURB_MODEL must be NONE if SOLVER= INC_NAVIER_STOKES", CURRENT_FUNCTION);
  }
  if (Kind_Solver == ENUM_MAIN_SOLVER::RANS && Kind_Turb_Model == TURB_MODEL::NONE){
    SU2_MPI::Error("A turbulence model must be specified with KIND_TURB_MODEL if SOLVER= RANS", CURRENT_FUNCTION);
  }
  if (Kind_Solver == ENUM_MAIN_SOLVER::INC_RANS && Kind_Turb_Model == TURB_MODEL::NONE){
  ...
  if (nMarker_WallFunctions > 0) {
    for (iMarker = 0; iMarker < nMarker_WallFunctions; iMarker++) {
      ...
      if (Kind_WallFunctions[iMarker] == WALL_FUNCTIONS::STANDARD_FUNCTION) {
        if (!((Kind_Solver == ENUM_MAIN_SOLVER::RANS) || (Kind_Solver == ENUM_MAIN_SOLVER::INC_RANS)))
  ...
  if (Kind_Solver == ENUM_MAIN_SOLVER::INC_EULER ||
      Kind_Solver == ENUM_MAIN_SOLVER::INC_NAVIER_STOKES ||
      Kind_Solver == ENUM_MAIN_SOLVER::INC_RANS) {
  ...
  if (Kind_Solver == ENUM_MAIN_SOLVER::EULER ||
      Kind_Solver == ENUM_MAIN_SOLVER::NAVIER_STOKES ||
      Kind_Solver == ENUM_MAIN_SOLVER::RANS ||
      Kind_Solver == ENUM_MAIN_SOLVER::NEMO_EULER ||
      Kind_Solver == ENUM_MAIN_SOLVER::NEMO_NAVIER_STOKES ||
  ...
  } else if (Kind_Solver == ENUM_MAIN_SOLVER::INC_EULER ||
             Kind_Solver == ENUM_MAIN_SOLVER::INC_NAVIER_STOKES ||
             Kind_Solver == ENUM_MAIN_SOLVER::INC_RANS){
  ...
  if (Kind_Solver == ENUM_MAIN_SOLVER::FEM_ELASTICITY) {
    nMGLevels = 0;
  ...
  if ((Kind_Solver != ENUM_MAIN_SOLVER::EULER && Kind_Solver != ENUM_MAIN_SOLVER::NAVIER_STOKES && Kind_Solver != ENUM_MAIN_SOLVER::RANS) && (TimeMarching == TIME_MARCHING::HARMONIC_BALANCE)){
  ...
  if (ideal_gas && (Kind_Solver != ENUM_MAIN_SOLVER::INC_EULER && Kind_Solver != ENUM_MAIN_SOLVER::INC_NAVIER_STOKES && Kind_Solver != ENUM_MAIN_SOLVER::INC_RANS)) {
    if (SystemMeasurements == US && standard_air) {
  ...
  if (Kind_InitOption == REYNOLDS){
    if ((Kind_Solver == ENUM_MAIN_SOLVER::NAVIER_STOKES || Kind_Solver == ENUM_MAIN_SOLVER::RANS) && Reynolds <=0){
  ...
  if (Kind_Solver == ENUM_MAIN_SOLVER::EULER ||
      Kind_Solver == ENUM_MAIN_SOLVER::INC_EULER ||
      Kind_Solver == ENUM_MAIN_SOLVER::NEMO_EULER ||
      Kind_Solver == ENUM_MAIN_SOLVER::FEM_EULER)
    Kind_Turb_Model = TURB_MODEL::NONE;
  ...
  if (ContinuousAdjoint) {
    if (Kind_Solver == ENUM_MAIN_SOLVER::EULER) Kind_Solver = ENUM_MAIN_SOLVER::ADJ_EULER;
    if (Kind_Solver == ENUM_MAIN_SOLVER::NAVIER_STOKES) Kind_Solver = ENUM_MAIN_SOLVER::ADJ_NAVIER_STOKES;
    if (Kind_Solver == ENUM_MAIN_SOLVER::RANS) Kind_Solver = ENUM_MAIN_SOLVER::ADJ_RANS;
  }
  ...
  if ((Kind_SU2 == SU2_COMPONENT::SU2_CFD) && (Kind_Solver == ENUM_MAIN_SOLVER::NONE)) {
    SU2_MPI::Error("PHYSICAL_PROBLEM must be set in the configuration file", CURRENT_FUNCTION);
  }

  /*--- Set a flag for viscous simulations ---*/

  Viscous = (( Kind_Solver == ENUM_MAIN_SOLVER::NAVIER_STOKES          ) ||
             ( Kind_Solver == ENUM_MAIN_SOLVER::NEMO_NAVIER_STOKES     ) ||
             ( Kind_Solver == ENUM_MAIN_SOLVER::ADJ_NAVIER_STOKES      ) ||
             ( Kind_Solver == ENUM_MAIN_SOLVER::RANS                   ) ||
             ( Kind_Solver == ENUM_MAIN_SOLVER::ADJ_RANS               ) ||
             ( Kind_Solver == ENUM_MAIN_SOLVER::FEM_NAVIER_STOKES      ) ||
             ( Kind_Solver == ENUM_MAIN_SOLVER::FEM_RANS               ) ||
             ( Kind_Solver == ENUM_MAIN_SOLVER::FEM_LES                ) ||
             ( Kind_Solver == ENUM_MAIN_SOLVER::INC_NAVIER_STOKES      ) ||
  ...
  if ((Kind_Solver == ENUM_MAIN_SOLVER::FEM_EULER)         ||
      (Kind_Solver == ENUM_MAIN_SOLVER::FEM_NAVIER_STOKES) ||
      (Kind_Solver == ENUM_MAIN_SOLVER::FEM_RANS)          ||
      (Kind_Solver == ENUM_MAIN_SOLVER::FEM_LES)) {
  ...
  if (Kind_Solver == ENUM_MAIN_SOLVER::RANS && Kind_Turb_Model != TURB_MODEL::SST && Kind_Turb_Model != TURB_MODEL::SST_SUST && using_uq){
  ...
  if (Kind_Solver == ENUM_MAIN_SOLVER::INC_NAVIER_STOKES || Kind_Solver == ENUM_MAIN_SOLVER::INC_RANS) {
    if (Kind_ViscosityModel == VISCOSITYMODEL::SUTHERLAND) {
      if ((Kind_FluidModel != INC_IDEAL_GAS) && (Kind_FluidModel != INC_IDEAL_GAS_POLY)) {
  ...
  if ((Kind_Solver == ENUM_MAIN_SOLVER::INC_EULER || Kind_Solver == ENUM_MAIN_SOLVER::INC_NAVIER_STOKES || Kind_Solver == ENUM_MAIN_SOLVER::INC_RANS) && (Kind_FluidModel == INC_IDEAL_GAS_POLY)) {
    su2double sum = 0.0;
  ...
  if (((Kind_Solver == ENUM_MAIN_SOLVER::INC_EULER || Kind_Solver == ENUM_MAIN_SOLVER::INC_NAVIER_STOKES || Kind_Solver == ENUM_MAIN_SOLVER::INC_RANS)) && (Kind_ViscosityModel == VISCOSITYMODEL::POLYNOMIAL)) {
    su2double sum = 0.0;
    for (unsigned short iVar = 0; iVar < N_POLY_COEFFS; iVar++) {
  ...
  if ((Kind_Solver == ENUM_MAIN_SOLVER::INC_EULER || Kind_Solver == ENUM_MAIN_SOLVER::INC_NAVIER_STOKES || Kind_Solver == ENUM_MAIN_SOLVER::INC_RANS) && (Kind_ConductivityModel == CONDUCTIVITYMODEL::POLYNOMIAL)) {
    su2double sum = 0.0;
    for (unsigned short iVar = 0; iVar < N_POLY_COEFFS; iVar++) {
  ...
  if ((Kind_Solver == ENUM_MAIN_SOLVER::INC_EULER || Kind_Solver == ENUM_MAIN_SOLVER::INC_NAVIER_STOKES || Kind_Solver == ENUM_MAIN_SOLVER::INC_RANS) && (SystemMeasurements == US)) {
  ...
  if ((Kind_Solver == ENUM_MAIN_SOLVER::INC_EULER || Kind_Solver == ENUM_MAIN_SOLVER::INC_NAVIER_STOKES || Kind_Solver == ENUM_MAIN_SOLVER::INC_RANS) && (nMarker_Inlet != 0)) {
  ...
  if ((Kind_Solver == ENUM_MAIN_SOLVER::INC_EULER || Kind_Solver == ENUM_MAIN_SOLVER::INC_NAVIER_STOKES || Kind_Solver == ENUM_MAIN_SOLVER::INC_RANS) && (nMarker_Outlet != 0)) {
  ...
  if ((Kind_Solver != ENUM_MAIN_SOLVER::RANS) &&
      (Kind_Solver != ENUM_MAIN_SOLVER::ADJ_RANS) &&
      (Kind_Solver != ENUM_MAIN_SOLVER::DISC_ADJ_RANS) &&
      (Kind_Solver != ENUM_MAIN_SOLVER::INC_RANS) &&
      (Kind_Solver != ENUM_MAIN_SOLVER::DISC_ADJ_INC_RANS)){
  ...
  if (DiscreteAdjoint) {
    ...
    switch(Kind_Solver) {
      case ENUM_MAIN_SOLVER::EULER:
        Kind_Solver = ENUM_MAIN_SOLVER::DISC_ADJ_EULER;
        break;
      case ENUM_MAIN_SOLVER::RANS:
        Kind_Solver = ENUM_MAIN_SOLVER::DISC_ADJ_RANS;
        break;
      case ENUM_MAIN_SOLVER::NAVIER_STOKES:
        Kind_Solver = ENUM_MAIN_SOLVER::DISC_ADJ_NAVIER_STOKES;
        break;
      case ENUM_MAIN_SOLVER::INC_EULER:
        Kind_Solver = ENUM_MAIN_SOLVER::DISC_ADJ_INC_EULER;
        break;
      case ENUM_MAIN_SOLVER::INC_RANS:
        Kind_Solver = ENUM_MAIN_SOLVER::DISC_ADJ_INC_RANS;
        break;
      case ENUM_MAIN_SOLVER::INC_NAVIER_STOKES:
        Kind_Solver = ENUM_MAIN_SOLVER::DISC_ADJ_INC_NAVIER_STOKES;
        break;
      case ENUM_MAIN_SOLVER::FEM_EULER :
        Kind_Solver = ENUM_MAIN_SOLVER::DISC_ADJ_FEM_EULER;
        break;
      case ENUM_MAIN_SOLVER::FEM_RANS :
        Kind_Solver = ENUM_MAIN_SOLVER::DISC_ADJ_FEM_RANS;
        break;
      case ENUM_MAIN_SOLVER::FEM_NAVIER_STOKES :
        Kind_Solver = ENUM_MAIN_SOLVER::DISC_ADJ_FEM_NS;
        break;
      case ENUM_MAIN_SOLVER::FEM_ELASTICITY:
        Kind_Solver = ENUM_MAIN_SOLVER::DISC_ADJ_FEM;
        break;
      case ENUM_MAIN_SOLVER::HEAT_EQUATION:
        Kind_Solver = ENUM_MAIN_SOLVER::DISC_ADJ_HEAT;
        break;
      default:
        break;
    }
...
void CConfig::SetOutput(SU2_COMPONENT val_software, unsigned short val_izone) {
  ...
  bool fea = ((Kind_Solver == ENUM_MAIN_SOLVER::FEM_ELASTICITY) || (Kind_Solver == ENUM_MAIN_SOLVER::DISC_ADJ_FEM));
  ...
  if (val_software == SU2_COMPONENT::SU2_CFD) {
    ...
    switch (Kind_Solver) {
      case ENUM_MAIN_SOLVER::EULER:     case ENUM_MAIN_SOLVER::DISC_ADJ_EULER:
      case ENUM_MAIN_SOLVER::INC_EULER: case ENUM_MAIN_SOLVER::DISC_ADJ_INC_EULER:
      case ENUM_MAIN_SOLVER::FEM_EULER: case ENUM_MAIN_SOLVER::DISC_ADJ_FEM_EULER:
        ...
        break;
      case ENUM_MAIN_SOLVER::NAVIER_STOKES:     case ENUM_MAIN_SOLVER::DISC_ADJ_NAVIER_STOKES:
      case ENUM_MAIN_SOLVER::INC_NAVIER_STOKES: case ENUM_MAIN_SOLVER::DISC_ADJ_INC_NAVIER_STOKES:
      case ENUM_MAIN_SOLVER::FEM_NAVIER_STOKES: case ENUM_MAIN_SOLVER::DISC_ADJ_FEM_NS:
        ...
        break;
      case ENUM_MAIN_SOLVER::RANS:     case ENUM_MAIN_SOLVER::DISC_ADJ_RANS:
      case ENUM_MAIN_SOLVER::INC_RANS: case ENUM_MAIN_SOLVER::DISC_ADJ_INC_RANS:
      case ENUM_MAIN_SOLVER::FEM_RANS: case ENUM_MAIN_SOLVER::DISC_ADJ_FEM_RANS:
      ...
      case ENUM_MAIN_SOLVER::FEM_LES:
        ...
        break;
      case ENUM_MAIN_SOLVER::FEM_ELASTICITY: case ENUM_MAIN_SOLVER::DISC_ADJ_FEM:
        ...
        break;
      case ENUM_MAIN_SOLVER::ADJ_EULER: cout << "Continuous Euler adjoint equations." << endl; break;
    ...
    if ((Kind_Regime == ENUM_REGIME::COMPRESSIBLE) && (Kind_Solver != ENUM_MAIN_SOLVER::FEM_ELASTICITY)) {
    ...
    if (Restart) {
      ...
      if (!ContinuousAdjoint && Kind_Solver != ENUM_MAIN_SOLVER::FEM_ELASTICITY) cout << "Read flow solution from: " << Solution_FileName << "." << endl;
  ...
  if (val_software == SU2_COMPONENT::SU2_CFD) {
    ...
    if ((Kind_Solver == ENUM_MAIN_SOLVER::EULER)          || (Kind_Solver == ENUM_MAIN_SOLVER::NAVIER_STOKES)          || (Kind_Solver == ENUM_MAIN_SOLVER::RANS) ||
        (Kind_Solver == ENUM_MAIN_SOLVER::INC_EULER)      || (Kind_Solver == ENUM_MAIN_SOLVER::INC_NAVIER_STOKES)      || (Kind_Solver == ENUM_MAIN_SOLVER::INC_RANS) ||
        (Kind_Solver == ENUM_MAIN_SOLVER::NEMO_EULER)     || (Kind_Solver == ENUM_MAIN_SOLVER::NEMO_NAVIER_STOKES)     ||
        (Kind_Solver == ENUM_MAIN_SOLVER::DISC_ADJ_EULER) || (Kind_Solver == ENUM_MAIN_SOLVER::DISC_ADJ_NAVIER_STOKES) || (Kind_Solver == ENUM_MAIN_SOLVER::DISC_ADJ_RANS) ) {
      ...
      if (Kind_ConvNumScheme_Flow == SPACE_UPWIND) {
        ...
        if (Kind_Solver == ENUM_MAIN_SOLVER::EULER         || Kind_Solver == ENUM_MAIN_SOLVER::DISC_ADJ_EULER ||
            Kind_Solver == ENUM_MAIN_SOLVER::NAVIER_STOKES || Kind_Solver == ENUM_MAIN_SOLVER::DISC_ADJ_NAVIER_STOKES ||
            Kind_Solver == ENUM_MAIN_SOLVER::RANS          || Kind_Solver == ENUM_MAIN_SOLVER::DISC_ADJ_RANS) {
    ...
    if ((Kind_Solver == ENUM_MAIN_SOLVER::RANS) || (Kind_Solver == ENUM_MAIN_SOLVER::DISC_ADJ_RANS)) {
    ...
    if ((Kind_Solver == ENUM_MAIN_SOLVER::ADJ_EULER) || (Kind_Solver == ENUM_MAIN_SOLVER::ADJ_NAVIER_STOKES) || (Kind_Solver == ENUM_MAIN_SOLVER::ADJ_RANS)) {
    ...
    if ((Kind_Solver == ENUM_MAIN_SOLVER::ADJ_RANS) && (!Frozen_Visc_Cont)) {
    ...
    if ((Kind_Solver == ENUM_MAIN_SOLVER::NAVIER_STOKES) || (Kind_Solver == ENUM_MAIN_SOLVER::RANS) ||
        (Kind_Solver == ENUM_MAIN_SOLVER::INC_NAVIER_STOKES) || (Kind_Solver == ENUM_MAIN_SOLVER::INC_RANS) ||
        (Kind_Solver == ENUM_MAIN_SOLVER::NEMO_NAVIER_STOKES) ||
        (Kind_Solver == ENUM_MAIN_SOLVER::DISC_ADJ_INC_NAVIER_STOKES) || (Kind_Solver == ENUM_MAIN_SOLVER::DISC_ADJ_INC_RANS) ||
        (Kind_Solver == ENUM_MAIN_SOLVER::DISC_ADJ_NAVIER_STOKES) || (Kind_Solver == ENUM_MAIN_SOLVER::DISC_ADJ_RANS)) {
        cout << "Average of gradients with correction (viscous flow terms)." << endl;
    }

    if ((Kind_Solver == ENUM_MAIN_SOLVER::ADJ_NAVIER_STOKES) || (Kind_Solver == ENUM_MAIN_SOLVER::ADJ_RANS)) {
      cout << "Average of gradients with correction (viscous adjoint terms)." << endl;
    }

    if ((Kind_Solver == ENUM_MAIN_SOLVER::RANS) || (Kind_Solver == ENUM_MAIN_SOLVER::DISC_ADJ_RANS) || (Kind_Solver == ENUM_MAIN_SOLVER::INC_RANS) || (Kind_Solver == ENUM_MAIN_SOLVER::DISC_ADJ_INC_RANS) ) {
    ...
    if(Kind_Solver != ENUM_MAIN_SOLVER::FEM_EULER && Kind_Solver != ENUM_MAIN_SOLVER::FEM_NAVIER_STOKES &&
       Kind_Solver != ENUM_MAIN_SOLVER::FEM_RANS  && Kind_Solver != ENUM_MAIN_SOLVER::FEM_LES &&
       Kind_Solver != ENUM_MAIN_SOLVER::DISC_ADJ_FEM_EULER && Kind_Solver != ENUM_MAIN_SOLVER::DISC_ADJ_FEM_NS &&
       Kind_Solver != ENUM_MAIN_SOLVER::DISC_ADJ_FEM_RANS) {
      if (!fea){
    ...
    if(Kind_Solver == ENUM_MAIN_SOLVER::FEM_EULER || Kind_Solver == ENUM_MAIN_SOLVER::FEM_NAVIER_STOKES ||
      ...
      if(Kind_FEM_Flow == DG) {
        ...
        if(Kind_Solver != ENUM_MAIN_SOLVER::FEM_EULER && Kind_Solver != ENUM_MAIN_SOLVER::DISC_ADJ_FEM_EULER) {
    ...
    if ((Kind_Solver == ENUM_MAIN_SOLVER::EULER) || (Kind_Solver == ENUM_MAIN_SOLVER::NAVIER_STOKES) || (Kind_Solver == ENUM_MAIN_SOLVER::RANS) ||
        (Kind_Solver == ENUM_MAIN_SOLVER::INC_EULER) || (Kind_Solver == ENUM_MAIN_SOLVER::INC_NAVIER_STOKES) || (Kind_Solver == ENUM_MAIN_SOLVER::INC_RANS) ||
        (Kind_Solver == ENUM_MAIN_SOLVER::NEMO_EULER) || (Kind_Solver == ENUM_MAIN_SOLVER::NEMO_NAVIER_STOKES) ||
        (Kind_Solver == ENUM_MAIN_SOLVER::DISC_ADJ_INC_EULER) || (Kind_Solver == ENUM_MAIN_SOLVER::DISC_ADJ_INC_NAVIER_STOKES) || (Kind_Solver == ENUM_MAIN_SOLVER::DISC_ADJ_INC_RANS) ||
        (Kind_Solver == ENUM_MAIN_SOLVER::DISC_ADJ_EULER) || (Kind_Solver == ENUM_MAIN_SOLVER::DISC_ADJ_NAVIER_STOKES) || (Kind_Solver == ENUM_MAIN_SOLVER::DISC_ADJ_RANS) ||
        (Kind_Solver == ENUM_MAIN_SOLVER::DISC_ADJ_FEM_EULER) || (Kind_Solver == ENUM_MAIN_SOLVER::DISC_ADJ_FEM_NS) || (Kind_Solver == ENUM_MAIN_SOLVER::DISC_ADJ_FEM_RANS)) {
    ...
    if ((Kind_Solver != ENUM_MAIN_SOLVER::FEM_ELASTICITY) && (Kind_Solver != ENUM_MAIN_SOLVER::DISC_ADJ_FEM)) {
    ...
    if ((Kind_Solver == ENUM_MAIN_SOLVER::RANS) || (Kind_Solver == ENUM_MAIN_SOLVER::DISC_ADJ_RANS) ||
        (Kind_Solver == ENUM_MAIN_SOLVER::INC_RANS) || (Kind_Solver == ENUM_MAIN_SOLVER::DISC_ADJ_INC_RANS))
      if (Kind_TimeIntScheme_Turb == EULER_IMPLICIT)
...
void CConfig::SetGlobalParam(ENUM_MAIN_SOLVER val_solver,
  ...
  switch (val_solver) {
    case ENUM_MAIN_SOLVER::EULER: case ENUM_MAIN_SOLVER::INC_EULER: case ENUM_MAIN_SOLVER::NEMO_EULER:
      ...
      break;
    case ENUM_MAIN_SOLVER::NAVIER_STOKES: case ENUM_MAIN_SOLVER::INC_NAVIER_STOKES: case ENUM_MAIN_SOLVER::NEMO_NAVIER_STOKES:
      if (val_system == RUNTIME_FLOW_SYS) {
        SetKind_ConvNumScheme(Kind_ConvNumScheme_Flow, Kind_Centered_Flow,
                              Kind_Upwind_Flow, Kind_SlopeLimit_Flow,
                              MUSCL_Flow, NONE);
