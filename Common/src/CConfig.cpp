...
CConfig::CConfig(char case_filename[MAX_STRING_SIZE], SU2_COMPONENT val_software, bool verb_high) {
  ...
  /*--- Set the default values for all the options that weren't set. ---*/
...
// enum types work differently than all the others because there are a small number of valid
...
CConfig::~CConfig() {
 ...
 /*--- Delete all the option objects in the global option map ---*/
