...
unsigned short FEMStandardElementBaseClass::GetNIntegrationStatic(unsigned short VTK_Type,
...
void FEMStandardElementBaseClass::IntegrationPointsPyramid(void) {
  ...
  switch( orderExact ) {
    ...
    case  9: nIntegration =  62; break;
    default:
      cout << "FEMStandardElementBaseClass::IntegrationPointsPyramid: Polynomial order not supported" << endl;
#ifndef HAVE_MPI
    exit(EXIT_FAILURE);
#else
    MPI_Abort(MPI_COMM_WORLD,1);
