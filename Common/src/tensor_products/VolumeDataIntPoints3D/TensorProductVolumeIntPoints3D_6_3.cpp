/*!
 * \file TensorProductVolumeIntPoints3D_6_3.cpp
 * \brief Function, which carries out the tensor product for (nDOFs1D,nInt1D) = (6,3)
...
void TensorProductVolumeIntPoints3D_6_3(const int           N,
                                        const int           ldb,
                                        const int           ldc,
