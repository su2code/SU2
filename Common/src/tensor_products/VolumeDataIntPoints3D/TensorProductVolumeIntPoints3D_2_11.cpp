/*!
 * \file TensorProductVolumeIntPoints3D_2_11.cpp
 * \brief Function, which carries out the tensor product for (nDOFs1D,nInt1D) = (2,11)
...
void TensorProductVolumeIntPoints3D_2_11(const int           N,
                                         const int           ldb,
                                         const int           ldc,
  ...
  for(int l=0; l<N; ++l) {
    ...
    su2double       (*c)[11][11] = (su2double (*)[11][11]) &C[l*ldc];
