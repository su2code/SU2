/*!
 * \file TensorProductVolumeIntPoints3D_6_8.cpp
 * \brief Function, which carries out the tensor product for (nDOFs1D,nInt1D) = (6,8)
...
void TensorProductVolumeIntPoints3D_6_8(const int           N,
  ...
  su2double tmpK[6][6][8];
  su2double tmpJ[8][6][8];
