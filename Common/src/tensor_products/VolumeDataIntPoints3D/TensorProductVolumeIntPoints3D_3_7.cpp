/*!
 * \file TensorProductVolumeIntPoints3D_3_7.cpp
 * \brief Function, which carries out the tensor product for (nDOFs1D,nInt1D) = (3,7)
...
void TensorProductVolumeIntPoints3D_3_7(const int           N,
  ...
  const int MP = CFEMStandardElementBase::PaddedValue(7);
  ...
  su2double tmpK[3][3][MP];
  su2double tmpJ[7][3][MP];
  ...
  for(int l=0; l<N; ++l) {
    ...
    su2double       (*c)[7][7] = (su2double (*)[7][7]) &C[l*ldc];
