/*!
 * \file TensorProductVolumeIntPoints3D_7_3.cpp
 * \brief Function, which carries out the tensor product for (nDOFs1D,nInt1D) = (7,3)
...
void TensorProductVolumeIntPoints3D_7_3(const int           N,
                                        const int           ldb,
                                        const int           ldc,
  ...
  su2double tmpK[7][7][MP];
  su2double tmpJ[3][7][MP];
