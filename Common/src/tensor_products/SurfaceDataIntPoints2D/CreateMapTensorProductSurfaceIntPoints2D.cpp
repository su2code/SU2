...
void CreateMapTensorProductSurfaceIntPoints2D(map<CUnsignedShort2T, TPIS2D> &mapFunctions) {
  ...
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceIntPoints2D_2_1);
  ...
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceIntPoints2D_2_6);

  nDOFsAndInt.short0 = 2; nDOFsAndInt.short1 = 7;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceIntPoints2D_2_7);

  nDOFsAndInt.short0 = 2; nDOFsAndInt.short1 = 8;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceIntPoints2D_2_8);

  nDOFsAndInt.short0 = 2; nDOFsAndInt.short1 = 9;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceIntPoints2D_2_9);

  nDOFsAndInt.short0 = 2; nDOFsAndInt.short1 = 10;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceIntPoints2D_2_10);

  nDOFsAndInt.short0 = 2; nDOFsAndInt.short1 = 11;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceIntPoints2D_2_11);

  nDOFsAndInt.short0 = 2; nDOFsAndInt.short1 = 12;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceIntPoints2D_2_12);

  nDOFsAndInt.short0 = 2; nDOFsAndInt.short1 = 13;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceIntPoints2D_2_13);

  nDOFsAndInt.short0 = 2; nDOFsAndInt.short1 = 14;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceIntPoints2D_2_14);

  nDOFsAndInt.short0 = 2; nDOFsAndInt.short1 = 15;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceIntPoints2D_2_15);

  nDOFsAndInt.short0 = 3; nDOFsAndInt.short1 = 1;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceIntPoints2D_3_1);

  nDOFsAndInt.short0 = 3; nDOFsAndInt.short1 = 2;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceIntPoints2D_3_2);
  ...
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceIntPoints2D_8_11);
