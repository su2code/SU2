/*!
 * \file TensorProductSurfaceIntPoints2D_2_13.cpp
 * \brief Function, which carries out the tensor product for (nDOFs1D,nInt1D) = (2,13)
...
void TensorProductSurfaceIntPoints2D_2_13(const int           N,
                                          const int           faceID,
                                          const int           ldb,
                                          const int           ldc,
