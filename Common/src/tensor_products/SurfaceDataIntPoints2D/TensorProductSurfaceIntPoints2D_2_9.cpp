/*!
 * \file TensorProductSurfaceIntPoints2D_2_9.cpp
 * \brief Function, which carries out the tensor product for (nDOFs1D,nInt1D) = (2,9)
...
void TensorProductSurfaceIntPoints2D_2_9(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
