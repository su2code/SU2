/*!
 * \file TensorProductVolumeIntPoints2D_4_1.cpp
 * \brief Function, which carries out the tensor product for (nDOFs1D,nInt1D) = (4,1)
...
void TensorProductVolumeIntPoints2D_4_1(const int           N,
  ...
  const int MP = CFEMStandardElementBase::PaddedValue(1);
