/*!
 * \file TensorProductSurfaceIntPoints3D_4_6.cpp
...
void TensorProductSurfaceIntPoints3D_4_6(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
  ...
  for(int l=0; l<N; ++l) {
    ...
    for(int j=0; j<4; ++j) {
      ...
      for(int i=0; i<4; ++i) bFace[j][i] = 0.0;
    }
