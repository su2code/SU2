/*!
 * \file TensorProductSurfaceIntPoints3D_5_6.cpp
...
void TensorProductSurfaceIntPoints3D_5_6(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
  ...
  for(int l=0; l<N; ++l) {
    ...
    for(int j=0; j<5; ++j) {
      SU2_OMP_SIMD_(safelen(5))
      for(int i=0; i<5; ++i) bFace[j][i] = 0.0;
    }
