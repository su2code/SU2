/*!
 * \file TensorProductSurfaceIntPoints3D_3_8.cpp
 * \brief Function, which carries out the tensor product for (nDOFs1D,nInt1D) = (3,8)
...
void TensorProductSurfaceIntPoints3D_3_8(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
