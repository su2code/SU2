/*!
 * \file TensorProductSurfaceIntPoints3D_2_3.cpp
 * \brief Function, which carries out the tensor product for (nDOFs1D,nInt1D) = (2,3)
...
void TensorProductSurfaceIntPoints3D_2_3(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
