/*!
 * \file TensorProductSurfaceResVolumeDOFs3D_2_2.cpp
 * \brief Function, which carries out the tensor product for (nDOFs1D,nInt1D) = (2,2)
...
void TensorProductSurfaceResVolumeDOFs3D_2_2(const int           N,
  ...
  const int KP = CFEMStandardElementBase::PaddedValue(2);
  ...
  su2double bFace[2][KP];
  su2double tmpI[2][KP], tmpJ[2][2];
