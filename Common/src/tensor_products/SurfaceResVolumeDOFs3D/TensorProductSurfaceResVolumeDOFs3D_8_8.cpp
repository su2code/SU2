/*!
 * \file TensorProductSurfaceResVolumeDOFs3D_8_8.cpp
 * \brief Function, which carries out the tensor product for (nDOFs1D,nInt1D) = (8,8)
...
void TensorProductSurfaceResVolumeDOFs3D_8_8(const int           N,
  ...
  const int KP = CFEMStandardElementBase::PaddedValue(8);
