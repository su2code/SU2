/*!
 * \file CreateMapTensorProductSurfaceResVolumeDOFs3D
...
void CreateMapTensorProductSurfaceResVolumeDOFs3D(map<CUnsignedShort2T, TPDR3D> &mapFunctions) {
  ...
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs3D_7_12);
  ...
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs3D_8_11);
