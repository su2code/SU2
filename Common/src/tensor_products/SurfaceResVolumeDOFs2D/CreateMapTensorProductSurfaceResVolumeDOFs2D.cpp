...
void CreateMapTensorProductSurfaceResVolumeDOFs2D(map<CUnsignedShort2T, TPDR2D> &mapFunctions) {
  ...
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_1_2);

  nDOFsAndInt.short0 = 1; nDOFsAndInt.short1 = 3;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_1_3);

  nDOFsAndInt.short0 = 1; nDOFsAndInt.short1 = 4;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_1_4);

  nDOFsAndInt.short0 = 1; nDOFsAndInt.short1 = 5;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_1_5);
  ...
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_2_3);

  nDOFsAndInt.short0 = 2; nDOFsAndInt.short1 = 4;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_2_4);

  nDOFsAndInt.short0 = 2; nDOFsAndInt.short1 = 5;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_2_5);
  ...
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_3_4);

  nDOFsAndInt.short0 = 3; nDOFsAndInt.short1 = 5;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_3_5);

  nDOFsAndInt.short0 = 3; nDOFsAndInt.short1 = 6;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_3_6);

  nDOFsAndInt.short0 = 3; nDOFsAndInt.short1 = 7;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_3_7);

  nDOFsAndInt.short0 = 3; nDOFsAndInt.short1 = 8;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_3_8);
  ...
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_4_5);

  nDOFsAndInt.short0 = 4; nDOFsAndInt.short1 = 6;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_4_6);

  nDOFsAndInt.short0 = 4; nDOFsAndInt.short1 = 7;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_4_7);

  nDOFsAndInt.short0 = 4; nDOFsAndInt.short1 = 8;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_4_8);
  ...
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_5_6);

  nDOFsAndInt.short0 = 5; nDOFsAndInt.short1 = 7;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_5_7);

  nDOFsAndInt.short0 = 5; nDOFsAndInt.short1 = 8;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_5_8);
  ...
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_6_7);

  nDOFsAndInt.short0 = 6; nDOFsAndInt.short1 = 8;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_6_8);

  nDOFsAndInt.short0 = 6; nDOFsAndInt.short1 = 9;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_6_9);
  ...
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_7_8);

  nDOFsAndInt.short0 = 7; nDOFsAndInt.short1 = 9;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_7_9);

  nDOFsAndInt.short0 = 7; nDOFsAndInt.short1 = 12;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_7_12);
  ...
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_8_13);
  ...
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_9_13);

  nDOFsAndInt.short0 = 9; nDOFsAndInt.short1 = 14;
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_9_14);
  ...
  mapFunctions.emplace(nDOFsAndInt, &TensorProductSurfaceResVolumeDOFs2D_10_14);
}
