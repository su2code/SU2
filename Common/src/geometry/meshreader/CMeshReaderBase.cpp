...
void CMeshReaderBase::DetermineFacesVolumeElements(vector<CFaceOfElement>& localFaces) {
...
void CMeshReaderBase::GetCornerPointsAllFaces(const unsigned long* elemInfo, unsigned short& numFaces,
