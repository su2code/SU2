...
CPRISM6::CPRISM6() : CElementWithKnownSizes<NGAUSS, NNODE, NDIM>() {
  ...
  GaussCoord[0][1] = 1.0 / 6.0;
  GaussCoord[0][2] = 1.0 / 6.0;
  GaussWeight(0) = -1.0 / 6.0;
  GaussCoord[1][0] = -oneOnSqrt3;
  GaussCoord[1][1] = 2.0 / 3.0;
  GaussCoord[1][2] = 1.0 / 6.0;
  GaussWeight(1) = -1.0 / 6.0;
  GaussCoord[2][0] = -oneOnSqrt3;
  GaussCoord[2][1] = 1.0 / 6.0;
  GaussCoord[2][2] = 2.0 / 3.0;
  GaussWeight(2) = -1.0 / 6.0;
  GaussCoord[3][0] = oneOnSqrt3;
  GaussCoord[3][1] = 1.0 / 6.0;
  GaussCoord[3][2] = 1.0 / 6.0;
  GaussWeight(3) = -1.0 / 6.0;
  GaussCoord[4][0] = oneOnSqrt3;
  GaussCoord[4][1] = 2.0 / 3.0;
  GaussCoord[4][2] = 1.0 / 6.0;
  GaussWeight(4) = -1.0 / 6.0;
  GaussCoord[5][0] = oneOnSqrt3;
  GaussCoord[5][1] = 1.0 / 6.0;
  GaussCoord[5][2] = 2.0 / 3.0;
  GaussWeight(5) = -1.0 / 6.0;
  ...
  ExtrapCoord[0][1] = -1.0 / 3.0;
  ExtrapCoord[0][2] = -1.0 / 3.0;
  ExtrapCoord[1][0] = -sqrt3;
  ExtrapCoord[1][1] = 5.0 / 3.0;
  ExtrapCoord[1][2] = -1.0 / 3.0;
  ExtrapCoord[2][0] = -sqrt3;
  ExtrapCoord[2][1] = -1.0 / 3.0;
  ExtrapCoord[2][2] = 5.0 / 3.0;
  ExtrapCoord[3][0] = sqrt3;
  ExtrapCoord[3][1] = -1.0 / 3.0;
  ExtrapCoord[3][2] = -1.0 / 3.0;
  ExtrapCoord[4][0] = sqrt3;
  ExtrapCoord[4][1] = 5.0 / 3.0;
  ExtrapCoord[4][2] = -1.0 / 3.0;
  ExtrapCoord[5][0] = sqrt3;
  ExtrapCoord[5][1] = -1.0 / 3.0;
  ExtrapCoord[5][2] = 5.0 / 3.0;
