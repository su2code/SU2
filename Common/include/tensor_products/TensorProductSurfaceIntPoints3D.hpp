/*!
 * \file TensorProductSurfaceIntPoints3D.hpp
 * \brief Function prototypes for the tensor product to compute the surface data in the 2D integration points of a quad
...
typedef void(*TPIS3D)(const int           N,
                      const int           faceID,
                      const int           ldb,
                      const int           ldc,
 ...
 */
void CreateMapTensorProductSurfaceIntPoints3D(map<CUnsignedShort2T, TPIS3D> &mapFunctions);
 ...
 */
void TensorProductSurfaceIntPoints3D_1_2(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
 ...
 * \param[out] C          - Result of the tensor product C = A*B.
 */
void TensorProductSurfaceIntPoints3D_2_2(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
                                         const bool          swapTanDir,
 ...
 * \param[out] C          - Result of the tensor product C = A*B.
 */
void TensorProductSurfaceIntPoints3D_2_4(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
                                         const bool          swapTanDir,
 ...
 * \param[out] C          - Result of the tensor product C = A*B.
 */
void TensorProductSurfaceIntPoints3D_3_3(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
                                         const bool          swapTanDir,
 ...
 * \param[out] C          - Result of the tensor product C = A*B.
 */
void TensorProductSurfaceIntPoints3D_3_4(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
                                         const bool          swapTanDir,
 ...
 * \param[out] C          - Result of the tensor product C = A*B.
 */
void TensorProductSurfaceIntPoints3D_3_5(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
                                         const bool          swapTanDir,
 ...
 * \param[out] C          - Result of the tensor product C = A*B.
 */
void TensorProductSurfaceIntPoints3D_3_6(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
                                         const bool          swapTanDir,
 ...
 * \param[out] C          - Result of the tensor product C = A*B.
 */
void TensorProductSurfaceIntPoints3D_3_7(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
                                         const bool          swapTanDir,
 ...
 * \param[out] C          - Result of the tensor product C = A*B.
 */
void TensorProductSurfaceIntPoints3D_4_4(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
                                         const bool          swapTanDir,
 ...
 * \param[out] C          - Result of the tensor product C = A*B.
 */
void TensorProductSurfaceIntPoints3D_4_5(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
                                         const bool          swapTanDir,
 ...
 * \param[out] C          - Result of the tensor product C = A*B.
 */
void TensorProductSurfaceIntPoints3D_4_7(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
                                         const bool          swapTanDir,
 ...
 * \param[out] C          - Result of the tensor product C = A*B.
 */
void TensorProductSurfaceIntPoints3D_4_8(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
                                         const bool          swapTanDir,
 ...
 * \param[out] C          - Result of the tensor product C = A*B.
 */
void TensorProductSurfaceIntPoints3D_5_7(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
                                         const bool          swapTanDir,
 ...
 * \param[out] C          - Result of the tensor product C = A*B.
 */
void TensorProductSurfaceIntPoints3D_5_8(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
                                         const bool          swapTanDir,
 ...
 * \param[out] C          - Result of the tensor product C = A*B.
 */
void TensorProductSurfaceIntPoints3D_6_6(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
                                         const bool          swapTanDir,
 ...
 * \param[out] C          - Result of the tensor product C = A*B.
 */
void TensorProductSurfaceIntPoints3D_6_7(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
                                         const bool          swapTanDir,
 ...
 * \param[out] C          - Result of the tensor product C = A*B.
 */
void TensorProductSurfaceIntPoints3D_6_8(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
                                         const bool          swapTanDir,
 ...
 * \param[out] C          - Result of the tensor product C = A*B.
 */
void TensorProductSurfaceIntPoints3D_7_7(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
                                         const bool          swapTanDir,
 ...
 * \param[out] C          - Result of the tensor product C = A*B.
 */
void TensorProductSurfaceIntPoints3D_7_8(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
                                         const bool          swapTanDir,
 ...
 * \param[out] C          - Result of the tensor product C = A*B.
 */
void TensorProductSurfaceIntPoints3D_7_9(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
                                         const bool          swapTanDir,
...
/*!
 * \brief Function, which carries out the tensor product to obtain the data
 *        in the 2D integration points adjacent to a hex for (nDOFs1D,nInt1D) = (7,12).
 * \param[in]  N          - Number of variables to be determined in the integration points
 * \param[in]  faceID     - Face ID of the hex for which the quad data must be created
 * \param[in]  ldb        - Leading dimension of B when stored as a matrix.
 * \param[in]  ldc        - Leading dimension of C when stored as a matrix.
 ...
 * \param[out] C          - Result of the tensor product C = A*B.
 */
void TensorProductSurfaceIntPoints3D_7_12(const int           N,
                                          const int           faceID,
                                          const int           ldb,
                                          const int           ldc,
                                          const bool          swapTanDir,
...
/*!
 * \brief Function, which carries out the tensor product to obtain the data
 *        in the 2D integration points adjacent to a hex for (nDOFs1D,nInt1D) = (8,8).
 * \param[in]  N          - Number of variables to be determined in the integration points
 * \param[in]  faceID     - Face ID of the hex for which the quad data must be created
 * \param[in]  ldb        - Leading dimension of B when stored as a matrix.
 * \param[in]  ldc        - Leading dimension of C when stored as a matrix.
 ...
 * \param[out] C          - Result of the tensor product C = A*B.
 */
void TensorProductSurfaceIntPoints3D_8_13(const int           N,
                                          const int           faceID,
                                          const int           ldb,
                                          const int           ldc,
                                          const bool          swapTanDir,
 ...
 * \param[out] C          - Result of the tensor product C = A*B.
 */
void TensorProductSurfaceIntPoints3D_9_9(const int           N,
                                         const int           faceID,
                                         const int           ldb,
                                         const int           ldc,
                                         const bool          swapTanDir,
 ...
 * \param[out] C          - Result of the tensor product C = A*B.
 */
void TensorProductSurfaceIntPoints3D_9_13(const int           N,
                                          const int           faceID,
                                          const int           ldb,
                                          const int           ldc,
                                          const bool          swapTanDir,
 ...
 * \param[out] C          - Result of the tensor product C = A*B.
 */
void TensorProductSurfaceIntPoints3D_10_14(const int           N,
                                           const int           faceID,
                                           const int           ldb,
                                           const int           ldc,
                                           const bool          swapTanDir,
