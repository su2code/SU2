/*!
 * \file CInviscidShockVortexSolution.hpp
 * \brief Header file for the class CInviscidShockVortexSolution.
 *        The implementations are in the <i>CInviscidShockVortexSolution.cpp</i> file.
 * \author E.Molina
 ...
 * \brief Class to define the required data for the Inviscid Shock Vortex.
 * \author E. Molina
 */
class CInviscidShockVortexSolution: public CVerificationSolution {
...
protected:
  ...
  su2double x_c, y_c, a, b, M_v, v_m;
  su2double rho_u, u_u, v_u, w_u, p_u, t_u, M_s;
  su2double rho_d, u_d, v_d, w_d, p_d, t_d, RGas;
...
public:
   ...
   */
  CInviscidShockVortexSolution(void);
   ...
   */
  CInviscidShockVortexSolution(unsigned short val_nDim,
   ...
   */
  ~CInviscidShockVortexSolution(void) override;
