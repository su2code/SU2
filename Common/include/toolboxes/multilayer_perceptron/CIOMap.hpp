...

{
  ...
  */
  void PairVariableswithMLPs(CLookUp_ANN* MLP_collection, su2vector<std::string>& inputs,
   ...
   */
  std::vector<std::pair<std::size_t, std::size_t>> GetOutputMapping(std::size_t i_map) const {
