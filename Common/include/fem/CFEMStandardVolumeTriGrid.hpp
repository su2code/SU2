 ...
 * \version 7.0.6 "Blackbird"
 */
class CFEMStandardVolumeTriGrid final: public CFEMStandardElementBase {
...
private:
  ...
  unsigned short nDOFs;   /*!< \brief Number of DOFs for the triangle. */
  unsigned short nInt;    /*!< \brief Number of integration points for the triangle. */
