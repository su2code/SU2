...
public:
   ...
   */
  inline unsigned short GetNSolDOFs(void) const override {return rPyraSolDOFs.size();}
  ...
  inline unsigned short GetNSolDOFsPad(void) const override {
    return PaddedValue(rPyraSolDOFs.size());
  }
...
private:
  ...
  vector<passivedouble> rPyraDOFs; /*!< \brief Parametric r-coordinates of the pyramid grid DOFs. */
  vector<passivedouble> sPyraDOFs; /*!< \brief Parametric s-coordinates of the pyramid grid DOFs. */
  vector<passivedouble> tPyraDOFs; /*!< \brief Parametric t-coordinates of the pyramid grid DOFs. */
