/*!
 * \file CFEMStandardQuadPartition.hpp
 * \brief Class for the FEM quadrilateral standard element
...
/*!
 * \class CFEMStandardQuadPartition
...
public:
   ...
   */
  CFEMStandardQuadPartition() = delete;
   ...
   */
  CFEMStandardQuadPartition(const unsigned short val_nPoly,
   ...
   */
  ~CFEMStandardQuadPartition() = default;
