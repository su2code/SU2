/*!
 * \file CFEMStandardPrismPartition.hpp
 * \brief Class for the FEM prism standard element
 *        used during the partitioning.
 *        The functions are in the <i>CFEMStandardPrismPartitionin.cpp</i> file.
...
/*!
 * \class CFEMStandardPrismPartition
 * \brief Class which defines the variables and methods for the
 *        prism standard element used in the partitioning.
 * \author E. van der Weide
 * \version 7.1.1 "Blackbird"
 */
class CFEMStandardPrismPartition final: public CFEMStandardPrismBase {
...
public:
   ...
   */
  CFEMStandardPrismPartition() = delete;
   ...
   */
  CFEMStandardPrismPartition(const unsigned short val_nPoly,
                             const unsigned short val_orderExact);

  /*!
   * \brief Destructor.
   */
  ~CFEMStandardPrismPartition();
   ...
   */
  inline unsigned short GetnFaceTypes(void) const override {return 2;}
   ...
   */
  inline unsigned short GetVTK_TypeFace(unsigned short ind) const override {
