 ...
 * \version 7.0.8 "Blackbird"
 */
class CFEMStandardTetGrid final: public CFEMStandardTetBase {
...
public:
   ...
   * \param[in] val_nPolySol    - Polynomial degree of the solution for this element.
...
private:
  ...
  vector<passivedouble> rTetDOFs; /*!< \brief Parametric r-coordinates of the tetrahedron grid DOFs. */
  vector<passivedouble> sTetDOFs; /*!< \brief Parametric s-coordinates of the tetrahedron grid DOFs. */
  vector<passivedouble> tTetDOFs; /*!< \brief Parametric t-coordinates of the tetrahedron grid DOFs. */
