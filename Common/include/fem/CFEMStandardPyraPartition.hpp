/*!
 * \file CFEMStandardPyraPartition.hpp
 * \brief Class for the FEM pyramid standard element
...
/*!
 * \class CFEMStandardPyraPartition
...
public:
   ...
   */
  CFEMStandardPyraPartition() = delete;
   ...
   */
  CFEMStandardPyraPartition(const unsigned short val_nPoly,
                            const unsigned short val_orderExact);

  /*!
   * \brief Destructor.
   */
  ~CFEMStandardPyraPartition();
