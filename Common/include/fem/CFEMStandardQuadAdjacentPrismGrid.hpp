/*!
 * \file CFEMStandardQuadAdjacentPrismGrid.hpp
 * \brief Class for the FEM standard surface quadrilateral element
 *        adjacent to a prism for the grid.
 *        The functions are in the <i>CFEMStandardQuadAdjacentPrismGrid.cpp</i> file.
...
/*!
 * \class CFEMStandardQuadAdjacentPrismGrid.
 ...
 * \version 7.0.8 "Blackbird"
 */
class CFEMStandardQuadAdjacentPrismGrid final: public CFEMStandardElementBase {
...
public:
   ...
   */
  CFEMStandardQuadAdjacentPrismGrid() = delete;
   ...
   */
  CFEMStandardQuadAdjacentPrismGrid(const unsigned short val_nPoly,
   ...
   */
  ~CFEMStandardQuadAdjacentPrismGrid() = default;
