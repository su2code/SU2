...
class CPrimalGrid {
protected:
	unsigned short iDim;			/*!< \brief Counter for dimensions of the problem. */
	unsigned short iFace;			/*!< \brief Counter for faces of the problem. */
	unsigned short iNode;			/*!< \brief Counter for nodes of the problem. */
	...
	bool Divide;					/*!< \brief Marker used to know if we are going to divide this element 
									            in de adaptation proccess. */
	bool SemiDivide;				/*!< \brief Marker used to know if we are going to semi-divide this element 
									            in de adaptation proccess. */
	unsigned short DivStrength;		/*!< \brief Strength of the adaptation. */
...
public:
	...
	/*! 
	 * \brief Set the number of division of an element.
	 * \param[in] val_divstrength - Strength of the adaptation in an element.
	 */	
	void SetDivStrength(unsigned short val_divstrength);
	...
	/*! 
	 * \brief Get the number of division of an element.
	 * \return Strength of the adaptation in an element.
	 */	
	unsigned short GetDivStrength(void);
	
	/*! 
	 * \brief Set that an element must be semi-divided in the adaptation stage.
	 * \param[in] val_semidivide - <code>TRUE</code> if the element must be semi-divided; otherwise <code>FALSE</code>.
	 */	
	void SetSemiDivide(bool val_semidivide);
	
	/*! 
	 * \brief Get if an element must be semi-divided in the adaptation stage.
	 * \return <code>TRUE</code> if the element must be semi-divided; otherwise <code>FALSE</code>.
	 */	
	bool GetSemiDivide(void);
...
private:
	...
	static unsigned short maxNodesFace;			/*!< \brief Maximum number of nodes for a face. */
	static unsigned short nNeighbor_Elements;	/*!< \brief Number of Neighbor_Elements. */		
	unsigned long DomainElement;				/*!< \brief Only for boundaries, here we store the 
												            inside element which shares the face with the boundary. */
public:
