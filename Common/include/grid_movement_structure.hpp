...
public:
	...
	****Coord_SupportCP;			/*!< \brief Coordinates of the support control points. */
	...
	double *param_coord,	/*!< \brief Parametric coordinates of a point. */
	*cart_coord;			/*!< \brief Cartesian coordinates of a point. */
...
public:
	 ...
	 */		
	double *GetCartesianCoord(double *param_coord);
	 ...
	 */		
	void SetChunkDomain(CGeometry *geometry, CConfig *config, unsigned short iChunk);
	 ...
	 */		
	double GetBernsteinDerivative(unsigned short val_n, unsigned short val_i, double val_t, unsigned short val_order);
...
protected:
	...
	*Initial_Boundary;		/*!< \brief ___________. */
	double Ktor_mat[6][6];	/*!< \brief Element-based force-reduced torsional stiffness matrix. */
...
public:
	 ...
	 * \param[in] config - Definition of the particular problem.
	 */
	void TorsionalSpringMethod(CGeometry *geometry, CConfig *config);
	 ...
	 * \param[in] config - Definition of the particular problem.
	 */
	void SpringMethod(CGeometry *geometry, CConfig *config);
	
	/*! 
	 * \brief Grid deformation using the grid line method.
	 * \param[in] geometry - Geometrical definition of the problem.
	 * \param[in] config - Definition of the particular problem.
	 */
	void GridLineMethod(CGeometry *geometry, CConfig *config);
	 ...
	 * \param[in] config - Definition of the particular problem.
	 */
	void AlgebraicMethod(CGeometry *geometry, CConfig *config);
};
...
public:
  ...
  /*! 
	 ...
	 */		
	void SetParametricCoord(CGeometry *geometry, CConfig *config, CFreeFormChunk **chunk);
	 ...
	 * \param[in] chunk - Array with all the free forms chunks of the computation.
	 */		
	void SetCartesianCoord(CGeometry *geometry, CConfig *config, CFreeFormChunk **chunk);
