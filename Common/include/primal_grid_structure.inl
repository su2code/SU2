...
inline void CPrimalGrid::SetDivStrength  (unsigned short val_divstrength) {DivStrength = val_divstrength; }

inline bool CPrimalGrid::GetDivide (void) { return Divide; }

inline unsigned short CPrimalGrid::GetDivStrength (void) {	return DivStrength; }

inline void CPrimalGrid::SetSemiDivide (bool val_semidivide) {	SemiDivide = val_semidivide; }

inline bool CPrimalGrid::GetSemiDivide (void) { return SemiDivide; }
