...
private:
  ...
  RotVel_Ref;						/*!< \brief Reference speed for computing force coefficient in a rotating frame (e.g. tip speed). */
	...
	FreeSurface_Movement,			/*!< \brief Flag to know if there is free surface movement. */
	...
	*DV_Value_Old;		/*!< \brief Previous value of the design variable. */
	...
	double Sens_Limit;				/*!< \brief Cut value for limiting the sensitivity computation. */
	double RatioDensity,				/*!< \brief Ratio of density for a two phase problem. */
	RatioViscosity,				/*!< \brief Ratio of viscosity for a two phase problem. */
	InterfaseThickness;  /*!< \brief Thickness of the interfase for a two phase problem. */
	unsigned short Kind_Adaptation;	/*!< \brief Kind of numerical grid adaptation. */
	double New_Elem_Adapt;			/*!< \brief Elements to adapt in the numerical grid adaptation process. */
	double Unst_TimeStep;			/*!< \brief Time step for unsteady computations. */
  ...
  double **Periodic_Center;         /*!< \brief Rotational center for each SEND_RECEIVE boundary. */
	...
	*Marker_Config_Boundary;		/*!< \brief Global index for boundaries using config file. */
	...
	unsigned long nIntIter;			/*!< \brief Number of internal iterations. */
  ...
  Kind_SlopeLimit_AdjTurb,	/*!< \brief Slope limiter for the adjoint turbulent equation.*/
	...
	Kind_TimeIntScheme_Adj,		/*!< \brief Time integration for the adjoint flow equations. */
	Kind_TimeIntScheme_Lin,		/*!< \brief Time integration for the linearized flow equations. */
	Kind_TimeIntScheme_Turb,	/*!< \brief Time integration for the turbulence model. */
	Kind_TimeIntScheme_LevelSet,	/*!< \brief Time integration for the turbulence model. */
	...
	Kind_ConvNumScheme_Adj,		/*!< \brief Centered or upwind scheme for the adjoint flow equations. */
	Kind_ConvNumScheme_Lin,		/*!< \brief Centered or upwind scheme for the linearized flow equations. */
	...
	Kind_ViscNumScheme_Adj,		/*!< \brief Viscous scheme for the adjoint flow equations. */
	Kind_ViscNumScheme_Lin,		/*!< \brief Viscous scheme for the linearized flow equations. */
	...
	Kind_SourNumScheme_Adj,		/*!< \brief Source numerical scheme for the adjoint flow equations. */
	Kind_SourNumScheme_Lin,		/*!< \brief Source numerical scheme for the linearized flow equations. */
	...
	Kind_Centred_Adj,			/*!< \brief Centred scheme for the adjoint flow equations. */
	Kind_Centred_Lin,			/*!< \brief Centred scheme for the linearized flow equations. */
	...
	Kind_Upwind_Adj,			/*!< \brief Upwind scheme for the adjoint flow equations. */
	Kind_Upwind_Lin,			/*!< \brief Upwind scheme for the linearized flow equations. */
  ...
  double* Kappa_Flow,           /*!< \brief Numerical dissipation coefficients for the flow equations. */
    *Kappa_Adj,                  /*!< \brief Numerical dissipation coefficients for the adjoint equations. */
    *Kappa_Lin;                  /*!< \brief Numerical dissipation coefficients for the linearized equations. */
	double Kappa_1st_Adj,	/*!< \brief JST 1st order dissipation coefficient for adjoint flow equations (coarse multigrid levels). */
	Kappa_4th_Adj,			/*!< \brief JST 4th order dissipation coefficient for adjoint flow equations. */
	Kappa_1st_Lin,			/*!< \brief JST 1st order dissipation coefficient for linearized flow equations (coarse multigrid levels). */
	Kappa_4th_Lin,			/*!< \brief JST 4th order dissipation coefficient for linearized flow equations. */
	Kappa_1st_Flow,			/*!< \brief JST 1st order dissipation coefficient for flow equations (coarse multigrid levels). */
	Kappa_2nd_Flow,			/*!< \brief JST 2nd order dissipation coefficient for flow equations. */
	Kappa_4th_Flow;			/*!< \brief JST 4th order dissipation coefficient for flow equations. */
	bool StretchingFactor_Flow,			/*!< \brief Stretching correction for JST (flow equations). */
	StretchingFactor_Adj,		/*!< \brief Stretching correction for JST (adjoint equations). */
	StretchingFactor_Lin;		/*!< \brief Stretching correction for JST (linear equations). */
  ...
  unsigned short nMass;                 /*!< \brief No of particle masses */
	...
	ArtComp_Min,			/*!< \brief Value of the artificial compresibility factor for incompressible flows. */ 
	Gas_Constant,     /*!< \brief Specific gas constant. */
	Gas_Constant_Ref, /*!< \brief Reference specific gas constant. */
	LevelSet_Zero,	/*!< \brief Coordinate of the level set zero. */
...
public:
  ...
  bool TokenizeString(string & str, string & option_name, 
	...
	/*! 
	 * \brief Get the ratio of density for a two phase problem.
	 * \return Ratio of density for a two phase problem.
	 */
	double GetRatioDensity(void);
	
	/*! 
	 * \brief Get the ratio of viscosity for a two phase problem.
	 * \return Ratio of viscosity for a two phase problem.
	 */
	double GetRatioViscosity(void);
	
	/*! 
	 * \brief Get the thickness of the interfase for a two phase problem.
	 * \return Thickness of the interfase for a two phase problem.
	 */
	double GetInterfaseThickness(void);
	...
	/*! 
	 * \brief Get information about applying the stretching correction using the JST method (flow equations).
	 * \return <code>TRUE</code> if we are going to apply a stretching correction; otherwise <code>FALSE</code>.
	 */
	bool GetStretchingFactor_Flow(void);
	
	/*! 
	 * \brief Get information about applying the stretching correction using the JST method (adjoint equations).
	 * \return <code>TRUE</code> if we are going to apply a stretching correction; otherwise <code>FALSE</code>.
	 */
	bool GetStretchingFactor_Adj(void);
	
	/*! 
	 * \brief Get information about applying the stretching correction using the JST method (linear equations).
	 * \return <code>TRUE</code> if we are going to apply a stretching correction; otherwise <code>FALSE</code>.
	 */
	bool GetStretchingFactor_Lin(void);
  ...
  double GetArtComp_Factor(void);
	...
	/*! 
	 * \brief Get the minimum for the artificial compresibility.
	 * \return Value of the minimum for the artificial compresibility.
	 */
  double GetArtComp_Min(void);
	
	/*! 
	 * \brief Get the Level set zero for two phase .
	 * \return Value of the level set zero coordinate
	 */
  double GetLevelSet_Zero(void);
  ...
  double GetConversion_Factor(void);
	...
	/*! 
	 * \brief Governing equations of the flow (it can be different from the run time equation).
	 * \note It is necessary a copy for the master node in the MPI parallelization.
	 * \return Governing equation that we are solving.
	 */		
	unsigned short GetMPI_Kind_Solver(void);
	...
	/*! 
	 * \brief Set a copy for the master node of the kind of solver that is going to be used.
	 * \param[in] val_mpi_kind_solver - Kind of solver.
	 */		
	void SetMPI_Kind_Solver(unsigned short val_mpi_kind_solver);
  ...
  unsigned short GetKind_SU2(void);
	...
	*        equations (Galerkin, Average of gradients, Average of gradients
	 ...
	 */
	double GetKappa_4th_Adj(void);
	
	/*! 
	 * \brief Value of the calibrated constant for the low order method (center scheme).
	 * \return Calibrated constant for the low order center method for the adjoint flow equations.
	 */
	double GetKappa_1st_Adj(void);
	...
	/*! 
	 * \brief Get the limit for the maximum value of the sensitivity.
	 * \note In case we are dealing with leading edges it is necessary a threshold value.
	 * \return Maximum value of the sensitivity.
	 */
	double GetSens_Limit(void);
	...
	/*! 
	 * \brief Get information about the free surface movement.
	 * \return <code>TRUE</code> if there is a free surface movement; otherwise <code>FALSE</code>.
	 */
	bool GetFreeSurface_Movement(void);
  ...
  /*! 
	 * \brief Reference speed for computing force coefficients in a rotating frame.
	 * \return The specified reference speed.
	 */	
	double GetRotVel_Ref(void);
  ...
  /*! 
	 * \brief Get name of the new SU2 mesh converted from CGNS format.
	 * \return File name of the new SU2 mesh.
	 */
	string GetNew_SU2_FileName(void);
   ...
   * \param[in] val_rank - Processor rank.
	 */	
  void SetNondimensionalization(unsigned short val_nDim, int val_rank);
