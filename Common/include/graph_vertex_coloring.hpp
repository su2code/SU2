/*!
 * \file graph_vertex_coloring.hpp
 * \brief Include files and headers of the functions to carry out a vertex
 *        coloring of a given graph. The functions are in the
 *        <i>graph_vertex_coloring.cpp</i> file.
 ...
 * \param[in]  neighborVertices   - The neighboring vertices of the local vertices
                                    in global numbering.
