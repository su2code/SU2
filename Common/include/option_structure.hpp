...
const short N_ELEM_TYPES = 7;           /*!< \brief General output & CGNS defines. */
const short N_POINTS_LINE = 2;          /*!< \brief General output & CGNS defines. */
const short N_POINTS_TRIANGLE = 3;      /*!< \brief General output & CGNS defines. */
const short N_POINTS_QUADRILATERAL = 4; /*!< \brief General output & CGNS defines. */
const short N_POINTS_TETRAHEDRON = 4;   /*!< \brief General output & CGNS defines. */
const short N_POINTS_HEXAHEDRON = 8;    /*!< \brief General output & CGNS defines. */
const short N_POINTS_PYRAMID = 5;       /*!< \brief General output & CGNS defines. */
const short N_POINTS_PRISM = 6;         /*!< \brief General output & CGNS defines. */
