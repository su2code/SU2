...
enum ENUM_UPWIND {
  ...
  AUSMPLUSM = 19              /*!< \brief AUSM+M numerical method (All Speed) */
};
...
enum ENUM_LIMITER {
  ...
  MINMOD               = 7, /*!< \brief Slope limiter using Min-mod method. */
};
