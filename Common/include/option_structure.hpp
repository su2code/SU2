...
static const MapType<std::string, ENUM_FLUIDMODEL> FluidModel_Map = {
  ...
  MakePair("FLUID_FLAMELET", FLAMELET_FLUID_MODEL)
...
static const MapType<std::string, ENUM_SCALAR_MODEL> Scalar_Model_Map = {
  ...
  MakePair("FLAMELET", PROGRESS_VARIABLE)
...
enum ENUM_OBJECTIVE {
  ...
  SURFACE_TEMP = 82,
  SURFACE_PROG_VAR = 83,
  SURFACE_FTA_RATIO = 84,
  SURFACE_PASSIVE_SCALAR = 85,
  SURFACE_PROGVAR_VARIANCE = 86,
};
...
static const MapType<std::string, ENUM_OBJECTIVE> Objective_Map = {
  ...
  MakePair("SURFACE_FTA_RATIO", SURFACE_FTA_RATIO)
  MakePair("SURFACE_PROGVAR_VARIANCE", SURFACE_PROGVAR_VARIANCE)
};
