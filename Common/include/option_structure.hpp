...
enum class ENUM_MAIN_SOLVER {
  ...
  DISC_ADJ_INC_RANS,           /*!< \brief Definition of the discrete adjoint imcompressible Reynolds-averaged Navier-Stokes' (RANS) solver. */
  DISC_ADJ_INC_NAVIER_STOKES,  /*!< \brief Definition of the discrete adjoint imcompressible Navier-Stokes'. */
...
static const MapType<std::string, ENUM_MAIN_SOLVER> Solver_Map = {
  MakePair("NONE", ENUM_MAIN_SOLVER::NONE)
  MakePair("EULER", ENUM_MAIN_SOLVER::EULER)
  MakePair("NAVIER_STOKES", ENUM_MAIN_SOLVER::NAVIER_STOKES)
  MakePair("RANS", ENUM_MAIN_SOLVER::RANS)
  MakePair("INC_EULER", ENUM_MAIN_SOLVER::INC_EULER)
  MakePair("INC_NAVIER_STOKES", ENUM_MAIN_SOLVER::INC_NAVIER_STOKES)
  MakePair("INC_RANS", ENUM_MAIN_SOLVER::INC_RANS)
  MakePair("FEM_EULER", ENUM_MAIN_SOLVER::FEM_EULER)
  MakePair("FEM_NAVIER_STOKES", ENUM_MAIN_SOLVER::FEM_NAVIER_STOKES)
  MakePair("FEM_RANS", ENUM_MAIN_SOLVER::FEM_RANS)
  MakePair("FEM_LES", ENUM_MAIN_SOLVER::FEM_LES)
  MakePair("NEMO_EULER",ENUM_MAIN_SOLVER::NEMO_EULER)
  MakePair("NEMO_NAVIER_STOKES",ENUM_MAIN_SOLVER::NEMO_NAVIER_STOKES)
  MakePair("ADJ_EULER", ENUM_MAIN_SOLVER::ADJ_EULER)
  MakePair("ADJ_NAVIER_STOKES", ENUM_MAIN_SOLVER::ADJ_NAVIER_STOKES)
  MakePair("ADJ_RANS", ENUM_MAIN_SOLVER::ADJ_RANS )
  MakePair("HEAT_EQUATION", ENUM_MAIN_SOLVER::HEAT_EQUATION)
  MakePair("ELASTICITY", ENUM_MAIN_SOLVER::FEM_ELASTICITY)
  MakePair("DISC_ADJ_EULER", ENUM_MAIN_SOLVER::DISC_ADJ_EULER)
  MakePair("DISC_ADJ_RANS", ENUM_MAIN_SOLVER::DISC_ADJ_RANS)
  MakePair("DISC_ADJ_NAVIERSTOKES", ENUM_MAIN_SOLVER::DISC_ADJ_NAVIER_STOKES)
  MakePair("DISC_ADJ_INC_EULER", ENUM_MAIN_SOLVER::DISC_ADJ_INC_EULER)
  MakePair("DISC_ADJ_INC_RANS", ENUM_MAIN_SOLVER::DISC_ADJ_INC_RANS)
  MakePair("DISC_ADJ_INC_NAVIERSTOKES", ENUM_MAIN_SOLVER::DISC_ADJ_INC_NAVIER_STOKES)
  MakePair("DISC_ADJ_HEAT_EQUATION", ENUM_MAIN_SOLVER::DISC_ADJ_HEAT)
  MakePair("DISC_ADJ_FEM_EULER", ENUM_MAIN_SOLVER::DISC_ADJ_FEM_EULER)
  MakePair("DISC_ADJ_FEM_RANS", ENUM_MAIN_SOLVER::DISC_ADJ_FEM_RANS)
  MakePair("DISC_ADJ_FEM_NS", ENUM_MAIN_SOLVER::DISC_ADJ_FEM_NS)
  MakePair("DISC_ADJ_FEM", ENUM_MAIN_SOLVER::DISC_ADJ_FEM)
  MakePair("TEMPLATE_SOLVER", ENUM_MAIN_SOLVER::TEMPLATE_SOLVER)
  MakePair("MULTIPHYSICS", ENUM_MAIN_SOLVER::MULTIPHYSICS)
};
