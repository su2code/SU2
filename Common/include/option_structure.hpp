...
enum PERIODIC_QUANTITIES {
  ...
  PERIODIC_PRESSURE   = 18,   /*!< \brief Corrected pressure communication . */
};
...
enum MPI_QUANTITIES {
  ...
  MASS_FLUX            = 31,  /*!< \brief Mass flux in a CV communication. */
  MOM_COEFF		  	   = 32,  /*!< \brief Momentum eq coefficient communication. */
  PRESSURE_VAR	       = 33   /*!< \brief Primitive variable communication. */
};
