...
enum ENUM_SOLVER {
  ...
  DISC_ADJ_TWO_PHASE_EULER= 38,
  DISC_ADJ_TWO_PHASE_NAVIER_STOKES= 39,
  DISC_ADJ_TWO_PHASE_RANS = 40
};
/* BEGIN_CONFIG_ENUMS */
...
("DISC_ADJ_TWO_PHASE_EULER", DISC_ADJ_EULER)
("DISC_ADJ_TWO_PHASE_RANS", DISC_ADJ_RANS)
("DISC_ADJ_TWO_PHASE_NAVIERSTOKES", DISC_ADJ_EULER)
...
enum ENUM_DEFORM_STIFFNESS {
  ...
  WALL_DISTANCE = 2			/*!< \brief Impose a stiffness for each element that is proportional to the distance from the solid surface. */
};
