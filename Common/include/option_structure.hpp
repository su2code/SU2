...
enum MPI_QUANTITIES {
  ...
  PRIMITIVE_ADAPT_AUX  ,  /*!< \brief Auxiliary vectors for anisotropic mesh adaptation. */
  GRADIENT_ADAPT_AUX   ,  /*!< \brief Auxiliary gradient vectors for anisotropic mesh adaptation. */
