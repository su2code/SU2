...
static const map<string, ENUM_SOBOLEV_MODUS> Sobolev_Modus_Map = CCreateMap<string, ENUM_SOBOLEV_MODUS>
("NONE", NO_MODUS)
("PARAM_LEVEL_COMPLETE"  , PARAM_LEVEL_COMPLETE)
("PARAM_LEVEL_SEQUENTIAL", PARAM_LEVEL_SEQUENTIAL)
