 ...
 */
enum class ENUM_MPI_QUANTITIES {
...
static const MapType<std::string, ENUM_MPI_QUANTITIES> MPI_Quantities_Map = {
  MakePair("SOLUTION", ENUM_MPI_QUANTITIES::SOLUTION)
  MakePair("SOLUTION_OLD", ENUM_MPI_QUANTITIES::SOLUTION_OLD)
  MakePair("SOLUTION_GRADIENT", ENUM_MPI_QUANTITIES::SOLUTION_GRADIENT)
  MakePair("SOLUTION_GRAD_REC", ENUM_MPI_QUANTITIES::SOLUTION_GRAD_REC)
  MakePair("SOLUTION_LIMITER", ENUM_MPI_QUANTITIES::SOLUTION_LIMITER)
  MakePair("SOLUTION_GEOMETRY", ENUM_MPI_QUANTITIES::SOLUTION_GEOMETRY)
  MakePair("PRIMITIVE_GRADIENT", ENUM_MPI_QUANTITIES::PRIMITIVE_GRADIENT)
  MakePair("PRIMITIVE_GRAD_REC", ENUM_MPI_QUANTITIES::PRIMITIVE_GRAD_REC)
  MakePair("PRIMITIVE_LIMITER", ENUM_MPI_QUANTITIES::PRIMITIVE_LIMITER)
  MakePair("UNDIVIDED_LAPLACIAN", ENUM_MPI_QUANTITIES::UNDIVIDED_LAPLACIAN)
  MakePair("MAX_EIGENVALUE", ENUM_MPI_QUANTITIES::MAX_EIGENVALUE)
  MakePair("SENSOR", ENUM_MPI_QUANTITIES::SENSOR)
  MakePair("AUXVAR_GRADIENT", ENUM_MPI_QUANTITIES::AUXVAR_GRADIENT)
  MakePair("COORDINATES", ENUM_MPI_QUANTITIES::COORDINATES)
  MakePair("COORDINATES_OLD", ENUM_MPI_QUANTITIES::COORDINATES_OLD)
  MakePair("MAX_LENGTH", ENUM_MPI_QUANTITIES::MAX_LENGTH)
  MakePair("GRID_VELOCITY", ENUM_MPI_QUANTITIES::GRID_VELOCITY)
  MakePair("SOLUTION_EDDY", ENUM_MPI_QUANTITIES::SOLUTION_EDDY)
  MakePair("SOLUTION_MATRIX", ENUM_MPI_QUANTITIES::SOLUTION_MATRIX)
  MakePair("SOLUTION_MATRIXTRANS", ENUM_MPI_QUANTITIES::SOLUTION_MATRIXTRANS)
  MakePair("NEIGHBORS", ENUM_MPI_QUANTITIES::NEIGHBORS)
  MakePair("SOLUTION_FEA", ENUM_MPI_QUANTITIES::SOLUTION_FEA)
  MakePair("MESH_DISPLACEMENTS", ENUM_MPI_QUANTITIES::MESH_DISPLACEMENTS)
  MakePair("SOLUTION_TIME_N", ENUM_MPI_QUANTITIES::SOLUTION_TIME_N)
  MakePair("SOLUTION_TIME_N1", ENUM_MPI_QUANTITIES::SOLUTION_TIME_N1)
};
