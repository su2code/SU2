...
public:
  ...
  */
   ...
   */
  su2double GetOneShotGamma(void) const { return One_Shot_Gamma; }
   ...
   */
  su2double GetOneShotGammaRate(void) const { return One_Shot_Gamma_Rate; }
   ...
   */
  su2double GetOneShotGammaMax(void) const { return One_Shot_Gamma_Max; }
   ...
   */
  void SetOneShotGamma(su2double input) { One_Shot_Gamma = input; }
   ...
   */
  su2double GetObjScale(void) const { return Obj_Func_Scale; }
   ...
   */
  unsigned short GetOneShotSearchIter(void) const { return OS_Search_Iter; }

  /*!
   * \brief Lower bound for one-shot step size.
   * \return Value for the lower bound of step size.
   */
  su2double GetOneShotSearchTol(void) const { return OS_Search_Tol; }
   ...
   * \return Kind of constraint function.
   */
  unsigned short GetKind_ConstrFuncType(unsigned short val_cons) const { return Kind_ConstrFuncType[val_cons]; }
  ...
  /*!
   * \brief Get the scale of the multiplier scale for the given constraint
   * \return Value of multiplier scale.
   */
  su2double GetMultiplierScale(unsigned short val_cons) const { return Multiplier_Scale[val_cons]; }

  /*!
   * \brief Get target value for constraint functions
   * \return Value of target value for constraint functions.
   */
  su2double GetConstraintTarget(unsigned short val_cons) const { return Constraint_Target[val_cons]; }

  /*!
   * \brief Get scaling value for constraint functions
   * \return Value of scaling value for constraint functions.
   */
  su2double GetConstraintScale(unsigned short val_cons) const { return Constraint_Scale[val_cons]; }
   ...
   */
  bool GetBFGSInit(void) const { return BFGS_Init; }
  ...
  /*!
   * \brief Get the epsilon added to the diagonal of the BCheck preconditioner
   * \return Value of epsilon.
   */
  su2double GetBCheckEpsilon(void) const {return BCheck_Epsilon; }

  /*!
   * \brief Get whether to use a constant preconditioner.
   * \return Whether to use a constant preconditioner.
   */
  bool GetConstPrecond(void) const { return Constant_Preconditioner; }

  /*!
   * \brief Get whether to use AD for the gradient projection.
   * \return Whether to use AD for the gradient projection
   */
