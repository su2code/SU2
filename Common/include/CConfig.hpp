...
public:
  ...
  */
  ...
  /*!
    ...
    * \return PRef_Value.
    */
  su2double GetPRef_Value(void) const {return PRef_Value;}
   ...
   * \return Governing equation that we are solving.
   */
  unsigned short GetKind_Incomp_System(void) const { return Kind_Incomp_System; }
   ...
   * \return Governing equation that we are solving.
   */
  unsigned short GetKind_PBIter(void) const { return Kind_PBIter; }
   ...
   */
  unsigned long GetLinear_Solver_Iter_Flow(void) const { return Linear_Solver_Iter_Flow; }
   ...
   */
  unsigned long GetLinear_Solver_Iter_Poisson(void) const { return Linear_Solver_Iter_Poisson; }
  
  /*!
   * \brief Get max number of iterations of the linear solver for the implicit formulation.
   * \return Max number of iterations of the linear solver for the implicit formulation.
   */
  void SetLinear_Solver_Iter(unsigned long LinSolver_Iter) { Linear_Solver_Iter = LinSolver_Iter; }
