...
public:
  ...
  */
  ...
  /*!
   * \brief Determines whether a marker with index iMarker is a inlet boundary.
   * \param iMarker
   * \return <TRUE> it marker with index iMarker is a inlet boundary.
   */
  bool GetInlet(unsigned short iMarker) const;
