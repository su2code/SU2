...
private:
  ...
  *Marker_All_TagBound;           /*!< \brief Global index for markers using grid information. */
  su2double RBF_SupportRadius;               /*!< \brief RBF Support Radius. */
  su2double RBF_GreedyTolerance;             /*!< \brief RBF Tollerance for the Greedy algorithm. */
  
  bool RBF_MeshDeformation;                  /*!< \brief Activate RBF mesh deformation. */
  bool RBF_SensSmooth;                       /*!< \brief Smooth Sensitivity with rbf. */
  int RBF_nMultiLevelSteps;                  /*!< \brief number of levels for the Greedy algorithm of RBF. */
  int RBF_MaxnControlPoints;                 /*!< \brief Number of control points for RBF mesh deformation. */
  su2double RBF_VolumeReductionFactor;       /*!< \brief RBF Volume Reduction Factor. */
