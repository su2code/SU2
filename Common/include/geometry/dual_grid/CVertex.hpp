...
protected:
  ...
  su2double *Normal_Old;  /*!< \brief Normal coordinates of the element and its center of gravity at the old design. */
...
public:
  ...
  /*!
   * \brief Get the old normal to a face of the control volume asociated with a vertex.
   * \return Dimensional normal vector, the modulus is the area of the face.
   */
