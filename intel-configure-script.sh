...
./configure -prefix=${INSTALL_DIR} --enable-mpi --with-cc=${I_MPI_ROOT}/intel64/bin/mpiicc --with-cxx=${I_MPI_ROOT}/intel64/bin/mpiicpc CXXFLAGS="-O3 -I${MKLROOT}/include -DHAVE_MKL -xCORE-AVX512" LIBS="-Wl,--start-group ${MKLROOT}/lib/intel64/libmkl_intel_lp64.a ${MKLROOT}/lib/intel64/libmkl_sequential.a ${MKLROOT}/lib/intel64/libmkl_core.a -Wl,--end-group -lpthread -lm -ldl"
