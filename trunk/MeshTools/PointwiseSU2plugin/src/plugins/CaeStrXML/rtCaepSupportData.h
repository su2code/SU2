...
/*------------------------------------*/
/* CaeStrXML format item setup data */
/*------------------------------------*/
CAEP_BCINFO CaeStrXMLBCInfo[] = {
    { "inflow", 100 },
    { "outflow", 101 },
    { "wall", 102 },
};
/*------------------------------------*/
CAEP_VCINFO CaeStrXMLVCInfo[] = {
    { "viscous", 200 },
    { "invisid", 201 },
};
/*------------------------------------*/
const char *CaeStrXMLFileExt[] = {
    "xml"
};
...
\skip == CAEP_BCINFO*
\until ARRAYSIZE(CaeStrXMLFileExt)
*/
