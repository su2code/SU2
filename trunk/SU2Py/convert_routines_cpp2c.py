...
#        subroutine_list = []
        ...
        for data_line in source_file_data:
            ...
            if data_line.startswith('//SU2_CPP2C') and routine_open == 0 :
                # split into words
            ...
            # if routine is open
                ...
                # check for cpp2c comment
                if data_line.startswith('//SU2_CPP2C'):
                    # split into words
                    data_words = data_line.split()
...
#                                new_data.append(new_line)
                                ...
                                for sub_data_line in sub_file_data:
                                    if sub_data_line.startswith('//SU2_CPP2C') and sub_open == 0 :
                                        # split into words
                                        ...
                                        if sub_data_line.startswith('//SU2_CPP2C'):
                                            # split into words
                                            sub_data_words = sub_data_line.split()
...
#                            subroutine_list.append(data_words[2])
                ...
                elif comment_open == 0 and subroutine_open == 0:
                    # cut and paste
