...
def merge_grid_su2( filename   ,
    ...
    for domain in range(int(partitions)):
        ...
        percentage = int(100*float(domain)/(float(partitions)-1.0)*0.5)
        sys.stdout.write("\rMerging grid files (.su2)... %d%%" % percentage)
        sys.stdout.flush()
    ...
    for domain in range(int(partitions)):
        ...
        percentage = int(50+100*float(domain)/(float(partitions)-1.0)*0.5)
        sys.stdout.write("\rMerging grid files (.su2)... %d%%" % percentage)
        sys.stdout.flush()
