...
parser.add_option("-o", "--os", dest="operatingsys",
                  help="specify build OS (darwin, redhat)", metavar="OS")
...
group.add_option("--SU2_PBC",
                 ...
                 help="build SU2_PBC")
group.add_option("--SU2_SMC",
                 action="store_true", dest="SU2_SMC", default=False,
                 help="build SU2_SMC")
parser.add_option_group(group)
(options, args)=parser.parse_args()

# Perform some logic for the options.
if options.SU2_CFD or options.SU2_DDC or options.SU2_GPC or options.SU2_GDC or options.SU2_MAC or options.SU2_MDC or options.SU2_PBC or options.SU2_SMC:
  if options.SU2_CFD:
    build_cfd = True
  else:
    build_cfd = False
...
if options.operatingsys == "darwin":
  ...
  if options.clean:
    ...
    if build_cfd:
      print '\n  Cleaning SU2_CFD...\n'
      os.chdir(su2_home + '/SU2_CFD/config')
      os.system('cp ./makefile.darwin.gcc4.2.1.in ./makefile.in')
    ...
    if build_ddc:
      ...
      os.system('make clean')
      os.chdir(su2_home + '/SU2_DDC/config')
      os.system('cp ./makefile.darwin.gcc4.2.1.in ./makefile.in')
      os.system('make clean')
      os.chdir(su2_home + '/SU2Py')
    ...
    if build_mac:
      print '\n  Cleaning SU2_MAC...\n'
      os.chdir(su2_home + '/SU2_MAC/config')
      os.system('cp ./makefile.darwin.gcc4.2.1.in ./makefile.in')
      os.system('make clean')
      os.chdir(su2_home + '/SU2Py')
    ...
    if build_mdc:
      print '\n  Cleaning SU2_MDC...\n'
      os.chdir(su2_home + '/SU2_MDC/config')
      os.system('cp ./makefile.darwin.gcc4.2.1.in ./makefile.in')
      os.system('make clean')
      os.chdir(su2_home + '/SU2Py')
    ...
    if build_gpc:
      print '\n  Cleaning SU2_GPC...\n'
      os.chdir(su2_home + '/SU2_GPC/config')
      os.system('cp ./makefile.darwin.gcc4.2.1.in ./makefile.in')
      os.system('make clean')
      os.chdir(su2_home + '/SU2Py')
    ...
    if build_gdc:
      print '\n  Cleaning SU2_GDC...\n'
      os.chdir(su2_home + '/SU2_GDC/config')
      os.system('cp ./makefile.darwin.gcc4.2.1.in ./makefile.in')
      os.system('make clean')
      os.chdir(su2_home + '/SU2Py')
    ...
    if build_cfd:
      print '\n  Compiling SU2_CFD...\n'
      os.chdir(su2_home + '/SU2_CFD/config')
      os.system('cp ./makefile.darwin.gcc4.2.1.mpi.in ./makefile.in')
    ...
    if build_gdc:
      ...
      if options.compiler != False:
        set_compiler(options.compiler, 'makefile.in')
      if options.cgns:
        print '\n!!! Warning: SU2_GDC does not yet support parallel CGNS. Option ignored. !!!\n'
      os.system('make all')      
  ...
  if options.clean:
    ...
    if build_cfd:
      print '\n  Cleaning SU2_CFD...\n'
      os.chdir(su2_home + '/SU2_CFD/config')
      os.system('cp ./makefile.redhat.gcc4.1.2.in ./makefile.in')
      os.system('make clean')
      os.chdir(su2_home + '/SU2Py')
      os.system('rm -f SU2_CFD')
    ...
    if build_cfd:
      print '\n  Compiling SU2_CFD...\n'
      os.chdir(su2_home + '/SU2_CFD/config')
      os.system('cp ./makefile.redhat.gcc4.1.2.mpi.in ./makefile.in')
      if options.compiler != False:
        set_compiler(options.compiler, 'makefile.in')
      if options.cgns:
        print '\n!!! Warning: SU2_CFD does not yet support parallel CGNS. Option ignored. !!!\n'
  ...
  print '      Options are: darwin, redhat           \n'
  exit(1)
...
if options.clean:
  ...
  if build_pbc:
    print '\n  Cleaning SU2_PBC...\n'
    os.chdir(su2_home + '/SU2_PBC/config')
    os.system('make clean')
    os.chdir(su2_home + '/SU2Py')
  ...
  if build_smc:
    print '\n  Cleaning SU2_SMC...\n'
    os.chdir(su2_home + '/SU2_SMC/config')
    os.system('make clean')
    os.chdir(su2_home + '/SU2Py')
    os.system('rm -f SU2_SMC')
  ...
  if build_smc:
    ...
    if options.compiler != False:
      set_compiler(options.compiler, 'makefile.in')
    if options.cgns:
      print '\n!!! Warning: SU2_SMC does not yet support CGNS. Option ignored. !!!\n'
    os.system('make all')
