...
const int TRANS_SOL = 4;		/*!< \brief Position of the turbulence solution in the solution container array. */
...
enum ENUM_UPWIND {
	...
	ROE_TURKEL_1ST = 12,			/*!< \brief First order Roe-Turkel's upwind numerical method. */
	ROE_TURKEL_2ND = 13,			/*!< \brief Second order Roe-Turkel's upwind numerical method. */
};
