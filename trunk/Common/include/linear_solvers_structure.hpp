...
class CSolutionSendReceive {
public:
  virtual ~CSolutionSendReceive() = 0; ///< class destructor
  virtual void operator()(CSysVector & u)
	const = 0; ///< mpi rend receive operation
};
inline CSolutionSendReceive::~CSolutionSendReceive() {}
