...
public:
	 ...
	 * \param[in] val_mesh_out_filename - Name of the output file.
	 */	
	virtual void SetMeshFile(CGeometry *geometry, CConfig *config, string val_mesh_out_filename, unsigned short val_domain);
...
public:
	 ...
	 * \param[in] val_mesh_out_filename - Name of the output file.
	 */
	void SetMeshFile(CGeometry *geometry, CConfig *config, string val_mesh_out_filename, unsigned short val_domain);
