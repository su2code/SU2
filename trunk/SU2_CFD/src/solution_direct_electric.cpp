...
void CElectricSolution::Solve_LinearSystem(CGeometry *geometry, CSolution **solution_container, 
	...
	/*--- Solve the system ---*/
	CSysVector rhs_vec(geometry->GetnPoint(), geometry->GetnPointDomain(), geometry->GetnDim(), rhs);
	CSysVector sol_vec(geometry->GetnPoint(), geometry->GetnPointDomain(), geometry->GetnDim(), xsol);
