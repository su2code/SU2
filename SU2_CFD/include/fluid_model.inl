...
inline void CFluidModel::SetLiquidProp (su2double P, su2double T, su2double rho, su2double h_v, su2double Rcritical, su2double R, su2double mom3) {
        Liquid_Prop->Set_LiquidProp(P, T, rho, h_v, Rcritical, R, mom3);
}
...
inline void CFluidModel::Set_Cv (su2double T, su2double v) {};
