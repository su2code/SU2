 ...
 * \version 5.0.0 "Raven"
 */
class C2phaseSolver : public CSolver {
protected:
  su2double *FlowPrimVar_i,  /*!< \brief Store the flow solution at point i. */
  *FlowPrimVar_j,         /*!< \brief Store the flow solution at point j. */
  *lowerlimit,            /*!< \brief contains lower limits for turbulence variables. */
...
public:
   ...
   * \brief Destructor of the class.
   */
  virtual ~C2phaseSolver(void);

  /*!
   * \brief Constructor of the class.
   */
  C2phaseSolver(CConfig *config);
  ...
  /*!
   * \brief Compute the time step for solving the two phase equations.
   * \param[in] geometry - Geometrical definition of the problem.
   * \param[in] solver_container - Container vector with all the solutions.
   * \param[in] config - Definition of the particular problem.
   * \param[in] iMesh - Index of the mesh in multigrid computations.
...
public:
  ...
  /*!
   * \brief Impose the riemann (inlet/outlet) boundary condition.
   * \param[in] geometry - Geometrical definition of the problem.
   * \param[in] solver_container - Container vector with all the solutions.
   * \param[in] conv_numerics - Description of the numerical method.
   * \param[in] visc_numerics - Description of the numerical method.
...
class C2phase_QMOMSolver: public C2phaseSolver {
private:
  su2double *Primitive_Liquid;  /*!< \brief prim vector for the model. */
  CLiquidModel  *liquid;
...
public:
   ...
   * \param[in] iMesh - Index of the mesh in multigrid computations.
   */
  C2phase_QMOMSolver(CGeometry *geometry, CConfig *config, unsigned short iMesh);
