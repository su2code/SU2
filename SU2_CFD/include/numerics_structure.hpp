...
public:
  ...
  *WindGustDer_j;      /*!< \brief Wind gust derivatives at point j. */
  ...
  virtual su2double  GetNucleation_Rate (su2double P, su2double T, su2double rho, su2double h, su2double k, su2double mu, su2double CpoCv, su2double HeatCapP, su2double *V_Liquid);

  virtual su2double  GetGrowth_Rate (su2double P, su2double T, su2double rho, su2double h, su2double k, su2double mu, su2double CpoCv, su2double HeatCapP, su2double *V_Liquid);
