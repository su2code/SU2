...
/*!
 * \class CDiscGalerkin_Flow
 * \brief Class for the discontinuous galerkin method.
 * \ingroup ConvDiscr
 * \author J. Alonso, E. van der Weide, T. Economon
 * \version 4.0.2 "Cardinal"
 */
class CDiscGalerkin_Flow : public CNumerics {
...
public:
   ...
   * \param[in] config - Definition of the particular problem.
   */
  CDiscGalerkin_Flow(unsigned short val_nDim, unsigned short val_nVar, CConfig *config);
  
  /*!
   * \brief Destructor of the class.
   */
  ~CDiscGalerkin_Flow(void);
  
  /*!
   * \brief Compute the flow residual using a discontinous galerkin method.
   * \param[out] val_resconv - Pointer to the convective residual.
   * \param[out] val_resvisc - Pointer to the artificial viscosity residual.
   * \param[out] val_Jacobian_i - Jacobian of the numerical method at node i (implicit computation).
   * \param[out] val_Jacobian_j - Jacobian of the numerical method at node j (implicit computation).
...
/*!
 * \class CFEMVisc_Flow
 * \brief Class for computing viscous terms for the finite element flow solver.
 * \ingroup ViscDiscr
 * \author J. Alonso, E. van der Weide, T. Economon
 * \version 4.0.2 "Cardinal"
 */
class CFEMVisc_Flow : public CNumerics {
private:
...
public:
   ...
   * \param[in] config - Definition of the particular problem.
   */
  CFEMVisc_Flow(unsigned short val_nDim, unsigned short val_nVar, CConfig *config);
  ...
  /*!
   * \brief Compute the viscous flow residual.
   * \param[out] val_residual - Pointer to the total residual.
   * \param[out] val_Jacobian_i - Jacobian of the numerical method at node i (implicit computation).
   * \param[out] val_Jacobian_j - Jacobian of the numerical method at node j (implicit computation).
   * \param[in] config - Definition of the particular problem.
...
/*!
 * \class CSourceFEM
 * \brief Class for the source term integration in the finite element flow solver.
 * \ingroup SourceDiscr
 * \author J. Alonso, E. van der Weide, T. Economon
 * \version 4.0.2 "Cardinal"
 */
class CSourceFEM: public CNumerics {
...
public:
   ...
   * \param[in] config - Definition of the particular problem.
   */
  CSourceFEM(unsigned short val_nDim, unsigned short val_nVar, CConfig *config);
