/*!
 * \file CTNE2CompOutput.hpp
 * \brief  Headers of the TNE2 compressible flow output.
...
/*! \class CTNE2CompOutput
 *  \brief Output class for tne2 compressible flow problems.
 *  \author R. Sanchez, T. Albring.
 */
class CTNE2CompOutput final: public CFlowOutput {
private:
...
public:
   ...
   */
  CTNE2CompOutput(CConfig *config, unsigned short nDim);

  /*!
   * \brief Destructor of the class.
   */
  ~CTNE2CompOutput(void) override;
