...
/*! \class CAdjTNE2CompOutput
 *  \brief Output class for compressible flow adjoint problems.
 *  \author R. Sanchez, T. Albring.
 */
class CAdjTNE2CompOutput final: public COutput {
private:
...
public:
   ...
   */
  CAdjTNE2CompOutput(CConfig *config, unsigned short nDim);

  /*!
   * \brief Destructor of the class.
   */
  ~CAdjTNE2CompOutput(void) override;
