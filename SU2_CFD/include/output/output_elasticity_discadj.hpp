 ...
 *  \date June 5, 2018.
 */
class CDiscAdjElasticityOutput : public COutput {
private:
...
public:
   ...
   */
  CDiscAdjElasticityOutput(CConfig *config, CGeometry *geometry, unsigned short iZone);

  /*!
   * \brief Destructor of the class.
   */
  virtual ~CDiscAdjElasticityOutput(void);
