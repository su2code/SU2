 ...
 * \brief Headers of the oneshot computation output.
 * \author T. Dick
...
#include "COutput.hpp"
#include "CAdjFlowCompOutput.hpp"

/*! \class COneShotOutput
 *  \brief Output class for One Shot problems.
 *  \author T. Dick
 *  \date 30.10.2020.
 */
...
public:
   ...
   */
  COneShotOutput(CConfig *config, unsigned short nDim);

  /*!
   * \brief Destructor of the class.
   */
  ~COneShotOutput(void) override;
