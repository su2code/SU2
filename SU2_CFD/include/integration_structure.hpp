...
public:
  ...
  virtual void SetRestricted_EddyVisc(unsigned short RunTime_EqSystem, CSolver *sol_fine, CSolver *sol_coarse, CGeometry *geo_fine, CGeometry *geo_coarse, CConfig *config);
	 ...
	 * \param[in] config - Definition of the particular problem.
	 */
    virtual void SetForcing_Term(unsigned short RunTime_EqSystem, CSolver *sol_fine, CSolver *sol_coarse, CGeometry *geo_fine, CGeometry *geo_coarse,
...
public:
  ...
  void Smooth_Solution(unsigned short RunTime_EqSystem, CSolver *solver, CGeometry *geometry,
	 ...
	 * \param[in] config - Definition of the particular problem.
	 */
  void SetRestricted_Residual(unsigned short RunTime_EqSystem, CSolver *sol_fine, CSolver *sol_coarse, CGeometry *geo_fine,
								CGeometry *geo_coarse, CConfig *config);
	 ...
	 * \param[in] config - Definition of the particular problem.
	 */
    void SetForcing_Term(unsigned short RunTime_EqSystem, CSolver *sol_fine, CSolver *sol_coarse, CGeometry *geo_fine, CGeometry *geo_coarse,
						 CConfig *config, unsigned short iMesh);
};
