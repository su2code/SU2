...
public:
  ...
  /*!
   * \brief Get the configuration container for a specified zone.
   * \param[in] val_iZone - Value of the zone.
   * \return config_container[val_iZone]
   */
  CConfig* GetConfiguration(unsigned short val_iZone);

  /*!
   * \brief Get the geometry container for a specified zone and mesh level.
   * \param[in] val_iZone - Value of the zone.
   * \param[in] val_iMesh - Value of the mesh level.
