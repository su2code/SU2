...
public:
	 ...
	 * \return nothing
	 */	
	virtual void SetTemperature(unsigned short val_Fluid);
	 ...
	 */		
	virtual void SetEddyViscosity(unsigned short val_Kind_Turb_Model, double *Turb_Solution);
	 ...
	 * \brief A virtual member.
	 */
	virtual void SetPressure(double GammaMonatomic, double GammaDiatomic);
	 ...
	 */
	virtual void SetF1blending(double val_viscosity, double val_dist, double val_density);

	/*!
	 * \brief Get the blending function for the blending of k-w and k-eps.
	 */
	 ...
	 * \brief Add a value to the maximum eigenvalue for the inviscid terms of the PDE.
	 * \param[in] val_max_lambda - Value of the maximum eigenvalue for the inviscid terms of the PDE.
	 * \param[in] iFluids - Value of fluid to which the eigenvalue belongs
	 */
	virtual void AddMax_Lambda_Inv(double val_max_lambda, unsigned short iFluids);
};
...
protected:
	...
	double DensityInc; /*!< \brief Density of the fluid (used in two phase incompressible flows). */
...
public:
	 ...
	 * \param[in] Turb_Solution - Solution of the turbulence model.
	 */
	void SetEddyViscosity(unsigned short val_Kind_Turb_Model, double *Turb_Solution);
...
public:
	 ...
	 * \param[in] config - Definition of the particular problem.	 
	 */	
	CTurbSAVariable(double val_nu_tilde, unsigned short val_ndim, unsigned short val_nvar, CConfig *config);
...
public:
	 ...
	 * \param[in] val_density - Value of the density.
	 */
	void SetF1blending(double val_viscosity, double val_dist, double val_density);
...
public:
	 ...
	 * \param[in] config - Definition of the particular problem.	 
	 */		
	CPlasmaMonatomicVariable(double *val_density, double **val_velocity, double *val_energy, unsigned short val_ndim, 
			unsigned short val_nvar, unsigned short val_nSpecies, unsigned short  val_nFluids, CConfig *config);
	 ...
	 * \param[in] config - Definition of the particular problem.	 
	 */		
	CPlasmaMonatomicVariable(double *val_solution, unsigned short val_ndim, unsigned short val_nvar, CConfig *config);
	 ...
	 */
	void SetTemperature(unsigned short val_Fluid);
	 ...
	 * \return Value of the velocity for the dimension <i>val_dim</i>.
	 */
	double GetVelocity(unsigned short val_dim, unsigned short val_Fluid);
	 ...
	 */
	double GetSoundSpeed(unsigned short val_Fluid);
	 ...
	 * \return the value of the maximum eigenvalue for the inviscid terms of the PDE.
	 */
	double GetMax_Lambda_Inv(unsigned short iFluids);
	 ...
	 * \param[in] iFluids - Value of fluid to which the eigenvalue belongs
	 */
	void AddMax_Lambda_Inv(double val_max_lambda, unsigned short iFluids);
};

/*! 
 * \class CPlasmaDiatomicVariable
 * \brief Main class for defining the variables of the Plasma solver.
 * \version 1.0.
 */
class CPlasmaDiatomicVariable : public CVariable {
protected:
	double *Pressure;	/*!< \brief  partial Pressure of species in flow. */
	double *Temperature;	/*!< \brief temperature of species in flow. */
	double **Gradient_Primitive;	/*!< \brief Gradient of the primitive variables (T,vx,vy,vz,P,rho). */ 
...
public:
	 ...
	 * \param[in] *val_energy_formation -Vector of values of chemical energies of formation for all species. 
	 ...
	 * \param[in] config - Definition of the particular problem.	 
	 */		
	CPlasmaDiatomicVariable(double *val_density, double **val_velocity, double *val_energy, double *val_energy_vib, 
	 ...
	 * \param[in] config - Definition of the particular problem.	 
	 */		
	CPlasmaDiatomicVariable(double *val_solution, unsigned short val_ndim, unsigned short val_nvar, CConfig *config);
	 ...
	 * \brief Set the value of the pressure.
	 */
	void SetPressure(double GammaMonatomic, double GammaDiatomic);
...
/*! 
 * \class CCombustionVariable
 * \brief Main class for defining the variables of the Combustion.
 * \version 1.0.
 */
class CCombustionVariable : public CVariable {

public:
	/*!
	 * \brief Constructor of the class. 
	 */	
	CCombustionVariable(void);
	 ...
	 * \param[in] config - Definition of the particular problem.
	 */
	CCombustionVariable(unsigned short val_ndim, unsigned short val_nvar, CConfig *config);

	/*!
	 * \overload
	 * \param[in] val_lambda - Lambda variable value (initialization value).
	 * \param[in] val_ndim - Number of dimensions of the problem.
	 * \param[in] val_nvar - Number of variables of the problem.
	 * \param[in] config - Definition of the particular problem.	 
	 */	
	CCombustionVariable(double val_lambda, unsigned short val_ndim, unsigned short val_nvar, CConfig *config);

	/*!
	 * \brief Destructor of the class.
	 */
	virtual ~CCombustionVariable(void);
