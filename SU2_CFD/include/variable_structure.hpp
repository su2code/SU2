...
public:
   ...
   */
  virtual su2double CalcEve(CConfig *config, su2double val_Tve,
                            unsigned short val_Species);

  /*!
   * \brief Calculates enthalpy per mass, \f$h_s\f$, for input species (not including KE)
   */
  virtual su2double CalcHs(CConfig *config, su2double val_T, su2double val_eves,
                           unsigned short val_Species);

  /*!
   * \brief Calculates enthalpy per mass, \f$Cv_s\f$, for input species (not including KE)
   */
  virtual su2double CalcCvve(su2double val_Tve, CConfig *config,
                             unsigned short val_Species);
   ...
   * \param[in] dPdU
   */
  virtual void CalcdPdU(su2double *V, su2double *val_eves,
