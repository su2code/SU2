...
/*!
  ...
  inline void SetOldSolution_Store(unsigned long iPoint) {
  ...
  inline virtual void SetSensitivity_AugmentedLagrangian(unsigned long iPoint, unsigned short iDim, unsigned short kind, su2double val) { }
