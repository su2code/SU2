...
public:
   ...
   */
  inline virtual void SetStreamwise_Periodic_RecoveredPressure(su2double val_pressure) {}
  
  /*!
   * \brief A virtual member.
   * \return Recovered/Physical pressure for streamwise periodic flow.
   */
  inline virtual su2double GetStreamwise_Periodic_RecoveredPressure(void) { return 0.0; }
  
  /*!
   * \brief A virtual member.
   * \param[in] val_temperature - temperature value.
   */
  inline virtual void SetStreamwise_Periodic_RecoveredTemperature(su2double val_temperature) {}
  
  /*!
   * \brief A virtual member.
   * \return Recovered/Physical temperature for streamwise periodic flow.
   */
  inline virtual su2double GetStreamwise_Periodic_RecoveredTemperature(void) { return 0.0; }

  /*!
   * \brief A virtual member.
   * \param[in] val_velocity - Pointer to the velocity.
   */
  inline virtual void SetVelocity(su2double *val_velocity) {}
