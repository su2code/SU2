...
//  inline virtual su2double GetGammaBC(unsigned long iPoint) const { return 0.0; }
  ...
  inline virtual void SetProductionTerm(unsigned long iPoint, su2double val_production) {}
  inline virtual void SetDestructionTerm(unsigned long iPoint, su2double val_destruction) {}
  inline virtual su2double GetProductionTerm(unsigned long iPoint) const { return 0.0; }
  inline virtual su2double GetDestructionTerm(unsigned long iPoint) const { return 0.0; }
