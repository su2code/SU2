...
public:
   ...
   */
  inline virtual su2double GetVorticityMag(unsigned long iPoint) const { return 0.0; }
   ...
   */
  inline virtual void SetBlendingFunc(unsigned long iPoint, const su2double val_viscosity, const su2double val_dist, const su2double val_density) {}
  ...
  inline virtual su2double GetTauWallFactor(unsigned long iPoint) const { return 1.0; }
