...
public:
   ...
   */
  inline su2double GetMassTruncError(void) { return Mass_TruncError; }
  
  /*!
   * \brief Add a value to the truncation error.
   * \param[in] val_truncation_error - Value that we want to add to the truncation error.
   */
  inline void AddMass_TruncError(su2double val_mass_truncation_error) { Mass_TruncError += val_mass_truncation_error ; }
  
  /*!
   * \brief Subtract a value to the truncation error.
   * \param[in] val_truncation_error - Value that we want to subtract to the truncation error.
   */
  inline void SubtractMass_TruncError(su2double val_mass_truncation_error) { Mass_TruncError -= val_mass_truncation_error ; }
  
  /*!
   * \brief Set the truncation error to zero.
   */
  inline void SetMass_TruncErrorZero(void) { Mass_TruncError = 0.0 ; }
   ...
   * \brief A virtual member.
   */
  inline virtual su2double GetPrimitiveMGCorr(unsigned short val_var) {return 0; }
 ...
 /*!
   * \brief A virtual member.
   */
  inline virtual void SetPrimitiveMGCorr(unsigned short val_var, su2double val_prim) {}
...
/*!
   * \brief A virtual member.
   */
  inline virtual void SetPrimitiveMGCorr(su2double *val_prim_new) {}
   ...
   * \brief A virtual member.
   */
  inline virtual su2double *GetPrimitiveMGCorr(void) { return NULL; }
   ...
   * \brief A virtual member.
   */
  inline virtual void SetPressure_val(su2double val_pressure) {}
