...
class CTNE2TurbSAVariable : public CTNE2TurbVariable {
...
public:
   ...
   */
  CTNE2TurbSAVariable(su2double val_nu_tilde, su2double val_muT, unsigned short val_nDim, unsigned short val_nvar, CConfig *config);
