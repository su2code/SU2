...
/*!
 * \class CTNE2TurbSAVariable
 * \brief Main class for defining the variables of the turbulence model.
 * \ingroup Turbulence_Model
 * \author W. Maier
 */

class CTNE2TurbSAVariable final : public CTurbVariable {
...
public:
  ...
  */
  CTNE2TurbSAVariable(su2double val_nu_tilde, su2double val_muT, unsigned long npoint, unsigned long ndim, unsigned long nvar, CConfig *config);

  /*!
   * \brief Destructor of the class.
   */
  ~CTNE2TurbSAVariable() = default;
