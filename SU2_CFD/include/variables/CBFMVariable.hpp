...
class CBFMVariable : public CVariable {
    ...
    */
    su2double GetBodyForce(unsigned long iPoint, unsigned short iDim){return Body_Force_Vector(iPoint, iDim);};
    ...
    */
    void SetBodyForce(unsigned long iPoint, unsigned short iDim, su2double value){Body_Force_Vector(iPoint, iDim) = value;}
