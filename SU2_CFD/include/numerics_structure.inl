...
inline void CNumerics::ComputeResidual_HeatMassTransfer(su2double S, su2double h, su2double Y,  su2double *Residual, su2double **Jacobian_i) {}
...
inline void CNumerics::Set2phaseVar(su2double *val_2phasevar_i, su2double *val_2phasevar_j) {
  Two_phaseVar_i = val_2phasevar_i;
...
inline void CNumerics::Set2phaseVarGradient(su2double **val_2phasevar_grad_i, su2double **val_2phasevar_grad_j) {
  Two_phaseVar_Grad_i = val_2phasevar_grad_i;
  Two_phaseVar_Grad_j = val_2phasevar_grad_j;
}
...
inline void CNumerics::ComputeResidual(su2double **val_Jacobian_i, su2double *val_Jacobian_mui, su2double ***val_Jacobian_gradi, 
 ...
 inline su2double CNumerics::GetNucleation_Rate (su2double P, su2double T, su2double rho, su2double h, su2double k, su2double mu, su2double CpoCv, su2double HeatCapP, su2double *V_Liquid) {
        return nucleation_model->SetNucleationRate(P, T, rho, h, k, mu, CpoCv, HeatCapP, V_Liquid);
}

 inline su2double CNumerics::GetGrowth_Rate (su2double P, su2double T, su2double rho, su2double h, su2double k, su2double mu, su2double CpoCv, su2double HeatCapP, su2double *V_Liquid) {
        return nucleation_model->SetGrowthRate(P, T, rho, h, k, mu, CpoCv, HeatCapP, V_Liquid);
}
