/*!
 * \file CSourcePieceWise_TurbSA_Neg.hpp
 * \brief Delaration of numerics class CSourcePieceWise_TurbSA_Neg, the
 *        implementation is in the CSourcePieceWise_TurbSA_Neg.cpp file.
