/*!
 * \file CSourcePieceWise_TurbSA_COMP.hpp
 * \brief Delaration of numerics class CSourcePieceWise_TurbSA_COMP, the
 *        implementation is in the CSourcePieceWise_TurbSA_COMP.cpp file.
