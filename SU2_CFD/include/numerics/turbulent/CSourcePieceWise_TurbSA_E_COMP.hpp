/*!
 * \file CSourcePieceWise_TurbSA_E_COMP.hpp
 * \brief Delaration of numerics class CSourcePieceWise_TurbSA_E_COMP, the
 *        implementation is in the CSourcePieceWise_TurbSA_E_COMP.cpp file.
