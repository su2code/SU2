/*!
 * \file CSourceRotatingFrame_AdjFlow.hpp
 * \brief Delaration of numerics class CSourceRotatingFrame_AdjFlow, the
 *        implementation is in the CSourceRotatingFrame_AdjFlow.cpp file.
