...
protected:
  ...
  su2double *Diff_U = nullptr, *Lambda = nullptr, *Epsilon = nullptr;
...
private:
  ...
  su2double sq_vel, R, RoePressure, RoeDensity, RoeEnthalpy, RoeSoundSpeed,
...
private:
  ...
  su2double sq_vel, Proj_ModJac_Tensor_ij, R, RoeDensity, RoeEnthalpy, RoeSoundSpeed, RoeSoundSpeed2,
