/*!
 * \file CSourceIncRotatingFrame_Flow.hpp
 * \brief Delaration of numerics class CSourceIncRotatingFrame_Flow, the
 *        implementation is in the CSourceIncRotatingFrame_Flow.cpp file.
