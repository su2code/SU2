/*!
 * \file computeLimitersSharpEdges.hpp
 ...
 */
template<>
struct LimiterDetails<SHARP_EDGES>
{
...
/*!
 * \brief Create a version of the generalized limiter for sharp edges.
 */
template<class FieldType, class GradientType>
void computeLimitersSharpEdges(CSolver* solver,
                               ...
                               FieldType& limiter)
{
  generalizedLimiter<FieldType, GradientType, SHARP_EDGES>(solver,
