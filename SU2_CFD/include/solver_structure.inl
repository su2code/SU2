...
inline void CSolver::SortAdaptedSolution(CGeometry **geometry, CSolver ***solver, CConfig *config, vector<vector<passivedouble> > const &SolAdap, int val_iter, bool val_update_geo) { }
...
inline void CSolver::SetGeometrySensitivityLagrangian(CGeometry *geometry, unsigned short kind){}
...
inline void CSolver::UpdateStateVariable(CConfig *config, su2double fd_step){}
...
inline void CSolver::SetSaveSolutionDelta(CGeometry *geometry){}
