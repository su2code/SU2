...
inline void CTransLMSolver::SetFreeStream_Solution(CConfig *config){
  for (unsigned long iPoint = 0; iPoint < nPoint; iPoint++){
    node[iPoint]->SetSolution(0, Intermittency_Inf);
    node[iPoint]->SetSolution(1, REth_Inf);
  }
}

inline su2double *CTransLMSolver::GetConstants() { return constants; }
...
inline su2double* CTurbSSTSolver::GetConstants() { return constants; }
