...
inline su2double CIncEulerSolver::GetOneD_FluxAvgEnthalpy(void) { return OneD_EnthalpyRef; }

inline void CIncEulerSolver::SetOneD_FluxAvgEnthalpy(su2double EnthalpyRef) { OneD_EnthalpyRef = EnthalpyRef; }
