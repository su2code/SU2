...
public:
   ...
   */
  inline su2double GetTotal_Sens_E(unsigned short iVal) const final { return Total_Sens_E[iVal]; }

  /*!
   * \brief Set the total Poisson's ratio sensitivity.
   * \return Value of the Poisson's ratio sensitivity
   */
  inline su2double GetTotal_Sens_Nu(unsigned short iVal) const final { return Total_Sens_Nu[iVal]; }

  /*!
   * \brief Get the total sensitivity for the structural density
   * \return Value of the structural density sensitivity
   */
  inline su2double GetTotal_Sens_Rho(unsigned short iVal) const final { return Total_Sens_Rho[iVal]; }

  /*!
   * \brief Get the total sensitivity for the structural weight
   * \return Value of the structural weight sensitivity
   */
  inline su2double GetTotal_Sens_Rho_DL(unsigned short iVal) const final { return Total_Sens_Rho_DL[iVal]; }

  /*!
   * \brief A virtual member.
   * \return Value of the sensitivity coefficient for the Electric Field in the region iEField (time averaged)
   */
  inline su2double GetTotal_Sens_EField(unsigned short iEField) const final { return Total_Sens_EField[iEField]; }

  /*!
   * \brief A virtual member.
   * \return Value of the total sensitivity coefficient for the FEA DV in the region iDVFEA (time averaged)
   */
  inline su2double GetTotal_Sens_DVFEA(unsigned short iDVFEA) const final { return Total_Sens_DV[iDVFEA]; }

  /*!
   * \brief A virtual member.
   * \return Value of the sensitivity coefficient for the Young Modulus E
   */
  inline su2double GetGlobal_Sens_E(unsigned short iVal) const final { return Global_Sens_E[iVal]; }

  /*!
   * \brief A virtual member.
   * \return Value of the Mach sensitivity for the Poisson's ratio Nu
   */
  inline su2double GetGlobal_Sens_Nu(unsigned short iVal) const final { return Global_Sens_Nu[iVal]; }

  /*!
   * \brief A virtual member.
   * \return Value of the sensitivity coefficient for the Electric Field in the region iEField
   */
  inline su2double GetGlobal_Sens_EField(unsigned short iEField) const final { return Global_Sens_EField[iEField]; }

  /*!
   * \brief A virtual member.
   * \return Value of the sensitivity coefficient for the FEA DV in the region iDVFEA
   */
  inline su2double GetGlobal_Sens_DVFEA(unsigned short iDVFEA) const final { return Global_Sens_DV[iDVFEA]; }

  /*!
   * \brief Get the total sensitivity for the structural density
   * \return Value of the structural density sensitivity
   */
  inline su2double GetGlobal_Sens_Rho(unsigned short iVal) const final { return Global_Sens_Rho[iVal]; }

  /*!
   * \brief Get the total sensitivity for the structural weight
   * \return Value of the structural weight sensitivity
   */
  inline su2double GetGlobal_Sens_Rho_DL(unsigned short iVal) const final { return Global_Sens_Rho_DL[iVal]; }
   ...
   */
  inline su2double GetVal_Young(unsigned short iVal) const final { return E_i[iVal]; }
   ...
   */
  inline su2double GetVal_Poisson(unsigned short iVal) const final { return Nu_i[iVal]; }
   ...
   */
  inline su2double GetVal_Rho(unsigned short iVal) const final { return Rho_i[iVal]; }
   ...
   */
  inline su2double GetVal_Rho_DL(unsigned short iVal) const final { return Rho_DL_i[iVal]; }
   ...
   */
  inline unsigned short GetnEField(void) const final { return nEField; }

  /*!
   * \brief Read the design variables for the adjoint solver
   */
  void ReadDV(CConfig *config) final;
