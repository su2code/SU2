...
class CPBIncEulerSolver : public CFVMFlowSolverBase<CPBIncEulerVariable, INCOMPRESSIBLE> {
protected:
...
public:
   ...
   */
  CPBIncEulerSolver(void): CFVMFlowSolverBase<CPBIncEulerVariable, INCOMPRESSIBLE>() {}
