...
public:
   ...
   * \param[in] scalars - scalars from species transport.
   */
  static void ComputeConsistentExtrapolation(CFluidModel* fluidModel, unsigned short nDim, su2double* primitive, su2double* scalars = nullptr);
