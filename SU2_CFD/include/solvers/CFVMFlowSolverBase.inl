...
void CFVMFlowSolverBase<V, R>::BC_Sym_Plane(CGeometry* geometry, CSolver** solver_container, CNumerics* conv_numerics,
  ...
  for (iVertex = 0; iVertex < geometry->nVertex[val_marker]; iVertex++) {
    ...
    //   /*--- normal is constant but this routine is used for Symmetry, Euler-Wall in inviscid flow ----*/
    ...
    //   // so instead of u-2*v.n we can reflect only the tangential component u-1*v.n
    //   for (iDim = 0; iDim < nDim; iDim++)
    ...
    //     cout <<"point "<<iPoint<< ", residual["<<iVar<<"] = " << residual[iVar] << endl;
