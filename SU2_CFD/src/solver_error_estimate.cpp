/*!
 * \file solver_error_estimate.cpp
 * \brief Main subroutines for solving the error estimate problem.
 * \author B. Munguia
 * \version 5.0.0 "Raven"
 *
...
CGradErrSolver::CGradErrSolver(void) : CSolver () {

}

CGradErrSolver::CGradErrSolver(CGeometry *geometry, CConfig *config)  : CSolver() {
...
CGradErrSolver::~CGradErrSolver(void) {
...
void CGradErrSolver::SetRecording(CGeometry* geometry, CConfig *config){
...
void CGradErrSolver::RegisterVariables(CGeometry *geometry, CConfig *config, bool reset) {
...
void CGradErrSolver::RegisterOutput(CGeometry *geometry, CConfig *config) {
...
void CGradErrSolver::ExtractAdjoint_Solution(CGeometry *geometry, CConfig *config){
...
void CGradErrSolver::ExtractAdjoint_Variables(CGeometry *geometry, CConfig *config) {
...
void CGradErrSolver::SetAdjoint_Output(CGeometry *geometry, CConfig *config) {
...
void CGradErrSolver::SetSensitivity(CGeometry *geometry, CConfig *config) {
...
void CGradErrSolver::SetSurface_Sensitivity(CGeometry *geometry, CConfig *config) {
...
void CGradErrSolver::Preprocessing(CGeometry *geometry, CSolver **solver_container, CConfig *config_container, unsigned short iMesh, unsigned short iRKStep, unsigned short RunTime_EqSystem, bool Output) {
...
void CGradErrSolver::LoadRestart(CGeometry **geometry, CSolver ***solver, CConfig *config, int val_iter, bool val_update_geo) {
...
void CGradErrSolver::ExtractCAA_Sensitivity(CGeometry *geometry, CConfig *config, int iExtIter){
...
void CGradErrSolver::ExtractBoomSensitivity(CGeometry *geometry, CConfig *config){
   unsigned long iPoint, iVar, iPanel;
   string  text_line;
   ifstream Boom_AdjointFile;
