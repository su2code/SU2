...
CDriver::CDriver(char* confFile, unsigned short val_nZone, SU2_Comm MPICommunicator, bool dummy_geo) :
  ...
  for (iZone = 0; iZone < nZone; iZone++) {
    ...
    MDOFsDomain   += static_cast<su2double>(DOFsPerPoint)*static_cast<su2double>(geometry_container[iZone][INST_0][MESH_0]->GetGlobal_nPointDomain())/(1.0e6);
  }
...
void CDriver::Postprocessing() {
  ...
  if ((rank == MASTER_NODE) && (wrt_perf)) {
    ...
    cout << setw(20) << "Core-hrs:" << setw(12) << static_cast<su2double>(size)*(TotalTime)/(60.0*60.0) << endl;
    cout << setw(25) << "Cores:" << setw(12) << size << " | ";
    cout << setw(20) << "DOFs/point:" << setw(12) << static_cast<su2double>(DOFsPerPoint) << endl;
    cout << setw(25) << "Points/core:" << setw(12) << 1.0e6*MpointsDomain/static_cast<su2double>(size) << " | ";
    cout << setw(20) << "Ghost points/core:" << setw(12) << 1.0e6*(Mpoints-MpointsDomain)/static_cast<su2double>(size) << endl;
    ...
    if (IterCount != 0) {
      cout << setw(20) << "Avg. s/iter:" << setw(12)<< UsedTimeCompute/static_cast<su2double>(IterCount) << endl;
      cout << setw(25) << "Core-s/iter/Mpoints:" << setw(12)<< static_cast<su2double>(size)*UsedTimeCompute/static_cast<su2double>(IterCount)/Mpoints << " | ";
      cout << setw(20) << "Mpoints/s:" << setw(12)<< Mpoints*static_cast<su2double>(IterCount)/UsedTimeCompute << endl;
    } else cout << endl;
    cout << endl;
    ...
    if (OutputCount != 0) {
      cout << setw(20)<< "Avg. s/output:" << setw(12)<< UsedTimeOutput/static_cast<su2double>(OutputCount) << endl;
      if (BandwidthSum > 0) {
        cout << setw(25)<< "Restart Aggr. BW (MB/s):" << setw(12)<< BandwidthSum/static_cast<su2double>(OutputCount) << " | ";
        cout << setw(20)<< "MB/s/core:" << setw(12)<< BandwidthSum/static_cast<su2double>(OutputCount)/static_cast<su2double>(size) << endl;
      }
    } else cout << endl;
    cout << "-------------------------------------------------------------------------" << endl;
    cout << endl;
