...
CDiscAdjMultizoneDriver::CDiscAdjMultizoneDriver(char* confFile,
  ...
  for (iZone = 0; iZone < nZone; iZone++) {
    ...
    for(iInst = 0; iInst < direct_nInst[iZone]; iInst++) {
      ...
      switch (config_container[iZone]->GetKind_Solver()) {
        ...
        case ENUM_MAIN_SOLVER::DISC_ADJ_EULER: case ENUM_MAIN_SOLVER::DISC_ADJ_NAVIER_STOKES: case ENUM_MAIN_SOLVER::DISC_ADJ_RANS:
          direct_iteration[iZone][iInst] = CIterationFactory::CreateIteration(ENUM_MAIN_SOLVER::EULER, config_container[iZone]);
          break;
        case ENUM_MAIN_SOLVER::DISC_ADJ_INC_EULER: case ENUM_MAIN_SOLVER::DISC_ADJ_INC_NAVIER_STOKES: case ENUM_MAIN_SOLVER::DISC_ADJ_INC_RANS:
          direct_iteration[iZone][iInst] = CIterationFactory::CreateIteration(ENUM_MAIN_SOLVER::INC_EULER, config_container[iZone]);
          break;
        case ENUM_MAIN_SOLVER::DISC_ADJ_HEAT:
          direct_iteration[iZone][iInst] = CIterationFactory::CreateIteration(ENUM_MAIN_SOLVER::HEAT_EQUATION, config_container[iZone]);
          break;
        case ENUM_MAIN_SOLVER::DISC_ADJ_FEM:
          direct_iteration[iZone][iInst] = CIterationFactory::CreateIteration(ENUM_MAIN_SOLVER::FEM_ELASTICITY, config_container[iZone]);
          break;
        default:
    ...
    switch (config_container[iZone]->GetKind_Solver()) {
      ...
      case ENUM_MAIN_SOLVER::DISC_ADJ_EULER: case ENUM_MAIN_SOLVER::DISC_ADJ_NAVIER_STOKES: case ENUM_MAIN_SOLVER::DISC_ADJ_RANS:
        direct_output[iZone] = COutputFactory::CreateOutput(ENUM_MAIN_SOLVER::EULER, config_container[iZone], nDim);
        break;
      case ENUM_MAIN_SOLVER::DISC_ADJ_INC_EULER: case ENUM_MAIN_SOLVER::DISC_ADJ_INC_NAVIER_STOKES: case ENUM_MAIN_SOLVER::DISC_ADJ_INC_RANS:
        direct_output[iZone] = COutputFactory::CreateOutput(ENUM_MAIN_SOLVER::INC_EULER, config_container[iZone], nDim);
        break;
      case ENUM_MAIN_SOLVER::DISC_ADJ_HEAT:
        direct_output[iZone] = COutputFactory::CreateOutput(ENUM_MAIN_SOLVER::HEAT_EQUATION, config_container[iZone], nDim);
        break;
      case ENUM_MAIN_SOLVER::DISC_ADJ_FEM:
        direct_output[iZone] = COutputFactory::CreateOutput(ENUM_MAIN_SOLVER::FEM_ELASTICITY, config_container[iZone], nDim);
        break;
      default:
