...
bool CTNE2EulerVariable::Cons2PrimVar(CConfig *config, double *U, double *V,
  ...
  double rho, rhoE, rhoEve, rhoE_f, rhoE_ref, rhoEve_min, rhoEve_max, rhoEve_t;
  double Ru, sqvel, rhoCvtr, rhoCvve;
  double Tve, Tve2, Tve_o;
  double f, df, NRtol, Btol, scale;
  double Tmin, Tmax, Tvemin, Tvemax;
  double radical2;
 ...
 */
bool CTNE2EulerVariable::GradCons2GradPrimVar(CConfig *config, double *U,
  ...
  /*--- Allocate arrays ---*/
  Grhou2 = new double[nDim];
  rhou   = new double[nDim];
...
void CTNE2NSVariable::SetTransportCoefficients_WBE(CConfig *config) {
  ...
  double *Ms, Mi, Mj, M;
  double rho, T, Tve, Ru, *xi;
  double Xs[nSpecies], conc;
  double Cves;
  double phis[nSpecies], mus[nSpecies], ks[nSpecies], kves[nSpecies];
