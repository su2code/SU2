...
void CDiscAdjFlowOutput::SetConvHistory_Header(CConfig *config, unsigned short val_iZone, unsigned short val_iInst) {
...
void CDiscAdjFlowOutput::SetConvHistory_Body(CGeometry ****geometry,
