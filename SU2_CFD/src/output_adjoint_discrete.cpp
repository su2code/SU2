...
void CDiscAdjFlowOutput::SetConvHistory_Header(ofstream *ConvHist_file, CConfig *config, unsigned short val_iZone, unsigned short val_iInst) {
...
void CDiscAdjFlowOutput::SetConvHistory_Body(ofstream *ConvHist_file,
                                  CGeometry ****geometry,
