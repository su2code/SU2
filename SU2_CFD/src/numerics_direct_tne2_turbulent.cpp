...
CAvgGrad_TNE2Scalar::CAvgGrad_TNE2Scalar(unsigned short val_nDim,
                                     unsigned short val_nVar,
                                     bool correct_grad,
                                     CConfig *config)
...
CAvgGrad_TNE2Scalar::~CAvgGrad_TNE2Scalar(void) {
...
CAvgGrad_TNE2TurbSA::CAvgGrad_TNE2TurbSA(unsigned short val_nDim,
                                 ...
                                 CConfig *config)
   : CAvgGrad_TNE2Scalar(val_nDim, val_nVar, correct_grad, config), sigma(2./3.) {
}
...
CAvgGrad_TNE2TurbSST::CAvgGrad_TNE2TurbSST(unsigned short val_nDim,
                                   unsigned short val_nVar,
                                   su2double *constants, bool correct_grad,
                                   CConfig *config)
 : CAvgGrad_TNE2Scalar(val_nDim, val_nVar, correct_grad, config) {
...
CSourcePieceWise_TNE2TurbSST::CSourcePieceWise_TNE2TurbSST(unsigned short val_nDim, unsigned short val_nVar, su2double *constants,
                                                   CConfig *config) : CNumerics(val_nDim, val_nVar, config) {
