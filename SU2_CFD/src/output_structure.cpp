...
COutput::COutput(CConfig *config) {
  ...
  if(turbo){
    ...
    TotalStaticEfficiency         = new su2double*[nMarkerTurboPerf*nTimeInstances];
    TotalTotalEfficiency          = new su2double*[nMarkerTurboPerf*nTimeInstances];
    KineticEnergyLoss             = new su2double*[nMarkerTurboPerf*nTimeInstances];
    TRadius                       = new su2double*[nMarkerTurboPerf*nTimeInstances];
    TotalPressureLoss             = new su2double*[nMarkerTurboPerf*nTimeInstances];
    MassFlowIn                    = new su2double*[nMarkerTurboPerf*nTimeInstances];
    MassFlowOut                   = new su2double*[nMarkerTurboPerf*nTimeInstances];
    FlowAngleIn                   = new su2double*[nMarkerTurboPerf*nTimeInstances];
    FlowAngleIn_BC                = new su2double*[nMarkerTurboPerf*nTimeInstances];
    FlowAngleOut                  = new su2double*[nMarkerTurboPerf*nTimeInstances];
    EulerianWork                  = new su2double*[nMarkerTurboPerf*nTimeInstances];
    TotalEnthalpyIn               = new su2double*[nMarkerTurboPerf*nTimeInstances];
    TotalEnthalpyIn_BC            = new su2double*[nMarkerTurboPerf*nTimeInstances];
    EntropyIn                     = new su2double*[nMarkerTurboPerf*nTimeInstances];
    EntropyOut                    = new su2double*[nMarkerTurboPerf*nTimeInstances];
    EntropyIn_BC                  = new su2double*[nMarkerTurboPerf*nTimeInstances];
    PressureRatio                 = new su2double*[nMarkerTurboPerf*nTimeInstances];
    TotalTemperatureIn            = new su2double*[nMarkerTurboPerf*nTimeInstances];
    EnthalpyOut                   = new su2double*[nMarkerTurboPerf*nTimeInstances];
    MachIn                        = new su2double**[nMarkerTurboPerf*nTimeInstances];
    MachOut                       = new su2double**[nMarkerTurboPerf*nTimeInstances];
    VelocityOutIs                 = new su2double*[nMarkerTurboPerf*nTimeInstances];
    DensityIn                     = new su2double*[nMarkerTurboPerf*nTimeInstances];
    PressureIn                    = new su2double*[nMarkerTurboPerf*nTimeInstances];
    TurboVelocityIn               = new su2double**[nMarkerTurboPerf*nTimeInstances];
    DensityOut                    = new su2double*[nMarkerTurboPerf*nTimeInstances];
    PressureOut                   = new su2double*[nMarkerTurboPerf*nTimeInstances];
    TurboVelocityOut              = new su2double**[nMarkerTurboPerf*nTimeInstances];
    EnthalpyOutIs                 = new su2double*[nMarkerTurboPerf*nTimeInstances];
    EntropyGen                    = new su2double*[nMarkerTurboPerf*nTimeInstances];
    AbsFlowAngleIn                = new su2double*[nMarkerTurboPerf*nTimeInstances];
    TotalEnthalpyOut              = new su2double*[nMarkerTurboPerf*nTimeInstances];
    TotalEnthalpyOutIs            = new su2double*[nMarkerTurboPerf*nTimeInstances];
    RothalpyIn                    = new su2double*[nMarkerTurboPerf*nTimeInstances];
    RothalpyOut    		  = new su2double*[nMarkerTurboPerf*nTimeInstances];
    AbsFlowAngleOut               = new su2double*[nMarkerTurboPerf*nTimeInstances];
    PressureOut_BC                = new su2double*[nMarkerTurboPerf*nTimeInstances];
    TemperatureIn                 = new su2double*[nMarkerTurboPerf*nTimeInstances];
    TemperatureOut                = new su2double*[nMarkerTurboPerf*nTimeInstances];
    TotalPressureIn               = new su2double*[nMarkerTurboPerf*nTimeInstances];
    TotalPressureOut              = new su2double*[nMarkerTurboPerf*nTimeInstances];
    TotalTemperatureOut           = new su2double*[nMarkerTurboPerf*nTimeInstances];
    EnthalpyIn                    = new su2double*[nMarkerTurboPerf*nTimeInstances];
    TurbIntensityIn               = new su2double*[nMarkerTurboPerf*nTimeInstances];
    Turb2LamViscRatioIn           = new su2double*[nMarkerTurboPerf*nTimeInstances];
    TurbIntensityOut              = new su2double*[nMarkerTurboPerf*nTimeInstances];
...
//      }
  ...
  if (rank == MASTER_NODE) {
    ...
    *Surface_CMz        = NULL;
    ...
    bool write_hist_mtz = (iExtIter % (config[val_iZone]->GetWrt_Con_Freq_MultiZone()) == 0 || iExtIter == (config[val_iZone]->GetnExtIter() -1));
...
void COutput::SpecialOutput_SpanLoad(CSolver *solver, CGeometry *geometry, CConfig *config, bool output) {
  ...
  MaxDistance, Distance, Chord, Aux, Dihedral_Leading, Dihedral_Trailing;
...
//    }
  ...
  if (rank == MASTER_NODE) cout << "Writing surface analysis files (surface_analysis.dat)." << endl;
...
void COutput::WriteTurboPerfConvHistory(CConfig *config){
  ...
  unsigned short iMarker_Monitoring, iMarkerPlot;
  string inMarker_Tag, outMarker_Tag, inMarkerTag_Mix;
  unsigned short nZone       = config->GetnZone()/nTimeInstances;
  ...
  for (iTimeInstance = 0; iTimeInstance < nTimeInstances; iTimeInstance++){
    ...
    for (iMarker_Monitoring = 0; iMarker_Monitoring < config->GetnMarker_Turbomachinery(); iMarker_Monitoring++){
      ...
      if(iMarker_Monitoring == iTimeInstance * nMarkerTurboPerf){
        cout << "BC Inlet convergence monitoring marker " << inMarker_Tag << " : "<<endl;
        cout << endl;
        cout << "     Inlet Total Enthalpy" << "     Inlet Total Enthalpy BC" << "     err(%)" <<  endl;
        cout.width(25); cout << TotalEnthalpyIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)]*config->GetEnergy_Ref();
        cout.width(25); cout << TotalEnthalpyIn_BC[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)]*config->GetEnergy_Ref();
        cout.width(25); cout << abs((TotalEnthalpyIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)] - TotalEnthalpyIn_BC[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)])/TotalEnthalpyIn_BC[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)])*100.0;
        cout << endl;
        cout << endl;
        cout << "     Inlet Entropy" << "            Inlet Entropy BC" << "            err(%)" <<  endl;
        cout.width(25); cout << EntropyIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)]*config->GetEnergy_Ref()/config->GetTemperature_Ref();
        cout.width(25); cout << EntropyIn_BC[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)]*config->GetEnergy_Ref()/config->GetTemperature_Ref();
        cout.width(25); cout << abs((EntropyIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)] - EntropyIn_BC[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)])/EntropyIn_BC[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)])*100.0;
        cout << endl;
        cout << endl;
        cout << "     Inlet Absolute Angle" << "     Inlet Absolute Angle BC" << "     err(%)" <<  endl;
        cout.width(25); cout << 180.0/PI_NUMBER*AbsFlowAngleIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)];
        cout.width(25); cout << 180.0/PI_NUMBER*FlowAngleIn_BC[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)];
        cout.width(25); cout << abs((AbsFlowAngleIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)] - FlowAngleIn_BC[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)])/FlowAngleIn_BC[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)])*100.0;
        cout << endl;
        cout << endl;
        if(turbulent){
          if(menter_sst){
            cout << "     Inlet TurbIntensity" << "      Inlet TurbIntensity BC" << "      err(%)" <<  endl;
            cout.width(25); cout << TurbIntensityIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)];
            cout.width(25); cout << config->GetTurbulenceIntensity_FreeStream();
            cout.width(25); cout << abs((TurbIntensityIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)] - config->GetTurbulenceIntensity_FreeStream())/config->GetTurbulenceIntensity_FreeStream())*100.0;
            cout << endl;
            cout << endl;
            cout << "     Inlet Turb2LamRatio" << "      Inlet Turb2LamRatio BC" << "      err(%)" <<  endl;
            cout.width(25); cout << Turb2LamViscRatioIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)];
            cout.width(25); cout << config->GetTurb2LamViscRatio_FreeStream();
            cout.width(25); cout << abs((Turb2LamViscRatioIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)] - config->GetTurb2LamViscRatio_FreeStream())/config->GetTurb2LamViscRatio_FreeStream())*100.0;
            cout << endl;
            cout << endl;
          }
          else{
            cout << "     Inlet Nu Factor" << "          Inlet Nu Factor BC" << "          err(%)" <<  endl;
            cout.width(25); cout << NuFactorIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)];
            cout.width(25); cout << config->GetNuFactor_FreeStream();
            cout.width(25); cout << abs((NuFactorIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)] - config->GetNuFactor_FreeStream())/config->GetNuFactor_FreeStream())*100.0;
            cout << endl;
            cout << endl;
          }
        }
      }
      if(iMarker_Monitoring ==  iTimeInstance * nMarkerTurboPerf + config->GetnMarker_Turbomachinery() -1 ){
        // if BC outlet
        ...
        cout.width(25); cout << PressureOut_BC[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)]*config->GetPressure_Ref();
        cout.width(25); cout << abs((PressureOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)] - PressureOut_BC[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)])/PressureOut_BC[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)])*100.0;
        cout << endl;
        cout << endl;
      }
      ...
      cout.width(25); cout << MassFlowIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)]*config->GetVelocity_Ref()*config->GetDensity_Ref();
      cout.width(25); cout << MassFlowOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)]*config->GetVelocity_Ref()*config->GetDensity_Ref();
      cout.width(25); cout << abs((MassFlowIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)] - MassFlowOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)])/MassFlowIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)])*100.0;
      cout << endl;
      cout << endl;
      //if(stator)
      ...
      cout.width(25); cout << RothalpyIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)]*config->GetEnergy_Ref();
      cout.width(25); cout << RothalpyOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)]*config->GetEnergy_Ref();
      cout.width(25); cout << abs((RothalpyIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)] - RothalpyOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)])/RothalpyIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)])*100.0;
      cout << endl;
      cout << endl;
      ...
      cout.width(25); cout << TotalPressureLoss[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)]*100.0;
      cout.width(25); cout << KineticEnergyLoss[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)]*100.0;
      cout.width(25); cout << EntropyGen[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)]*100.0;
      cout << endl;
      // if BC outlet
      cout << "BC outlet convergence monitoring  marker " << outMarker_Tag << " : "<<endl;
      cout << endl;
      ...
      cout.width(25); cout << TotalEnthalpyIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)]*config->GetEnergy_Ref();
      cout.width(25); cout << EulerianWork[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)]*config->GetEnergy_Ref();
      cout.width(25); cout << PressureRatio[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)];
      cout << endl;
      cout << endl;
      cout << "     Inlet Entropy" << "            Outlet Entropy" << "             Outlet Is. Enthalpy" <<  endl;
      cout.width(25); cout << EntropyIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)]*config->GetEnergy_Ref()/config->GetTemperature_Ref();
      cout.width(25); cout << EntropyOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)]*config->GetEnergy_Ref()/config->GetTemperature_Ref();
      cout.width(25); cout << EnthalpyOutIs[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)]*config->GetEnergy_Ref();
      cout << endl;
      cout << endl;
      ...
      cout.width(25); cout << sqrt(MachIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)][0]*MachIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)][0] +MachIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)][1]*MachIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)][1]);
      cout.width(25); cout << MachIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)][0];
      cout.width(25); cout << MachIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)][1];
      cout << endl;
      cout << endl;
      cout << "     Outlet Mach"<< "              Outlet Normal Mach" << "           Outlet Tang. Mach" << endl;
      cout.width(25); cout << sqrt(MachOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)][0]*MachOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)][0] +MachOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)][1]*MachOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)][1]);
      cout.width(25); cout << MachOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)][0];
      cout.width(25); cout << MachOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)][1];cout << endl;
      cout << endl;
      cout << "     Inlet Flow Angle" << "         Outlet flow Angle  " << endl;
      cout.width(25); cout << 180.0/PI_NUMBER*FlowAngleIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)];
      cout.width(25); cout << 180.0/PI_NUMBER*FlowAngleOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)];
      cout << endl;
      cout << endl;
      // if gridmov
      cout << "     Inlet Abs Flow Angle" << "     Outlet Abs Flow Angle  " << endl;
      cout.width(25); cout << 180.0/PI_NUMBER*AbsFlowAngleIn[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)];
      cout.width(25); cout << 180.0/PI_NUMBER*AbsFlowAngleOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)];
      cout << endl;
      cout << endl << "-------------------------------------------------------------------------" << endl;
      cout << endl;
      if(nZone > 0 && iMarker_Monitoring < config->GetnMarker_Turbomachinery() -1){
        cout << endl << "---------- Interface between Blade " << iMarker_Monitoring + 1 << " and Blade " << iMarker_Monitoring + 2 << " -----------" << endl;
        cout << endl;
        ...
        cout.width(25); cout << abs((DensityIn[iMarkerPlot + 1][config->GetnSpan_iZones(iMarker_Monitoring +1)] - DensityOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)])/DensityIn[iMarkerPlot + 1][config->GetnSpan_iZones(iMarker_Monitoring +1)])*100.0;
        cout << endl;
        cout << endl;
        ...
        cout.width(25); cout << abs((PressureIn[iMarkerPlot + 1][config->GetnSpan_iZones(iMarker_Monitoring +1)] - PressureOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)])/PressureIn[iMarkerPlot + 1][config->GetnSpan_iZones(iMarker_Monitoring +1)])*100.0;
        cout << endl;
        cout << endl;
        cout << "     Outlet Normal Velocity " << "  Inlet Normal Velocity" << "       err(%)" <<  endl;
        cout.width(25); cout << TurboVelocityOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)][0]*config->GetVelocity_Ref();
        cout.width(25); cout << TurboVelocityIn[iMarkerPlot + 1][config->GetnSpan_iZones(iMarker_Monitoring +1)][0]*config->GetVelocity_Ref();
        cout.width(25); cout << abs((TurboVelocityIn[iMarkerPlot + 1][config->GetnSpan_iZones(iMarker_Monitoring +1)][0] - TurboVelocityOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)][0])/TurboVelocityIn[iMarkerPlot+1][config->GetnSpan_iZones(iMarker_Monitoring +1)][0])*100.0;
        cout << endl;
        cout << endl;
        cout << "     Outlet Tang. Velocity " << "   Inlet Tang. Velocity" << "        err(%)" <<  endl;
        cout.width(25); cout << TurboVelocityOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)][1]*config->GetVelocity_Ref();
        cout.width(25); cout << TurboVelocityIn[iMarkerPlot + 1][config->GetnSpan_iZones(iMarker_Monitoring +1)][1]*config->GetVelocity_Ref();
        cout.width(25); cout << abs((TurboVelocityIn[iMarkerPlot + 1][config->GetnSpan_iZones(iMarker_Monitoring +1)][1] - TurboVelocityOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)][1])/TurboVelocityIn[iMarkerPlot+1][config->GetnSpan_iZones(iMarker_Monitoring +1)][1])*100.0;
        cout << endl;
        cout << endl;
        cout << "     Outlet Entropy " << "         Inlet Entropy" << "              err(%)" <<  endl;
        cout.width(25); cout << EntropyOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)]*config->GetEnergy_Ref()/config->GetTemperature_Ref();
        cout.width(25); cout << EntropyIn[iMarkerPlot + 1][config->GetnSpan_iZones(iMarker_Monitoring +1)]*config->GetEnergy_Ref()/config->GetTemperature_Ref();
        cout.width(25); cout << abs((EntropyIn[iMarkerPlot + 1][config->GetnSpan_iZones(iMarker_Monitoring+1)] - EntropyOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)])/EntropyIn[iMarkerPlot + 1][config->GetnSpan_iZones(iMarker_Monitoring+1)])*100.0;
        if(turbulent){
          cout << endl;
          cout << endl;
          if(menter_sst){
            cout << "     Outlet TurbIntensity " << "    Inlet TurbIntensity" << "         err(%)" <<  endl;
            cout.width(25); cout << TurbIntensityOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)];
            cout.width(25); cout << TurbIntensityIn[iMarkerPlot + 1][config->GetnSpan_iZones(iMarker_Monitoring +1)];
            cout.width(25); cout << abs((TurbIntensityIn[iMarkerPlot + 1][config->GetnSpan_iZones(iMarker_Monitoring+1)] - TurbIntensityOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)])/TurbIntensityIn[iMarkerPlot + 1][config->GetnSpan_iZones(iMarker_Monitoring+1)])*100.0;
            cout << endl;
            cout << endl;
            cout << "     Outlet Turb2LamRatio " << "    Inlet Turb2LamRatio" << "         err(%)" <<  endl;
            cout.width(25); cout << Turb2LamViscRatioOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)];
            cout.width(25); cout << Turb2LamViscRatioIn[iMarkerPlot + 1][config->GetnSpan_iZones(iMarker_Monitoring +1)];
            cout.width(25); cout << abs((Turb2LamViscRatioIn[iMarkerPlot + 1][config->GetnSpan_iZones(iMarker_Monitoring+1)] - Turb2LamViscRatioOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)])/Turb2LamViscRatioIn[iMarkerPlot + 1][config->GetnSpan_iZones(iMarker_Monitoring+1)])*100.0;
          }
          else{
            cout << "     Outlet Nu Factor " << "        Inlet Nu Factor" << "             err(%)" <<  endl;
            cout.width(25); cout << NuFactorOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)];
            cout.width(25); cout << NuFactorIn[iMarkerPlot + 1][config->GetnSpan_iZones(iMarker_Monitoring +1)];
            cout.width(25); cout << abs((NuFactorIn[iMarkerPlot + 1][config->GetnSpan_iZones(iMarker_Monitoring+1)] - NuFactorOut[iMarkerPlot][config->GetnSpan_iZones(iMarker_Monitoring)])/NuFactorIn[iMarkerPlot + 1][config->GetnSpan_iZones(iMarker_Monitoring+1)])*100.0;
          }
          cout << endl;
          cout << endl << "-------------------------------------------------------------------------" << endl;
          cout << endl;
    ...
    if(nZone > 1){
      ...
      for(iStage = 0; iStage < nStages; iStage++ ){
        iMarkerPlot = iTimeInstance * nMarkerTurboPerf;
        ...
        cout.width(25); cout << TotalTotalEfficiency[iMarkerPlot + nBladesRow + iStage][nSpanWiseSections]*100.0;
        cout.width(25); cout << TotalStaticEfficiency[iMarkerPlot + nBladesRow + iStage][nSpanWiseSections]*100.0;
        cout.width(25); cout << EntropyGen[iMarkerPlot + nBladesRow + iStage][nSpanWiseSections]*100.0;
        cout << endl;
        cout << endl;
        cout << "     Pressure Ratio " << "          Outlet Is. Enthalpy" << "       In-Out MassFlow Diff (%)" <<  endl;
        cout.width(25); cout << PressureRatio[iMarkerPlot + nBladesRow + iStage][nSpanWiseSections];
        cout.width(25); cout << EnthalpyOutIs[iMarkerPlot + nBladesRow + iStage][nSpanWiseSections]*config->GetEnergy_Ref();
        cout.width(25); cout << abs((MassFlowIn[iMarkerPlot + nBladesRow + iStage][nSpanWiseSections] - MassFlowOut[iMarkerPlot + nBladesRow + iStage][nSpanWiseSections])/MassFlowIn[iMarkerPlot + nBladesRow + iStage][nSpanWiseSections])*100.0;
      }
      cout << endl;
      cout << endl << "-------------------------------------------------------------------------" << endl;
      cout << endl;
      ...
      cout << endl;
      cout << "     Total-Total Eff.(%)" << "      Total-Static Eff.(%)" << "      Entropy Generation(%)" << endl;
      cout.width(25); cout << TotalTotalEfficiency[iMarkerPlot + nBladesRow + nStages][nSpanWiseSections]*100.0;
      cout.width(25); cout << TotalStaticEfficiency[iMarkerPlot + nBladesRow + nStages][nSpanWiseSections]*100.0;
      cout.width(25); cout << EntropyGen[iMarkerPlot + nBladesRow + nStages][nSpanWiseSections]*100.0;
      cout << endl;
      cout << endl;
      cout << "     Pressure Ratio " << "          Outlet Is. Enthalpy" << "       In-Out MassFlow Diff (%)" <<  endl;
      cout.width(25); cout << PressureRatio[iMarkerPlot + nBladesRow + nStages][nSpanWiseSections];
      cout.width(25); cout << EnthalpyOutIs[iMarkerPlot + nBladesRow + nStages][nSpanWiseSections]*config->GetEnergy_Ref();;
      cout.width(25); cout << abs((MassFlowIn[iMarkerPlot + nBladesRow + nStages][nSpanWiseSections] - MassFlowOut[iMarkerPlot + nBladesRow + nStages][nSpanWiseSections])/MassFlowIn[iMarkerPlot + nBladesRow + nStages][nSpanWiseSections])*100.0;
      cout << endl;
      cout << endl << "-------------------------------------------------------------------------" << endl;
      cout << endl;
    }
...
void COutput::SpecialOutput_Turbo(CSolver ****solver, CGeometry ***geometry, CConfig **config,
  ...
  unsigned long iExtIter = config[val_iZone]->GetExtIter();
  su2double* SpanWiseValuesIn, *SpanWiseValuesOut, absFlowAngle2;
  int rank;
#ifdef HAVE_MPI
  MPI_Comm_rank(MPI_COMM_WORLD, &rank);
#else
  ...
  if (rank == MASTER_NODE){
    ...
    for(iSpan = 0; iSpan < config[ZONE_0]->GetnSpan_iZones(val_iZone); iSpan++){
      ...
      myfile.width(15); myfile << iSpan;
      myfile.width(30); myfile << (SpanWiseValuesIn[iSpan] - SpanWiseValuesIn[0])/(SpanWiseValuesIn[config[ZONE_0]->GetnSpan_iZones(val_iZone)-1] -SpanWiseValuesIn[0]);
    ...
    for(iSpan = 0; iSpan < config[ZONE_0]->GetnSpan_iZones(val_iZone); iSpan++){
      ...
      myfile.width(15); myfile << iSpan;
      myfile.width(30); myfile << (SpanWiseValuesOut[iSpan] - SpanWiseValuesOut[0])/(SpanWiseValuesOut[config[ZONE_0]->GetnSpan_iZones(val_iZone)-1] -SpanWiseValuesOut[0]);
    ...
    for(iSpan = 0; iSpan < config[ZONE_0]->GetnSpan_iZones(val_iZone); iSpan++){
      ...
      absFlowAngle2 = atan(TurboVelocityIn[val_iZone][iSpan][2]/TurboVelocityIn[val_iZone][iSpan][0]);
      if(absFlowAngle2 != absFlowAngle2){
        myfile.width(30); myfile << "0.0000";
      }
      else{
        myfile.width(30); myfile << absFlowAngle2*180.0/PI_NUMBER;
      }
    ...
    for(iSpan = 0; iSpan < config[ZONE_0]->GetnSpan_iZones(val_iZone); iSpan++){
      ...
      absFlowAngle2 = atan(TurboVelocityOut[val_iZone][iSpan][2]/TurboVelocityOut[val_iZone][iSpan][0]);
      if(absFlowAngle2 != absFlowAngle2){
        myfile.width(30); myfile << "0.0000";
      }
      else{
  ...
  if (rank == MASTER_NODE) {
    ...
    for (iGeomZone = 0; iGeomZone < nGeomZones; iGeomZone++){
      for (unsigned short iTimeInstance = 0; iTimeInstance < nTimeInstances; iTimeInstance++){
        ...
        sbuf_var[++var_tag] = EntropyGenAverage_HB;
        sbuf_var[++var_tag] = Power_HB;
        sbuf_var[++var_tag] = TotalStaticEfficiencyAverage_HB;
...
void COutput::SpecialOutput_AnalyzeSurface(CSolver *solver, CGeometry *geometry, CConfig *config, bool output) {
  ...
  if ((rank == MASTER_NODE) && !config->GetDiscrete_Adjoint() && output) {
    ...
    for (iMarker_Analyze = 0; iMarker_Analyze < nMarker_Analyze; iMarker_Analyze++) {
      ...
      if (config->GetSystemMeasurements() == SI) cout << ", T (K): " << Temperature << "," << endl;
      else if (config->GetSystemMeasurements() == US) cout << ", T (R): " << Temperature << "," << endl;
      ...
      if (config->GetSystemMeasurements() == SI) cout << ", Vn (m/s): " << NormalVelocity << "," << endl;
      else if (config->GetSystemMeasurements() == US) cout << ", Vn (ft/s): " << NormalVelocity << "," << endl;
