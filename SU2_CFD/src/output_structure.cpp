...
void COutput::SetConvHistory_Header(ofstream *ConvHist_file, CConfig *config, unsigned short val_iZone, unsigned short val_iInst) {
  ...
  switch (config->GetKind_Turb_Model()) {
    case SA:case SA_NEG:case SA_E: case SA_COMP: case SA_E_COMP: case SA_SALSA: case SA_RC:
    ...
    *Surface_Buffet_Metric = NULL;
    ...
    if (turbulent) {
      switch (config[val_iZone]->GetKind_Turb_Model()) {
        case SA: case SA_NEG: case SA_E: case SA_E_COMP: case SA_COMP: case SA_SALSA: case SA_RC: nVar_Turb = 1; break;
    ...
    if (turbulent) {
      switch (config[val_iZone]->GetKind_Turb_Model()) {
        case SA: case SA_NEG: case SA_E: case SA_E_COMP: case SA_COMP: case SA_SALSA: case SA_RC: nVar_AdjTurb = 1; break;
      ...
      if ((val_iZone == 0 && val_iInst == 0)|| fluid_structure){
        ...
        if (  (!fem && ((write_heads) && !(!DualTime_Iteration && Unsteady))) ||
          ...
          case RANS :
            ...
            switch (config[val_iZone]->GetKind_Turb_Model()) {
              case SA: case SA_NEG: case SA_E: case SA_E_COMP: case SA_COMP: case SA_SALSA: case SA_RC: cout << "       Res[nu]"; break;
