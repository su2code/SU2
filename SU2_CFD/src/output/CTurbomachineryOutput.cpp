 ...
 * \brief Main methods for turbomachienry output
 * \author A. Rubino
...
CTurbomachineryOutput::CTurbomachineryOutput(CConfig *config, unsigned short nDim) : CFlowOutput(config, nDim, false) {
...
void CTurbomachineryOutput::SetHistoryOutputFields(CConfig *config){
  ...
  AddHistoryOutput("ENTROPY",    "s[]",  ScreenOutputFormat::FIXED, "RMS_RES", "Root-mean square residual of the density.", HistoryFieldType::RESIDUAL);
...
void CTurbomachineryOutput::SetVolumeOutputFields(CConfig *config){
...
void CTurbomachineryOutput::LoadVolumeData(CConfig *config, CGeometry *geometry, CSolver **solver, unsigned long iPoint){
...
void CTurbomachineryOutput::LoadSurfaceData(CConfig *config, CGeometry *geometry, CSolver **solver, unsigned long iPoint, unsigned short iMarker, unsigned long iVertex){
...
void CTurbomachineryOutput::LoadHistoryData(CConfig *config, CGeometry *geometry, CSolver **solver)  {
...
bool CTurbomachineryOutput::SetInit_Residuals(CConfig *config){
...
bool CTurbomachineryOutput::SetUpdate_Averages(CConfig *config){
...
void CTurbomachineryOutput::SetAdditionalScreenOutput(CConfig *config){
...
void CTurbomachineryOutput::SetFixedCLScreenOutput(CConfig *config){
...
bool CTurbomachineryOutput::WriteHistoryFile_Output(CConfig *config) {
