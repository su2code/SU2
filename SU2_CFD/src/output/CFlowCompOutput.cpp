...
void CFlowCompOutput::SetHistoryOutputFields(CConfig *config){
  ...
  case TURB_MODEL::SST: case TURB_MODEL::SST_SUST:
    /// DESCRIPTION: Root-mean square residual of kinetic energy (TURB_MODEL::SST model).
    AddHistoryOutput("RMS_TKE", "rms[k]",  ScreenOutputFormat::FIXED, "RMS_RES", "Root-mean square residual of kinetic energy (TURB_MODEL::SST model).", HistoryFieldType::RESIDUAL);
    /// DESCRIPTION: Root-mean square residual of the dissipation (TURB_MODEL::SST model).
    AddHistoryOutput("RMS_DISSIPATION", "rms[w]",  ScreenOutputFormat::FIXED, "RMS_RES", "Root-mean square residual of dissipation (TURB_MODEL::SST model).", HistoryFieldType::RESIDUAL);
    break;
  default: break;
  }
  /// END_GROUP
