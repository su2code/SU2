...
void CSU2BinaryFileWriter::Write_Data(){
  ...
  fileSize += (su2double)var_buf_size*sizeof(int);
  ...
  for (iVar = 0; iVar < GlobalField_Counter; iVar++) {
    ...
    fileSize += (su2double)CGNS_STRING_SIZE*sizeof(char);
  }
  ...
  fileSize += (su2double)nParallel_Poin*GlobalField_Counter*sizeof(passivedouble);
  ...
  fileSize += (su2double)GlobalField_Counter*nParallel_Poin*sizeof(passivedouble);
