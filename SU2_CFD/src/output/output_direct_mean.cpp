...
CFlowOutput::CFlowOutput(CConfig *config, CGeometry *geometry, CSolver **solver, unsigned short val_iZone) : CFlowCommonOutput(config) {
...
bool CFlowOutput::SetUpdate_Averages(CConfig *config){
