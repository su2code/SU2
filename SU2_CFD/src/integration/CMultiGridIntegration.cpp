...
void CMultiGridIntegration::GetProlongated_Correction(unsigned short RunTime_EqSystem, CSolver *sol_fine, CSolver *sol_coarse,
  ...
  sol_coarse->InitiateComms(geo_coarse, config, ENUM_MPI_QUANTITIES::SOLUTION_OLD);
  sol_coarse->CompleteComms(geo_coarse, config, ENUM_MPI_QUANTITIES::SOLUTION_OLD);
...
void CMultiGridIntegration::SetProlongated_Correction(CSolver *sol_fine, CGeometry *geo_fine,
  ...
  sol_fine->InitiateComms(geo_fine, config, ENUM_MPI_QUANTITIES::SOLUTION);
  sol_fine->CompleteComms(geo_fine, config, ENUM_MPI_QUANTITIES::SOLUTION);
