...
void CDriver::Solver_Preprocessing(CSolver ****solver_container, CGeometry ***geometry,
  ...
  e_spalart_allmaras, comp_spalart_allmaras, e_comp_spalart_allmaras, salsa_spalart_allmaras;
  ...
  for (iMGlevel = 0; iMGlevel <= config->GetnMGLevels(); iMGlevel++) {
    ...
    if (turbulent) {
      if (spalart_allmaras || e_spalart_allmaras || comp_spalart_allmaras || e_comp_spalart_allmaras || neg_spalart_allmaras || salsa_spalart_allmaras) {
...
void CDriver::Solver_Postprocessing(CSolver ****solver_container, CGeometry **geometry,
  ...
  for (iMGlevel = 0; iMGlevel <= config->GetnMGLevels(); iMGlevel++) {
    ...
    if (turbulent) {
      if (spalart_allmaras || neg_spalart_allmaras || menter_sst || e_spalart_allmaras || comp_spalart_allmaras || e_comp_spalart_allmaras || salsa_spalart_allmaras) {
...
void CDriver::Numerics_Preprocessing(CNumerics *****numerics_container,
  ...
  transition,
  template_solver;
  bool e_spalart_allmaras, comp_spalart_allmaras, e_comp_spalart_allmaras, salsa_spalart_allmaras;
  ...
  if (turbulent) {
    ...
    switch (config->GetKind_ConvNumScheme_Turb()) {
      ...
      case SPACE_UPWIND :
        for (iMGlevel = 0; iMGlevel <= config->GetnMGLevels(); iMGlevel++) {
          if (spalart_allmaras || neg_spalart_allmaras || e_spalart_allmaras || comp_spalart_allmaras || e_comp_spalart_allmaras || salsa_spalart_allmaras) {
