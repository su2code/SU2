...
void CTurbSSTVariable::SetBlendingFunc(su2double val_viscosity, su2double val_dist,
  ...
  if ( transitionLM ) {
    const su2double Rey  = val_density*val_dist*sqrt(Solution[0])/(120.0*val_viscosity);
