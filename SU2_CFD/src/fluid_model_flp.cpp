...
CFluidProp::CFluidProp( string thermolib, int ncomp, string* comp, su2double* conc, bool HasSinglePhaseOnly, string tablename, su2double T_ref, su2double P_ref, su2double rho_ref, int ErrorLevel ) : CFluidModel() {
...
void CFluidProp::SetTDState_rhoe (su2double rho, su2double e ){
...
void CFluidProp::SetTDState_PT (su2double P, su2double T ){
...
void CFluidProp::SetTDState_Prho (su2double P, su2double rho ){
...
void CFluidProp::SetEnergy_Prho (su2double P, su2double rho ){
...
void CFluidProp::SetTDState_hs (su2double h, su2double s ){
...
void CFluidProp::SetTDState_rhoT (su2double rho, su2double T ){
...
void CFluidProp::SetTDState_Ps (su2double P, su2double s ){
	...
	struct fluidstate_su2_t output;
	if (ErrorLevel > 1) printf( "%ld.  P   = %f, s = %f: ", i++, P, s);
	fluidprop_allprops_su2( pair, P, s, &output);
	if (ErrorLevel > 1) printf( "T   = %f, u   = %f, rho = %f, c = %f, cv = %f \n",
			output.T, output.u, output.d, sqrt(output.c2), output.cv);
