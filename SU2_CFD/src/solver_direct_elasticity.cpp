...
void CFEM_ElasticitySolver::ComputeResidual_BGS(CGeometry *geometry, CConfig *config){
...
void CFEM_ElasticitySolver::UpdateSolution_BGS(CGeometry *geometry, CConfig *config){
