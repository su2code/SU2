...
int main(int argc, char *argv[]) {
  ...
  if ( (config->GetKind_Solver() == FEM_ELASTICITY ||
    ...
    driver = new CHBDriver(config_file_name, nTimeInstances, nDim, periodic, MPICommunicator);
    ...
    driver = new CHBMultiZoneDriver(config_file_name, nTotTimeInstances, nDim, periodic, MPICommunicator);
