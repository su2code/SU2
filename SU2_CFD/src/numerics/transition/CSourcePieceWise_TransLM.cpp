/*!
 * \file CSourcePieceWise_TransLM.cpp
 * \brief Implementation of numerics class CSourcePieceWise_TransLM.
...
#include "../../../include/numerics/transition/CSourcePieceWise_TransLM.hpp"
