...
void CAvgGrad_TurbSST::FinishResidualCalc(const CConfig* config) {
  ...
  if (exact_jacobian) {
    ...
    // if (TurbVar_i[1] > VorticityMag_i*F2_i/a1) {
      Jacobian_i[0][1] -= 0.5*TurbVar_i[0]/pow(zeta_i,2.0)*Proj_Mean_GradTurbVar[0]*sigma_kine_i;
      Jacobian_i[1][1] -= 0.5*TurbVar_i[0]/pow(zeta_i,2.0)*Proj_Mean_GradTurbVar[1]*sigma_omega_i;
    // }
    ...
    // if (TurbVar_j[1] > VorticityMag_j*F2_j/a1) {
      Jacobian_j[0][1] -= 0.5*TurbVar_j[0]/pow(zeta_j,2.0)*Proj_Mean_GradTurbVar[0]*sigma_kine_j;
      Jacobian_j[1][1] -= 0.5*TurbVar_j[0]/pow(zeta_j,2.0)*Proj_Mean_GradTurbVar[1]*sigma_omega_j;
    // }
    // const su2double zeta_i = max(TurbVar_i[1], StrainMag_i*F2_i/a1);
    // const su2double zeta_j = max(TurbVar_j[1], StrainMag_j*F2_j/a1);
    ...
    // Jacobian_j[0][0] += 0.5/zeta_j*Proj_Mean_GradTurbVar[0]*sigma_kine_j;
    // Jacobian_j[1][0] += 0.5/zeta_j*Proj_Mean_GradTurbVar[1]*sigma_omega_j;
    // if (TurbVar_j[1] > StrainMag_j*F2_j/a1) {
