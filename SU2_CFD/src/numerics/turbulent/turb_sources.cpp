...
//          Jacobian_i[0][0] = min((factor*StrainMag_i*StrainMag_i/TurbVar_i[1]-2./3.*diverg)*Volume, 0.);
...
//        else {
//          Jacobian_i[0][0] = min((factor*StrainMag_i*StrainMag_i*a1/(VorticityMag*F2_i)-2./3.*diverg)*Volume, 0.);
//        }
