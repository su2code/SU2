...
CUpwHLLC_NEMO::CUpwHLLC_NEMO(unsigned short val_nDim,
...
CUpwHLLC_NEMO::~CUpwHLLC_NEMO(void) {
...
CNumerics::ResidualType<> CUpwHLLC_NEMO::ComputeResidual(const CConfig* config) {
...
void CUpwGeneralHLLC_NEMO::VinokurMontagne() {
