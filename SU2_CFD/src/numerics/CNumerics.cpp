...
void CNumerics::GetInviscidProjJac(const su2double *val_velocity, const su2double *val_energy, const su2double *val_tke,
  ...
  a1 = Gamma*(*val_energy)-phi-(Gamma_Minus_One-TWO3)*(*val_tke);
  a2 = Gamma_Minus_One;
...
void CNumerics::GetPMatrix(su2double *val_density, su2double *val_velocity, su2double *val_tke,
  ...
  rhoxtkeoc = rhooc*(*val_tke)*(Gamma_Minus_One-TWO3)/Gamma_Minus_One;
  ...
  if (nDim == 2) {
    ...
    val_p_tensor[3][0]=0.5*sqvel+(*val_tke)*(Gamma_Minus_One-TWO3)/Gamma_Minus_One;
    ...
    val_p_tensor[4][0]=0.5*sqvel*val_normal[0]+*val_density*val_velocity[1]*val_normal[2]-*val_density*val_velocity[2]*val_normal[1]+(*val_tke)*(Gamma_Minus_One-TWO3)/Gamma_Minus_One;
    val_p_tensor[4][1]=0.5*sqvel*val_normal[1]-*val_density*val_velocity[0]*val_normal[2]+*val_density*val_velocity[2]*val_normal[0]+(*val_tke)*(Gamma_Minus_One-TWO3)/Gamma_Minus_One;
    val_p_tensor[4][2]=0.5*sqvel*val_normal[2]+*val_density*val_velocity[0]*val_normal[1]-*val_density*val_velocity[1]*val_normal[0]+(*val_tke)*(Gamma_Minus_One-TWO3)/Gamma_Minus_One;
