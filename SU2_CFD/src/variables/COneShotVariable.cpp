...
COneShotVariable::COneShotVariable(const su2double* sol, unsigned long npoint, unsigned long ndim, unsigned long nvar, CConfig *config)
  : CDiscAdjVariableVariable(sol, npoint, ndim, nvar, config) {
