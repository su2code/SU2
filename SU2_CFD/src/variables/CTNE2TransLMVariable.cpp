...
CTNE2TransLMVariable::CTNE2TransLMVariable(void) : CTNE2TurbVariable() {}

CTNE2TransLMVariable::CTNE2TransLMVariable(su2double val_nu_tilde, su2double val_intermittency, su2double val_REth,
                                   unsigned short val_nDim, unsigned short val_nvar, CConfig *config) :
                                   CTNE2TurbVariable(val_nDim, val_nvar, config) {
...
CTNE2TransLMVariable::~CTNE2TransLMVariable(void) { }
