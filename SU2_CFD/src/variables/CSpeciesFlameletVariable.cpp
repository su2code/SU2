...
CSpeciesFlameletVariable::CSpeciesFlameletVariable(const su2double* species_inf, unsigned long npoint,
  ...
  scalar_dissipation.resize(nPoint, flamelet_config_options.n_control_vars) = su2double(0.0);
  lut_temperature.resize(nPoint) = su2double(0.0);
  raw_pv_source.resize(nPoint)   = su2double(0.0);
