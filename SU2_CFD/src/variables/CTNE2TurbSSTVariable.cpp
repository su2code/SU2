...
CTNE2TurbSSTVariable::CTNE2TurbSSTVariable(su2double kine, su2double omega,
                                           su2double mut, unsigned long npoint,
                                           unsigned long ndim, unsigned long nvar,
...
void CTNE2TurbSSTVariable::SetBlendingFunc(unsigned long iPoint, su2double val_viscosity,
  ...
  /*--- Cross diffusion ---*/
  cout << "delete me: these will not make us due to indices" << endl;
  CDkw(iPoint) = 0.0;
