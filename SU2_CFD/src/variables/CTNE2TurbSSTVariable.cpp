...
CTNE2TurbSSTVariable::CTNE2TurbSSTVariable(void) : CTNE2TurbVariable() { }

CTNE2TurbSSTVariable::CTNE2TurbSSTVariable(su2double val_kine, su2double val_omega, su2double val_muT,
                                   unsigned short val_nDim, unsigned short val_nvar, su2double *constants,
                                   CConfig *config) : CTNE2TurbVariable(val_nDim, val_nvar, config) {
...
CTNE2TurbSSTVariable::~CTNE2TurbSSTVariable(void) {}

void CTNE2TurbSSTVariable::SetBlendingFunc(su2double val_viscosity, su2double val_dist, su2double val_density) {
  unsigned short iDim;
