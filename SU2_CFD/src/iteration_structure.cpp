...
void CDiscAdjFluidIteration::SetDependencies(CSolver *****solver,
  ...
  if (turbulent && !frozen_visc){
    /*--- Communicate laminar viscosity and turbulent conservatives  ---*/
    solver[iZone][iInst][MESH_0][FLOW_SOL]->InitiateComms(geometry[iZone][iInst][MESH_0], config[iZone], PRIMITIVE);
    solver[iZone][iInst][MESH_0][FLOW_SOL]->CompleteComms(geometry[iZone][iInst][MESH_0], config[iZone], PRIMITIVE);
    ...
    solver[iZone][iInst][MESH_0][TURB_SOL]->InitiateComms(geometry[iZone][iInst][MESH_0], config[iZone], SOLUTION_EDDY);
    solver[iZone][iInst][MESH_0][TURB_SOL]->CompleteComms(geometry[iZone][iInst][MESH_0], config[iZone], SOLUTION_EDDY);
  }
