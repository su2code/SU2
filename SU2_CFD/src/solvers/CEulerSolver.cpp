          ...
          if (config->GetMarker_All_TurbomachineryFlag(iMarker) == marker_flag){
            ...
            case MIXEDOUT:
              ...
              if (belowMachLimit) {
                ...
                if ((avgDensity != avgDensity) || (avgPressure != avgPressure) || avgPressure < 0.0 || avgDensity < 0.0 ){
            ...
            const bool nanSolution = ((AverageDensity[iMarker][iSpan] != AverageDensity[iMarker][iSpan]) || (AveragePressure[iMarker][iSpan] != AveragePressure[iMarker][iSpan]));
