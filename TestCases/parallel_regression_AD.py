...
def main():
    ...
    discadj_cylinder3D.test_vals = [-3.719293, -4.038113, 0.000000, 0.000000] #last 4 columns
    ...
    discadj_incomp_NACA0012.test_vals = [-3.390496, -2.570037, 0.000000, 0.000000] #last 4 columns
    ...
    checkpointing_cylinder.su2_exec  = "discrete_adjoint.py -a True -n 2"
    checkpointing_cylinder.timeout   = 1600
    checkpointing_cylinder.unsteady  = True
    checkpointing_cylinder.reference_file  = "of_grad_cd.dat.parallel2.ref"
    ...
    checkpointing_cylinder2.su2_exec  = "discrete_adjoint.py -a True -n 2"
    checkpointing_cylinder2.timeout   = 1600
    checkpointing_cylinder2.unsteady  = True
    checkpointing_cylinder2.reference_file  = "of_grad_cd.dat.parallel2.ref"
    ...
    checkpointing_equidistant.su2_exec  = "discrete_adjoint.py -a True -n 2"
    checkpointing_equidistant.timeout   = 1600
    checkpointing_equidistant.unsteady  = True
    checkpointing_equidistant.reference_file  = "of_grad_cd.dat.parallel2.ref"
