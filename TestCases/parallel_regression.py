...
def main():
    ...
    turb_oneram6.test_vals = [-2.327524, -6.564320, 0.230436, 0.155826] #last 4 columns
    ...
    turb_naca0012_1c.test_vals = [-4.947463, 1.257551, 5.476060, 1.993986] #last 4 columns
    ...
    turb_naca0012_p1c1.test_vals = [-5.026227, 1.279928, 5.926643, 2.284609] #last 4 columns
    ...
    turb_naca0012_p1c2.test_vals = [-5.358974, 1.152989, 5.570125, 2.048507] #last 4 columns
    ...
    hb_rans_preconditioning.test_vals = [-1.900982, -5.880428, 0.007759, 0.125931] #last 4 columns
    ...
    Jones_tc_rst.test_vals = [-4.410726, -1.606225, 82.250590, 2.791302] #last 4 columns
