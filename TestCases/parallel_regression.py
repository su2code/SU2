...
def main():
    ...
    cfd_flamelet_ch4.test_vals = [-14.429718, -15.860038, -8.226686, -16.506667, -19.493283, 87.326000]
   ...
   # axisymmetric 2D planar laminar premixed methane flame on isothermal burner (restart)
    ...
    cfd_flamelet_ch4_axi.test_vals = [-11.259626, -10.020810, -11.852795, -4.909152, 95.000000]
    ...
    cfd_flamelet_ch4_partial_premix.test_vals = [-10.482722, -3.621055, -12.938151, -10.154391, 10.000000]
    ...
    channel.test_vals = [-2.305865, 3.236424, 0.124945, 0.153985]
    ...
    naca0012.test_vals = [-8.373603, -7.829504, 0.335767, 0.023275]
    ...
    wedge.test_iter = 20
    wedge.test_vals = [-3.627493, 2.096561, -0.249532, 0.043953]
    ...
    oneram6.test_vals = [-11.496917, -10.965749, 0.280800, 0.008623]
    ...
    fixedCL_naca0012.test_vals = [1.043429, -4.449377, -0.043084, -0.005092]
    ...
    polar_naca0012.test_vals         = [-1.180633, 4.269908, 0.017027, 0.067471]
    ...
    flatplate.test_vals = [-6.619907, -1.147097, 0.001192, 0.029461, 2.361500, -2.332100, 0.000000, 0.000000]
    ...
    cylinder.test_vals = [-6.710791, -1.248981, 0.281368, -67.973070, 0.000000]
    ...
    cylinder_lowmach.test_vals = [-6.710791, -1.248981, 0.281368, -67.973070, 0.000000]
    ...
    poiseuille.test_vals = [-12.008298, -7.539167, -0.000000, 2.089953]
    ...
    poiseuille_profile.test_vals = [-12.008298, -7.539167, -0.000000, 2.089953]
    ...
    rae2822_sa.test_vals = [-2.489258, 5.867404, 0.522358, 0.039169]
    ...
    rae2822_sst.test_vals = [-2.489258, 5.867404, 0.522358, 0.039169]
    ...
    rae2822_sst_sust.test_vals = [-2.489258, 5.867404, 0.522358, 0.039169]
    ...
    turb_flatplate.test_vals = [-4.876686, -1.664775, -2.430911, 0.640693, -3.575081, 3.000000, -1.169304, 2.000000, -1.513294, 3.000000, -0.710098, 0.999890, 0.999890]
    ...
    turb_flatplate_species.test_vals = [-4.876686, -1.664775, -2.430911, 0.640693, -3.575081, 3.000000, -1.169304, 2.000000, -1.513294, 3.000000, -0.710098, 0.999890, 0.999890]
    ...
    turb_flatplate_CC_Wilcox.test_vals = [-4.876686, -1.664775, -2.430911, 0.640693, -3.575081, 3.000000, -1.169304, 2.000000, -1.513294, 3.000000, -0.710098, 0.999890, 0.999890]
    ...
    turb_flatplate_CC_Sarkar.test_vals = [-4.876686, -1.664775, -2.430911, 0.640693, -3.575081, 3.000000, -1.169304, 2.000000, -1.513294, 3.000000, -0.710098, 0.999890, 0.999890]
    ...
    turb_naca0012_sa.test_vals = [-6.624755, -5.057150, 0.830237, -0.008624, 0.078094]
    ...
    turb_naca0012_sst.test_vals = [-6.624755, -5.057150, 0.830237, -0.008624, 0.078094]
    ...
    turb_naca0012_sst_sust.test_vals = [-6.624755, -5.057150, 0.830237, -0.008624, 0.078094]
    ...
    turb_naca0012_sst_2003_Vm.test_vals = [-6.624755, -5.057150, 0.830237, -0.008624, 0.078094]
    ...
    turb_naca0012_sst_1994_KLm.test_vals = [-6.624755, -5.057150, 0.830237, -0.008624, 0.078094]
    ...
    turb_naca0012_sst_fixedvalues.test_vals = [-6.624755, -5.057150, 0.830237, -0.008624, 0.078094]
    ...
    turb_naca0012_sst_expliciteuler.test_vals = [-6.624755, -5.057150, 0.830237, -0.008624, 0.078094]
    ...
    axi_rans_air_nozzle_restart.test_vals = [-12.069349, -7.508309, -8.813361, -3.732852, 0]
    ...
    inc_euler_naca0012.test_vals = [-6.148698, -5.237430, 0.527489, 0.008671]
    ...
    inc_nozzle.test_vals = [-6.144528, -5.335725, 0.005747, 0.125515]
    ...
    inc_lam_cylinder.test_vals = [-4.535580, -3.903517, -0.001555, 3.463461]
    ...
    inc_poly_cylinder.test_vals = [-4.535580, -3.903517, -0.001555, 3.463461]
    ...
    turbmod_sa_bsl_rae2822.test_vals = [-2.868992, 0.045625, -0.444345, -5.303336, 0.827669, 0.027373]
    ...
    turbmod_sa_neg_rae2822.test_vals = [-2.868992, 0.045625, -0.444345, -5.303336, 0.827669, 0.027373]
    ...
    turbmod_sa_comp_rae2822.test_vals = [-2.868992, 0.045625, -0.444345, -5.303336, 0.827669, 0.027373]
    ...
    turbmod_sa_edw_rae2822.test_vals = [-2.868992, 0.045625, -0.444345, -5.303336, 0.827669, 0.027373]
    ...
    contadj_naca0012.test_vals = [-9.566932, -15.166429, -0.726250, 0.020280]
    ...
    contadj_oneram6.test_vals = [-12.018827, -12.567570, -1.086100, 0.007556]
    ...
    contadj_fixed_CL_naca0012.test_vals = [1.043429, -4.449377, -0.043084, -0.005092]
    ...
    contadj_ns_cylinder.test_vals = [-3.591070, -9.031676, 2.056700, -0.000000]
    ...
    rot_naca0012.test_vals = [-1.395261, 4.114147, -0.008916, 0.078703]
    ...
    cavity.test_iter = 25
    cavity.test_vals = [-7.866620, -2.398839, 0.005654, 0.009526]
    ...
    spinning_cylinder.test_vals = [-7.501513, -2.041214, 3.986940, 1.777302]
    ...
    sine_gust.test_vals = [-1.977498, 3.481817, -0.008845, -0.009632]
    ...
    aeroelastic.test_vals = [0.073912, 0.027470, -0.001643, -0.000126]
    ...
    flatplate_unsteady.test_vals = [-6.619907, -1.147097, 0.001192, 0.029461, 2.361500, -2.332100, 0.000000, 0.000000]
    ...
    edge_VW.test_vals = [-8.640223, -2.486172, -0.000034, 0.000000]
    ...
    edge_PPR.test_vals = [-8.640223, -2.486172, -0.000034, 0.000000]
    ...
    bars_SST_2D.test_vals = [13.000000, -0.477372, -1.386674]
    ...
    pywrapper_turb_naca0012_sst.test_vals = [-6.624755, -5.057150, 0.830237, -0.008624, 0.078094]
    ...
    pywrapper_aeroelastic.test_vals = [0.073912, 0.027470, -0.001643, -0.000126]
    ...
    pywrapper_unsteadyCHT.test_vals = [-1.614167, 2.259984, -0.001488, 0.113181]
    ...
    species2_primitiveVenturi_mixingmodel_boundedscalar.test_vals = [-5.689670, -4.511504, -4.615493, -5.795204, -0.113336, -5.704986, 5.000000, -1.433752, 5.000000, -4.921373, 5.000000, -1.771016, 0.000318, 0.000318, 0.000000, 0.000000]
    ...
    cfd_flamelet_ch4_cht.test_vals = [-9.824525, -8.913124, -9.862973, -11.271228, -3.238372, -10.916614, -12.615134, -6.614396]
