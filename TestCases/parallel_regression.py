...
def main():
    ...
    fsi2d.test_iter = 4
    fsi2d.test_vals = [4, 0, -3.771873, -4.163491] #last 4 columns
    ...
    dyn_fsi.test_iter = 4
    dyn_fsi.test_vals = [-4.400874, -4.085152, 0.000000, 117]
    ...
    pywrapper_fsi2d.test_vals = [4, 0, -3.771873, -4.163491] #last 4 columns
