...
def main():
    ...
    poiseuille_profile.test_vals = [-12.494754, -7.712974, -0.000000, 2.085796] #last 4 columns
    ...
    Jones_tc.test_vals = [-5.352425, 0.417103, 82.840150, 0.882252] #last 4 columns
