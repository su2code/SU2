...
class testcase:
  ...
  def do_adjust_iter(self):
    ...
    # Read the cfg file
    file_in = open(os.path.join(os.environ['SU2_HOME'], self.cfg_dir, self.cfg_file), 'r')
...
if __name__=="__main__":
  ...
  #os.system('./configure --prefix=$SU2_HOME --with-MPI=mpicxx --with-Metis-lib=/home/ale11/tools/metis-4.0.3 --with-Metis-include=/home/ale11/tools/metis-4.0.3/Lib CXXFLAGS="-O3"')
