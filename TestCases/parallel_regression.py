...
def main():
   ...
   # axisymmetric 2D planar laminar premixed methane flame on isothermal burner (restart)
    ...
    rae2822_sst_sust.test_vals = [-3.074837, 4.634926, 0.399337, 0.073606]
    ...
    turb_naca0012_sst_restart_mg.test_vals = [-3.737525, -5.056934, 0.830606, -0.008579, 0.077961]
    ...
    bars_SST_2D.test_vals = [13.000000, -0.395943, -1.480113]
