...
def main():
    ...
    channel_2D.test_vals = [-1.656914, 4.263142, 0.000000, 0.000000] #last 4 columns
    ...
    supersonic_vortex_shedding.test_vals = [-1.127793, 4.602536, 0.000000, 0.000000] #last 4 columns
