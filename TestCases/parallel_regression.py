...
def main():
    ...
    mms_fvm_ns.test_vals = [0.0, 0.0, 0.0, 0.0] #last 4 columns
    ...
    mms_fvm_inc_euler.test_vals = [0.0, 0.0, 0.0, 0.0] #last 4 columns
    ...
    mms_fvm_inc_ns.test_vals = [0.0, 0.0, 0.0, 0.0] #last 4 columns
