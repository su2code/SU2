...
def main():
    ...
    naca0012.test_vals = [-4.477323, -3.932956, 0.293106, 0.025241]
    ...
    wedge.test_iter = 20
    wedge.test_vals = [-3.692506, 2.031830, -0.249531, 0.043953]
    ...
    flatplate.test_vals = [-6.543297, -1.065166, 0.001196, 0.029390, 2.361500, -2.332100, 0.000000, 0.000000]
    ...
    poiseuille_profile.test_vals         = [-12.005135, -7.582839, -0.000000, 2.089953]
    ...
    periodic2d.test_vals = [-10.817615, -8.363549, -8.287466, -5.334108, -1.088411, -2945.200000]
    ...
    rae2822_sa.test_vals = [-2.191224, -5.318375, 0.383474, 0.077579, 0.000000]
    ...
    rae2822_sst.test_vals = [-1.028081, 5.870628, 0.370413, 0.074981, 0.000000]
    ...
    rae2822_sst_sust.test_vals = [-2.487678, 5.870615, 0.370413, 0.074981]
    ...
    turb_naca0012_sa.test_vals = [-12.038076, -16.332088, 1.080346, 0.018385, 20.000000, -2.873282, 0.000000, -14.250270, 0.000000]
    ...
    turb_naca0012_sst.test_vals = [-12.093932, -15.251078, -5.906324, 1.070413, 0.015775, -2.855665, 0.000000]
    ...
    turb_naca0012_sst_sust.test_vals = [-12.080824, -14.837176, -5.732906, 1.000893, 0.019109, -2.119873]
    ...
    turb_naca0012_sst_fixedvalues.test_vals = [-5.192391, -10.448086, 0.773965, 1.022535, 0.040529, -2.383430]
    ...
    axi_rans_air_nozzle_restart.test_vals = [-12.066228, -7.425956, -8.815962, -3.732763, 0.000000]
    ...
    turb_naca0012_1c.test_vals = [-4.978739, 1.343522, 0.443669, -0.029236]
    ...
    turb_naca0012_2c.test_vals = [-5.482858, 1.260864, 0.404115, -0.040444]
    ...
    turb_naca0012_3c.test_vals         = [-5.583738, 1.228727, 0.381727, -0.046309]
    ...
    turb_naca0012_p1c1.test_vals = [-5.134138, 1.283457, 0.553714, 0.011830]
    ...
    turb_naca0012_p1c2.test_vals         = [-5.553996, 1.234026, 0.423907, -0.033586]
    ...
    inc_poly_cylinder.test_vals         = [-8.230355, -2.426280, 0.018487, 1.902090, -173.000000]
    ...
    inc_turb_naca0012.test_vals = [-4.758063, -10.974497, -0.000004, -0.028654, 4.000000, -5.405203, 2.000000, -5.032742]
    ...
    inc_weakly_coupled.test_vals = [-18.106285, -16.302975, -16.484862, -15.006575, -17.858122, -14.024831, 5.609100]
    ...
    unst_deforming_naca0012.test_vals = [-3.665298, -3.794240, -3.717017, -3.148592]
    ...
    edge_VW.test_vals = [-7.053424, -0.851927, -0.000009, 0.000000]
    ...
    edge_PPR.test_vals         = [-12.410181, -6.220513, -0.000034, 0.000000]
    ...
    axial_stage2D.test_vals = [1.167176, 1.598839, -2.928275, 2.573906, -2.526637, 3.017141, 106370.000000, 106370.000000, 5.726800, 64.383000]
    ...
    transonic_stator_restart.test_vals         = [-4.367138, -2.487740, -2.079070, 1.728179, -1.464970, 3.225024, -471620.000000, 94.839000, -0.051128]
    ...
    uniform_flow.test_vals = [5.000000, 0.000000, -0.195002, -10.624447]
    ...
    channel_2D.test_vals = [2.000000, 0.000000, 0.464938, 0.348071, 0.397513]
    ...
    channel_3D.test_vals = [2.000000, 0.000000, 0.629100, 0.524935, 0.422502]
    ...
    pipe.test_iter = 2
    pipe.test_vals = [0.080826, 0.547321, 0.655099, 0.968228, 1.049129]
    pipe.unsteady  = True
    pipe.multizone = True
    ...
    rotating_cylinders.test_vals = [3.000000, 0.000000, 0.717066, 1.119817, 1.160326]
    ...
    supersonic_vortex_shedding.test_vals = [5.000000, 0.000000, 1.207119, 1.065271]
    ...
    slinc_steady.test_vals         = [19.000000, -1.144099, -1.424989]
    ...
    fsi2d.test_iter = 4
    fsi2d.test_vals = [4, 0, -3.726029, -4.277530]
    ...
    fsi_cht_restart.test_vals = [5, 0.006352, -1.960362, -9.327033, -9.629669, -9.318754, 608.38, -0.012974, 0, 20]
