...
def main():
    ...
    channel.test_vals = [3.601531, 0.116605, 0.168986, 1.000000]
    ...
    oneram6.test_vals = [0.277392, 0.006227]
    ...
    flatplate.test_vals = [-8.265203, -2.790380, 0.001084, 0.036280, 2.361500, -2.325300, 0.000000, 0.000000]
    ...
    cylinder.test_vals = [-8.638753, -3.154563, 0.005584, 1.614194, 0.000000]
    ...
    poiseuille_profile.test_vals = [-12.004082, -7.637491, -0.000000, 2.089953]
    ...
    rae2822_sst.test_vals = [-1.479160, 5.898617, 0.678431, 0.024642, 100.000000]
    ...
    rae2822_sst_sust.test_vals = [-2.942880, 5.054180, 0.509065, 0.043399]
    ...
    turb_flatplate.test_vals = [-0.187373, 0.003723, 10.000000, -1.444696]
    ...
    turb_naca0012_sa.test_vals = [-12.038059, -16.332088, 1.080346, 0.018385, 20.000000, -2.873343, 0.000000, -14.250270, 0.000000]
    ...
    turb_naca0012_sst.test_vals = [-5.948944, -10.295370, -3.739562, 1.069316, 0.015855, -3.048239, 0.000000]
    ...
    turb_naca0012_sst_sust.test_vals = [-7.626467, -9.698545, -2.145340, 1.006188, 0.019328, -1.353713]
    ...
    turb_naca0012_sst_fixedvalues.test_vals = [-5.192392, -10.448218, 0.773965, 1.022535, 0.040529, -2.383336]
    ...
    axi_rans_air_nozzle_restart.test_vals = [-4.875434, 0.608496, -4.040017, 0.185569, 0.000000]
    ...
    turb_naca0012_sst_restart_mg.test_vals = [-3.689602, -5.056964, 0.830559, -0.008732, 0.078126]
    ...
    turb_naca0012_1c.test_vals = [-4.964342, 1.345656, 0.446527, -0.028331]
    ...
    turb_naca0012_2c.test_vals = [-5.482844, 1.260888, 0.404947, -0.040154]
    ...
    turb_naca0012_3c.test_vals = [-5.583731, 1.228717, 0.379824, -0.046992]
    ...
    turb_naca0012_p1c1.test_vals = [-5.167299, 1.279420, 0.549536, 0.011043]
    ...
    turb_naca0012_p1c2.test_vals = [-5.553265, 1.234113, 0.424941, -0.033285]
    ...
    inc_euler_naca0012.test_vals = [-6.668256, -5.851153, 0.531532, 0.008487]
    ...
    inc_nozzle.test_vals = [-6.121917, -5.432144, 0.000056, 0.125551]
    ...
    inc_lam_cylinder.test_vals = [-4.814160, -5.008238, 0.001269, 3.114987]
    ...
    inc_turb_naca0012_sst_sust.test_vals = [-9.784873, 3.354565, 0.000008, 0.309470]
    ...
    cavity.test_iter = 25
    cavity.test_vals = [-7.887109, -2.429088, 0.013598, 0.005372]
    ...
    sine_gust.test_vals = [-1.977498, 3.481817, -0.010724, -0.005369]
    ...
    aeroelastic.test_vals = [-1.876632, 4.021071, 0.080087, 0.027953, -0.001641, -0.000127, -1.052229]
    ...
    unst_deforming_naca0012.test_vals = [-3.666867, -3.796806, -3.719022, -3.150288]
    ...
    uniform_flow.test_vals = [5.000000, 0.000000, -0.195002, -10.624453]
