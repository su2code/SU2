...
def main():
    ...
    square_cylinder.test_vals = [-2.557893, -1.162560, 0.066414, 1.399788, 2.220411, 1.399743, 2.218612, -0.453170]
   ...
   # Channel_2D
    ...
    # set default command "SU2_CFD" unless something else has been specified
