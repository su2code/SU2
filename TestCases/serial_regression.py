...
if __name__=="__main__":
  ...
  channel.cfg_file  = "$SU2_HOME/TestCases/euler/channel/inv_channel_RK.cfg"
  channel.test_iter = 100
  channel.test_vals = [-2.489827,2.821844,0.008663,0.053519]
  channel.su2_dir   = "$SU2_RUN"
  ...
  turb_flatplate.su2_dir   = "$SU2_RUN"
  ...
  inc_turb_naca0012.su2_dir   = "$SU2_RUN"
  ...
  contadj_naca0012.su2_dir   = "$SU2_RUN"
  ...
  contadj_ns_cylinder.su2_dir   = "$SU2_RUN"
  ...
  contadj_ns_naca0012.su2_dir   = "$SU2_RUN"
  ...
  contadj_rans_naca0012.su2_dir   = "$SU2_RUN"
  ...
  contadj_incomp_NACA0012.su2_dir   = "$SU2_RUN"
  ...
  contadj_incomp_cylinder.su2_dir   = "$SU2_RUN"
