...
def main():
   ...
   # Channel_2D
    ...
    fsi2d.test_iter = 4
    fsi2d.test_vals = [4, 0, -3.771878, -4.163489] #last 4 columns
    ...
    dyn_fsi.test_iter = 4
    dyn_fsi.test_vals = [-4.400854, -4.085153, 0.000000, 101] #last 4 columns
...
#    test_list.append(opt_multiobjcombo_py)
    ...
    pywrapper_fsi2d.test_vals = [4, 0, -3.771878, -4.163489] #last 4 columns
