...
def main():
    ...
    inc_euler_naca0012.test_vals = [-4.876229, -3.786375, 0.501288, 0.007069] #last 4 columns
    ...
    schubauer_klebanoff_transition.test_vals    = [-8.287314, -14.278189, 0.000050, 0.007986] #last 4 columns
