...
def main():
    ...
    channel_2D.test_vals = [-1.656763, 4.263212, 0.000000, 0.000000] #last 4 columns
    ...
    supersonic_vortex_shedding.test_vals = [-1.129145, 4.596957, 0.000000, 0.000000] #last 4 columns
