...
def main():
    ...
    transonic_stator_rst.test_vals = [-8.248816, -2.976179, 5.285722, 0.003100] #last 4 columns
    ...
    uniform_flow.test_vals = [2.000000, 0.000000, -0.205134, -13.251572] #last 4 columns
