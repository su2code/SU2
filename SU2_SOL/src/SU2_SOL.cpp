 ...
 * \version 5.0.0 "Raven"
 *
 * SU2 Original Developers: Dr. Francisco Palacios.
...
*/
            ...
            if (rank == MASTER_NODE){
              ...
              for(unsigned short iPhi = 0; iPhi < boom.ray_N_phi; iPhi++){
                Objective_Function += (boom.p_rise[iPhi] + boom.p_rise2[iPhi])/boom.ray_N_phi; // Normalize by number of propagated signals
              }
            }
